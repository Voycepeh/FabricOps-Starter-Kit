...
Source notebook path: `templates/notebooks/00_env_config.ipynb`

## Purpose

Environment bootstrap for FabricOps Starter Kit notebooks. This notebook defines environment-wide values and assembles framework config.
