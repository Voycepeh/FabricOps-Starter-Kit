...
Schema fingerprint: `08311069057dcfc5eee75ddb18d561bd024799bd2ed93a2510b53e0b1cb947c1`
...
| --- | --- | --- | --- | --- |
| `steward_id` | `string` | No | FabricOps metadata schema registry | `steward_id` field in `METADATA_DATA_STEWARD`. |
