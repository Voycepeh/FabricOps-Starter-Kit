...
[View frozen source](https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/v0.2.0/src/fabricops_kit/io/read_lakehouse_excel.py)

Signature: `read_lakehouse_excel(relative_path: 'str', *, store: 'str' = 'Bronze', sheet_name=0, spark_session=None, context: 'dict[str, Any] | None' = None, **read_excel_kwargs)`
