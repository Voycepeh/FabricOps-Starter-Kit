...
Signature: `write_lakehouse_table(df, table_name: 'str', *, store: 'str' = 'Silver', schema=None, mode='append', partition_by=None, repartition_by=None, options=None, verbose=True, context=None)`
