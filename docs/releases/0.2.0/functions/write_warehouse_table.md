...
Signature: `write_warehouse_table(df, schema: 'str', table_name: 'str', *, store: 'str' = 'warehouse', mode: 'str' = 'append', repartition_by=None, options: 'dict[str, Any] | None' = None, context: 'dict[str, Any] | None' = None)`
