...
| 1 | Governance | `01_agreement` | [Create data stewards and a data agreement](guided-demo/01-create-agreement.md) |
| 2 | Engineering Development | `02_pipeline` | [Run the first Development pipeline](guided-demo/02-run-pipeline.md) |
| 3 | Governance | `03_review` | [Review catalogue evidence and define guardrails](guided-demo/03-enrich-guardrails.md) |
