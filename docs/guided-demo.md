...
| [4. Validate the frozen Data Contract](guided-demo/04-run-pipeline-with-guardrails.md) | `02_pipeline` | Put the governed target in Validate mode, evaluate the exact frozen candidate, record aggregate evidence, and leave the business target unchanged. |
