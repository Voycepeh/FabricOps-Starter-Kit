...
- **Enrichment suggestions:** propose business names, descriptions, classifications, and informational sensitivity from schema, profile, and governed context for steward review.
