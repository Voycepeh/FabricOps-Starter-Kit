...
FabricOps is a plug-and-play Data Engineering and Governance practice for Microsoft Fabric that standardizes the important foundations so teams can focus on project-specific engineering, analytics, and AI-assisted development.

<div class="fabricops-primary-grid">
  <a class="fabricops-primary-card" href="guided-demo/">
    <span class="fabricops-primary-card__title">Step-by-step Guided Demo</span>
    <span class="fabricops-primary-card__body">Follow the FabricOps workflow in order with practical actions, concept links, and expected results.</span>
  </a>

  <a class="fabricops-primary-card" href="how-fabricops-works/">
    <span class="fabricops-primary-card__title">How FabricOps works</span>
    <span class="fabricops-primary-card__body">Understand the operating model, workspaces, metadata, engineering flow, and path to Production.</span>
  </a>
</div>
...
<div class="fabricops-card-grid">
  ...
  <a class="fabricops-landing-card" href="reference/dq-rules/">
    <span class="fabricops-landing-card__title">Data Quality Rules</span>
    <span class="fabricops-landing-card__body">Review the supported Data Quality rule types used by FabricOps Guardrails.</span>
  </a>

  <a class="fabricops-landing-card fabricops-landing-card--wide" href="function-call-graph/">
