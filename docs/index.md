...
<div class="fabricops-card-grid">
  ...
  <a class="fabricops-landing-card" href="reference/">
    ...
    <span class="fabricops-landing-card__body"><!-- FABRICOPS_CALLABLE_RECORD_COUNT -->Supported by <strong>261</strong><span> functions and </span><strong>22</strong><span> non-function records</span><!-- /FABRICOPS_CALLABLE_RECORD_COUNT -->.</span>
  </a>
