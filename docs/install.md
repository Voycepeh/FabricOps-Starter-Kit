...
Next read: [Notebook Templates Implementation Guide](notebook-templates-implementation-guide/index.md), [Guided Demo](guided-demo.md),
...
can then continue with [Notebook Templates Implementation Guide](notebook-templates-implementation-guide/index.md) and
