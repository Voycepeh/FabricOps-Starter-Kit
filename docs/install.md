...
Next read: [Notebook Templates](how-fabricops-works/notebook-templates/index.md), [Guided Demo](guided-demo.md),
...
can then continue with [Notebook Templates](how-fabricops-works/notebook-templates/index.md) and
