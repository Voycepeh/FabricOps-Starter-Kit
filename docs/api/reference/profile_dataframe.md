...
<a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/b2463f3ad64a5b0679b3763509f3526351aa247c/src/fabricops_kit/data_profiling.py#L225-L345">View on GitHub</a>
</div>
    ...
    <div class="reference-helper-groups">
      <section class="reference-helper-group">
        ...
        <div class="reference-helper-chip-wrap">
          <a class="reference-helper-chip" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/b2463f3ad64a5b0679b3763509f3526351aa247c/src/fabricops_kit/config.py#L78-L83"><code>_audit_timestamp_expr</code></a>
      ...
      <section class="reference-helper-group">
        ...
        <div class="reference-helper-chip-wrap">
          <a class="reference-helper-chip" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/b2463f3ad64a5b0679b3763509f3526351aa247c/src/fabricops_kit/data_profiling.py#L59-L81"><code>_get_profiled_columns</code></a>
        </div>
      </section>
      <section class="reference-helper-group">
        ...
        <div class="reference-helper-chip-wrap">
          <a class="reference-helper-chip" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/b2463f3ad64a5b0679b3763509f3526351aa247c/src/fabricops_kit/data_profiling.py#L192-L222"><code>_build_distribution_summaries</code></a>
        </div>
      </section>
      <section class="reference-helper-group">
        ...
        <div class="reference-helper-chip-wrap">
          <a class="reference-helper-chip" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/b2463f3ad64a5b0679b3763509f3526351aa247c/src/fabricops_kit/data_profiling.py#L84-L104"><code>_is_min_max_supported_type</code></a>
        </div>
      </section>
      <section class="reference-helper-group">
        <h4>Other</h4>
        ...
        <div class="reference-helper-chip-wrap">
          <a class="reference-helper-chip" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/b2463f3ad64a5b0679b3763509f3526351aa247c/src/fabricops_kit/data_profiling.py#L152-L189"><code>_build_categorical_distribution</code></a>
          <a class="reference-helper-chip" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/b2463f3ad64a5b0679b3763509f3526351aa247c/src/fabricops_kit/data_profiling.py#L120-L149"><code>_build_numeric_distribution</code></a>
          <a class="reference-helper-chip" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/b2463f3ad64a5b0679b3763509f3526351aa247c/src/fabricops_kit/data_profiling.py#L107-L117"><code>_numeric_bin_edges</code></a>
        </div>
      </section>
    </div>
