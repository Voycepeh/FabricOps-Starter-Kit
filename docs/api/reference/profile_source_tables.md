...
`fabricops_kit/pipeline.py:958`

<a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/main/src/fabricops_kit/pipeline.py#L958-L972">View on GitHub</a>
</div>
...
- Use before transformations in guided 02_pipeline.
...
- Fully qualified function name: `fabricops_kit.pipeline.profile_source_tables`
- Short name: `profile_source_tables`
- Module: `pipeline`
...
- Source file path: `src/fabricops_kit/pipeline.py`
- GitHub source URL: <a href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/main/src/fabricops_kit/pipeline.py#L958-L972">https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/main/src/fabricops_kit/pipeline.py#L958-L972</a>
- Start line: `958`
- End line: `972`
- Signature:
