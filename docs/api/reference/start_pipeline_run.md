...
??? info "Call flow"
    ...
    **Call chains deeper than 4 levels**
    ...
    - `start_pipeline_run` → `widget_select_agreement` → `_current_notebook_active_registrations` → `_load_notebook_registry` → `_configured_lakehouse_schema` → `_get_store`
    - `start_pipeline_run` → `widget_select_agreement` → `_current_notebook_active_registrations` → `_load_notebook_registry` → `_configured_lakehouse_schema` → `_get_store` → `_normalize_path_config`
    - `start_pipeline_run` → `widget_select_agreement` → `_current_notebook_active_registrations` → `_load_notebook_registry` → `_configured_lakehouse_schema` → `_get_store` → `_normalize_path_config` → `PathConfig`
    - `start_pipeline_run` → `widget_select_agreement` → `_current_notebook_active_registrations` → `_load_notebook_registry` → `_configured_lakehouse_schema` → `_normalize_schema_name`
    - `start_pipeline_run` → `widget_select_agreement` → `_current_notebook_active_registrations` → `_load_notebook_registry` → `read_lakehouse_table` → `_get_spark`
    - `start_pipeline_run` → `widget_select_agreement` → `_current_notebook_active_registrations` → `_load_notebook_registry` → `read_lakehouse_table` → `_get_store`
    - `start_pipeline_run` → `widget_select_agreement` → `_current_notebook_active_registrations` → `_load_notebook_registry` → `read_lakehouse_table` → `_get_store` → `_normalize_path_config`
    - `start_pipeline_run` → `widget_select_agreement` → `_current_notebook_active_registrations` → `_load_notebook_registry` → `read_lakehouse_table` → `_get_store` → `_normalize_path_config` → `PathConfig`
