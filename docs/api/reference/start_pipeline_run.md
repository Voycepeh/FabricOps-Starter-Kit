...
??? info "Uses 41 internal helper functions"
    ...
    <div class="reference-call-tree" role="tree">
      ...
      <div class="reference-call-tree-row" role="treeitem"><span class="reference-call-tree-prefix">└── </span><a href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/main/src/fabricops_kit/pipeline.py#L218-L320"><code>_start_pipeline_run_workflow(...)</code></a></div>
...
| `select_agreement` | `bool` | No | Not documented yet |
| `register_notebook` | `bool` | No | Not documented yet |
| `read_only` | `bool` | No | Not documented yet |
| `run_context` | `Any` | No | Not documented yet |
