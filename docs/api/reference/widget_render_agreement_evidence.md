...
`fabricops_kit/data_agreement.py:1428`

<a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/main/src/fabricops_kit/data_agreement.py#L1428-L1461">View on GitHub</a>
</div>
...
??? info "Call flow"
    ...
    <div class="reference-call-tree" role="tree">
      ...
      <div class="reference-call-tree-row" role="treeitem"><span class="reference-call-tree-prefix">├── </span><a href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/main/src/fabricops_kit/data_agreement.py#L1307-L1425"><code>_render_agreement_evidence_widget(...)</code></a></div>
      ...
      <div class="reference-call-tree-row" role="treeitem"><span class="reference-call-tree-prefix">│   ├── </span><a href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/main/src/fabricops_kit/data_agreement.py#L795-L826"><code>_save_agreement_evidence_records(...)</code></a></div>
      ...
      <div class="reference-call-tree-row" role="treeitem"><span class="reference-call-tree-prefix">│   │   │   └── </span><a href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/main/src/fabricops_kit/config.py#L199-L204"><code>_get_audit_timezone(...)</code></a></div>
      <div class="reference-call-tree-row" role="treeitem"><span class="reference-call-tree-prefix">│   │   │       └── </span><a href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/main/src/fabricops_kit/config.py#L164-L196"><code>_validate_audit_timezone(...)</code></a></div>
      <div class="reference-call-tree-row" role="treeitem"><span class="reference-call-tree-prefix">│   │   ├── </span><a href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/main/src/fabricops_kit/data_agreement.py#L743-L793"><code>_prepare_evidence_file_references(...)</code></a></div>
      <div class="reference-call-tree-row" role="treeitem"><span class="reference-call-tree-prefix">│   │   │   └── </span><a href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/main/src/fabricops_kit/data_agreement.py#L731-L740"><code>_get_notebookutils(...)</code></a></div>
    ...
    **Helpers appearing in multiple branches**
    ...
    - `_config_value` appears in 2 branches.
    ...
    - `_resolve_lakehouse_table_path` appears in 2 branches.
    - `_validate_audit_timezone` appears in 2 branches.

    **Call chains deeper than 4 levels**

    - `widget_render_agreement_evidence` → `_render_agreement_evidence_widget` → `_list_all_data_agreement_rows` → `_configured_lakehouse_schema` → `_get_store` → `_normalize_path_config`
    - `widget_render_agreement_evidence` → `_render_agreement_evidence_widget` → `_list_all_data_agreement_rows` → `_configured_lakehouse_schema` → `_get_store` → `_normalize_path_config` → `PathConfig`
    - `widget_render_agreement_evidence` → `_render_agreement_evidence_widget` → `_list_all_data_agreement_rows` → `read_lakehouse_table` → `_get_store` → `_normalize_path_config`
    - `widget_render_agreement_evidence` → `_render_agreement_evidence_widget` → `_list_all_data_agreement_rows` → `read_lakehouse_table` → `_get_store` → `_normalize_path_config` → `PathConfig`
    - `widget_render_agreement_evidence` → `_render_agreement_evidence_widget` → `_list_all_data_agreement_rows` → `read_lakehouse_table` → `_resolve_lakehouse_table_path` → `_normalize_table_name`
    - `widget_render_agreement_evidence` → `_render_agreement_evidence_widget` → `_list_all_data_agreement_rows` → `read_lakehouse_table` → `_resolve_lakehouse_table_path` → `_resolve_lakehouse_schema`
    - `widget_render_agreement_evidence` → `_render_agreement_evidence_widget` → `_list_all_data_agreement_rows` → `read_lakehouse_table` → `_resolve_lakehouse_table_path` → `_resolve_lakehouse_schema` → `_normalize_schema_name`
    - `widget_render_agreement_evidence` → `_render_agreement_evidence_widget` → `_list_all_data_agreement_rows` → `read_lakehouse_table` → `resolve_fabric_context` → `get_default_fabric_context`
    ...
    **Helpers that only call one package-local helper**
    ...
    - `_prepare_evidence_file_references` only delegates to `_get_notebookutils`.
...
<div class="reference-helper-groups">
  ...
  <section class="reference-helper-group">
    ...
    <div class="reference-helper-chip-wrap">
      ...
      <a class="reference-helper-chip" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/main/src/fabricops_kit/data_agreement.py#L1307-L1425"><code>_render_agreement_evidence_widget</code></a>
      ...
      <a class="reference-helper-chip" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/main/src/fabricops_kit/data_agreement.py#L795-L826"><code>_save_agreement_evidence_records</code></a>
    </div>
  </section>
  <section class="reference-helper-group">
    <h4>Validation</h4>
    ...
    <div class="reference-helper-chip-wrap">
      <a class="reference-helper-chip" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/main/src/fabricops_kit/data_agreement.py#L743-L793"><code>_prepare_evidence_file_references</code></a>
    </div>
  </section>
  <section class="reference-helper-group">
    <h4>Rule parsing</h4>
  ...
  <section class="reference-helper-group">
    ...
    <div class="reference-helper-chip-wrap">
      <a class="reference-helper-chip" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/main/src/fabricops_kit/data_agreement.py#L731-L740"><code>_get_notebookutils</code></a>
...
- Source file path: `src/fabricops_kit/data_agreement.py`
- GitHub source URL: <a href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/main/src/fabricops_kit/data_agreement.py#L1428-L1461">https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/main/src/fabricops_kit/data_agreement.py#L1428-L1461</a>
- Start line: `1428`
- End line: `1461`
- Signature:
