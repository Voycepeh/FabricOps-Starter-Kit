...
<a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/main/src/fabricops_kit/data_agreement.py#L1407-L1440">View source on GitHub</a>

Implemented in `src/fabricops_kit/data_agreement.py`:1407.
