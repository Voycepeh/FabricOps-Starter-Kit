...
`fabricops_kit/data_agreement.py:829`

<a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/main/src/fabricops_kit/data_agreement.py#L829-L1057">View on GitHub</a>
</div>
...
```python
AGREEMENT = widget_select_agreement(notebook_type="02_pipeline", register_notebook=True)
```
...
| `spark_session` | `Any` | No | Fabric Spark session. Defaults to the active notebook ``spark`` global. |
| `metadata_schema` | `str \| None` | No | Explicit metadata Lakehouse schema override. Defaults to the active notebook ``METADATA_SCHEMA`` global. |
| `register_notebook` | `bool` | No | When True, render registration controls that link the current notebook to the selected agreement. |
| `notebook_type` | `str \| None` | No | Workflow metadata used for the returned runtime context and optional notebook registration. |
...
| `read_only` | `bool` | No | Marks exploratory contexts as read-only. |
| `run_context` | `Any` | No | ``RUN_CONTEXT`` from ``00_env_config``. Defaults to the active notebook variable named ``RUN_CONTEXT``. |

## Returns

Runtime context containing the selected agreement, run metadata, and optional notebook registration fields.

### Return interpretation

The returned context exposes agreement, run_id, pipeline_name, notebook identity, and registration fields for downstream templates.
...
??? info "Call flow"
    ...
    <div class="reference-call-tree" role="tree">
      ...
      <div class="reference-call-tree-row" role="treeitem"><span class="reference-call-tree-prefix">├── </span><a href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/main/src/fabricops_kit/data_agreement.py#L66-L84"><code>_AgreementRuntimeContext(...)</code></a></div>
      ...
      <div class="reference-call-tree-row" role="treeitem"><span class="reference-call-tree-prefix">│           └── </span><a href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/main/src/fabricops_kit/config.py#L141-L161"><code>resolve_fabric_context(...)</code></a></div>
      <div class="reference-call-tree-row" role="treeitem"><span class="reference-call-tree-prefix">│               └── </span><a href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/main/src/fabricops_kit/config.py#L26-L83"><code>get_default_fabric_context(...)</code></a></div>
      <div class="reference-call-tree-row" role="treeitem"><span class="reference-call-tree-prefix">├── </span><a href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/main/src/fabricops_kit/data_agreement.py#L87-L93"><code>_notebook_global(...)</code></a></div>
      ...
      <div class="reference-call-tree-row" role="treeitem"><span class="reference-call-tree-prefix">├── </span><a href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/main/src/fabricops_kit/data_agreement.py#L96-L101"><code>_runtime_metadata_value(...)</code></a></div>
      <div class="reference-call-tree-row" role="treeitem"><span class="reference-call-tree-prefix">└── </span><a href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/main/src/fabricops_kit/config.py#L141-L161"><code>resolve_fabric_context(...)</code></a></div>
      <div class="reference-call-tree-row" role="treeitem"><span class="reference-call-tree-prefix">    └── </span><a href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/main/src/fabricops_kit/config.py#L26-L83"><code>get_default_fabric_context(...)</code></a></div>
    </div>
...
<div class="reference-helper-groups">
  ...
  <section class="reference-helper-group">
    ...
    <div class="reference-helper-chip-wrap">
      ...
      <a class="reference-helper-chip" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/main/src/fabricops_kit/data_agreement.py#L96-L101"><code>_runtime_metadata_value</code></a>
    </div>
  </section>
  <section class="reference-helper-group">
    <h4>Rule parsing</h4>
  ...
  <section class="reference-helper-group">
    ...
    <div class="reference-helper-chip-wrap">
      <a class="reference-helper-chip" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/main/src/fabricops_kit/data_agreement.py#L66-L84"><code>_AgreementRuntimeContext</code></a>
      ...
      <a class="reference-helper-chip" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/main/src/fabricops_kit/data_agreement.py#L87-L93"><code>_notebook_global</code></a>
...
- **output:** Runtime context containing the selected agreement, run metadata, and optional notebook registration fields.
...
- Source file path: `src/fabricops_kit/data_agreement.py`
- GitHub source URL: <a href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/main/src/fabricops_kit/data_agreement.py#L829-L1057">https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/main/src/fabricops_kit/data_agreement.py#L829-L1057</a>
- Start line: `829`
- End line: `1057`
- Signature:
