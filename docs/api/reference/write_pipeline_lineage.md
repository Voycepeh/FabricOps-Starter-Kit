...
`fabricops_kit/pipeline.py:969`

<a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/main/src/fabricops_kit/pipeline.py#L969-L1056">View on GitHub</a>
</div>
...
| `run_id` | `str` | Yes | Pipeline run identifier. When omitted, the active context from :func:`widget_select_agreement` is used. |
...
- Source file path: `src/fabricops_kit/pipeline.py`
- GitHub source URL: <a href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/main/src/fabricops_kit/pipeline.py#L969-L1056">https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/main/src/fabricops_kit/pipeline.py#L969-L1056</a>
- Start line: `969`
- End line: `1056`
- Signature:
