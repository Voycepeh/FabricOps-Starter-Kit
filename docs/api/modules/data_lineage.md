...
<table>
  ...
  <tbody>
    <tr>
      <td><a href="#_build_lineage_record_from_steps"><code>_build_lineage_record_from_steps</code></a></td>
      <td>—</td>
    </tr>
    <tr>
      <td><a href="#_build_lineage_records"><code>_build_lineage_records</code></a></td>
      <td>—</td>
    </tr>
    <tr>
      <td><a href="#_call_name"><code>_call_name</code></a></td>
      <td>—</td>
    </tr>
    <tr>
      <td><a href="#_enrich_lineage_steps_with_ai"><code>_enrich_lineage_steps_with_ai</code></a></td>
      <td>—</td>
    </tr>
    <tr>
      <td><a href="#_fallback_copilot_lineage_prompt"><code>_fallback_copilot_lineage_prompt</code></a></td>
      <td>—</td>
    </tr>
    <tr>
      <td><a href="#_flatten_chain"><code>_flatten_chain</code></a></td>
      <td>—</td>
    </tr>
    <tr>
      <td><a href="#_literal"><code>_literal</code></a></td>
      <td>—</td>
    </tr>
    <tr>
      <td><a href="#_name"><code>_name</code></a></td>
      <td>—</td>
    </tr>
    <tr>
      <td><a href="#_resolve_write_target"><code>_resolve_write_target</code></a></td>
      <td>—</td>
    </tr>
    <tr>
      <td><a href="#_scan_notebook_cells"><code>_scan_notebook_cells</code></a></td>
      <td>—</td>
    </tr>
    <tr>
      <td><a href="#_scan_notebook_lineage"><code>_scan_notebook_lineage</code></a></td>
      <td>—</td>
    </tr>
    <tr>
      <td><a href="#_step"><code>_step</code></a></td>
      <td>—</td>
    </tr>
    <tr>
      <td><a href="#_validate_lineage_steps"><code>_validate_lineage_steps</code></a></td>
      <td>—</td>
    </tr>
  </tbody>
</table>
