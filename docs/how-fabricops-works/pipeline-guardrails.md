...
- [run_table_guardrails](../api/reference/run_table_guardrails.md) orchestrates widget-authored schema, freshness, profile behavior, and DQ enforcement before writes. [enforce_freshness](../api/modules/guardrails.md#enforce_freshness) and [enforce_profile_behavior](../api/modules/fabric_input_output.md#enforce_profile_behavior) remain focused runtime checks, while DQ execution is reached through the supported run_table_guardrails flow.
