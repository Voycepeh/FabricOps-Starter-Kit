...
`02_pipeline` then uses [`widget_select_agreement`](../../api/reference/widget_select_agreement.md) and the returned `AGREEMENT_CONTEXT.agreement` to read the selected agreement context for pipeline metadata and evidence.
