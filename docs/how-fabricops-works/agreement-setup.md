...
`02_pipeline` then uses [`widget_select_agreement`](../api/reference/widget_select_agreement.md) to select the agreement and return runtime context for pipeline metadata and evidence.
