...
| steward_role | Data Owner | Maintained | Controlled steward role selected from `DataAgreementConfig.steward_role_options` in `00_env_config` and saved in the existing `steward_role` column. |
