...
- **Option B** is separate widget cells for Data Steward, Data Agreement, and Agreement Evidence. Use Option B if Fabric output scrolling feels jumpy or if users prefer rerunning one section at a time.
