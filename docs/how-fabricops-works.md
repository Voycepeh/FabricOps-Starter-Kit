...
- **Metadata** — the structured information FabricOps records so Governance and Engineering can understand what the data is, what happened to it, and what rules apply.
...
- **Configuration-driven Engineering** — reusable pipeline behaviour controlled through configuration rather than repeatedly rewriting implementation code.
