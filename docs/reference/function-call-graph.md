...
| `scripts/generate_individual_function_reference_pages.py` | Generated individual reference pages under `docs/api/reference/`, `docs/reference/index.md`, and this explanatory page. |
