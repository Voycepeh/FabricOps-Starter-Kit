...
<article id="config-_audit_timestamp_expr" class="reference-catalogue-item" data-callable-row="true" data-callable-name="_audit_timestamp_expr" data-callable-module="config" data-callable-starter-path="—" data-function-type="internal" data-callable-purpose="Return a Spark expression for the current audit timestamp timezone.">
  <h3 class="reference-catalogue-item-name"><a class="reference-catalogue-item-title" href="internal/config__audit_timestamp_expr/"><code>_audit_timestamp_expr</code></a></h3>
  <p class="reference-catalogue-item-purpose">Return a Spark expression for the current audit timestamp timezone.</p>
  <p class="reference-catalogue-item-meta reference-catalogue-item-badges"><a class="reference-module-link" href="../api/modules/config/" title="Open config module page" aria-label="Open config module page">config</a><span class="reference-chip reference-chip-type reference-chip-internal">Internal</span><span class="reference-chip">—</span></p>
  <div class="reference-catalogue-item-counts">
    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Outbound 1</span></summary><ul><li><code>_get_audit_timezone</code></li></ul></details>
...
<article id="data_lineage-_build_lineage_records" class="reference-catalogue-item" data-callable-row="true" data-callable-name="_build_lineage_records" data-callable-module="data_lineage" data-callable-starter-path="—" data-function-type="internal" data-callable-purpose="Build metadata-ready lineage rows from validated lineage steps.">
  ...
  <div class="reference-catalogue-item-counts">
    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Outbound 2</span></summary><ul><li><code>_current_audit_timestamp</code></li><li><code>_validate_lineage_steps</code></li></ul></details>
...
<article id="metadata-_build_runtime_audit_fields" class="reference-catalogue-item" data-callable-row="true" data-callable-name="_build_runtime_audit_fields" data-callable-module="metadata" data-callable-starter-path="—" data-function-type="internal" data-callable-purpose="Build reusable framework-managed audit fields for metadata-table rows.">
  ...
  <p class="reference-catalogue-item-meta reference-catalogue-item-badges"><a class="reference-module-link" href="../api/modules/metadata/" title="Open metadata module page" aria-label="Open metadata module page">metadata</a><span class="reference-chip reference-chip-type reference-chip-internal">Internal</span><span class="reference-chip">—</span></p>
  <div class="reference-catalogue-item-counts">
    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Outbound 4</span></summary><ul><li><code>_current_audit_timestamp</code></li><li><code>_context_get</code></li><li><code>_runtime_context</code></li><li><code>_safe_str</code></li></ul></details>
...
<article id="pipeline-_canonical_catalogue_profile_df" class="reference-catalogue-item" data-callable-row="true" data-callable-name="_canonical_catalogue_profile_df" data-callable-module="pipeline" data-callable-starter-path="—" data-function-type="internal" data-callable-purpose="Return profile evidence using lowercase catalogue column names only.">
  <h3 class="reference-catalogue-item-name"><a class="reference-catalogue-item-title" href="internal/pipeline__canonical_catalogue_profile_df/"><code>_canonical_catalogue_profile_df</code></a></h3>
  <p class="reference-catalogue-item-purpose">Return profile evidence using lowercase catalogue column names only.</p>
  <p class="reference-catalogue-item-meta reference-catalogue-item-badges"><a class="reference-module-link" href="../api/modules/pipeline/" title="Open pipeline module page" aria-label="Open pipeline module page">pipeline</a><span class="reference-chip reference-chip-type reference-chip-internal">Internal</span><span class="reference-chip">—</span></p>
  <div class="reference-catalogue-item-counts">
...
<article id="config-_current_audit_timestamp" class="reference-catalogue-item" data-callable-row="true" data-callable-name="_current_audit_timestamp" data-callable-module="config" data-callable-starter-path="—" data-function-type="internal" data-callable-purpose="Return the current audit timestamp in the configured audit timezone.">
  <h3 class="reference-catalogue-item-name"><a class="reference-catalogue-item-title" href="internal/config__current_audit_timestamp/"><code>_current_audit_timestamp</code></a></h3>
  <p class="reference-catalogue-item-purpose">Return the current audit timestamp in the configured audit timezone.</p>
  <p class="reference-catalogue-item-meta reference-catalogue-item-badges"><a class="reference-module-link" href="../api/modules/config/" title="Open config module page" aria-label="Open config module page">config</a><span class="reference-chip reference-chip-type reference-chip-internal">Internal</span><span class="reference-chip">—</span></p>
  <div class="reference-catalogue-item-counts">
    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Outbound 1</span></summary><ul><li><code>_get_audit_timezone</code></li></ul></details>
    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Inbound 9</span></summary><ul><li><code>_build_lineage_records</code></li><li><code>build_lineage_records</code></li><li><code>_dq_summary</code></li><li><code>_prepare_dq_profile_input_rows</code></li><li><code>_build_runtime_audit_fields</code></li><li><code>_now_utc_iso</code></li><li><code>_register_current_notebook</code></li><li><code>_add_audit_columns</code></li><li><code>_now_iso</code></li></ul></details>
  </div>
</article>
<article id="fabric_input_output-_current_database_matches" class="reference-catalogue-item" data-callable-row="true" data-callable-name="_current_database_matches" data-callable-module="fabric_input_output" data-callable-starter-path="—" data-function-type="internal" data-callable-purpose="Internal helper used by the package.">
...
<article id="pipeline-_definition_name" class="reference-catalogue-item" data-callable-row="true" data-callable-name="_definition_name" data-callable-module="pipeline" data-callable-starter-path="—" data-function-type="internal" data-callable-purpose="Internal helper used by the package.">
  <h3 class="reference-catalogue-item-name"><a class="reference-catalogue-item-title" href="internal/pipeline__definition_name/"><code>_definition_name</code></a></h3>
  <p class="reference-catalogue-item-purpose">Internal helper used by the package.</p>
  <p class="reference-catalogue-item-meta reference-catalogue-item-badges"><a class="reference-module-link" href="../api/modules/pipeline/" title="Open pipeline module page" aria-label="Open pipeline module page">pipeline</a><span class="reference-chip reference-chip-type reference-chip-internal">Internal</span><span class="reference-chip">—</span></p>
  <div class="reference-catalogue-item-counts">
...
<article id="config-_detect_nested_metadata_delta_folders" class="reference-catalogue-item" data-callable-row="true" data-callable-name="_detect_nested_metadata_delta_folders" data-callable-module="config" data-callable-starter-path="—" data-function-type="internal" data-callable-purpose="Best-effort warning detector for legacy nested metadata Delta folders.">
  <h3 class="reference-catalogue-item-name"><a class="reference-catalogue-item-title" href="internal/config__detect_nested_metadata_delta_folders/"><code>_detect_nested_metadata_delta_folders</code></a></h3>
  <p class="reference-catalogue-item-purpose">Best-effort warning detector for legacy nested metadata Delta folders.</p>
  <p class="reference-catalogue-item-meta reference-catalogue-item-badges"><a class="reference-module-link" href="../api/modules/config/" title="Open config module page" aria-label="Open config module page">config</a><span class="reference-chip reference-chip-type reference-chip-internal">Internal</span><span class="reference-chip">—</span></p>
  <div class="reference-catalogue-item-counts">
    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Outbound 1</span></summary><ul><li><code>_get_store</code></li></ul></details>
...
<article id="governance_review-_display_review_guidance" class="reference-catalogue-item" data-callable-row="true" data-callable-name="_display_review_guidance" data-callable-module="governance_review" data-callable-starter-path="—" data-function-type="internal" data-callable-purpose="Internal helper used by the package.">
  ...
  <div class="reference-catalogue-item-counts">
    ...
    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Inbound 2</span></summary><ul><li><code>widget_review_column_classification</code></li><li><code>widget_review_column_context</code></li></ul></details>
  </div>
</article>
...
<article id="governance_review-_dq_failed_expression" class="reference-catalogue-item" data-callable-row="true" data-callable-name="_dq_failed_expression" data-callable-module="governance_review" data-callable-starter-path="—" data-function-type="internal" data-callable-purpose="Build a Spark boolean expression identifying rows that fail one DQ rule.">
  ...
  <div class="reference-catalogue-item-counts">
    ...
    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Inbound 3</span></summary><ul><li><code>_dq_failed_row_count</code></li><li><code>_dq_tagged_dataframe</code></li><li><code>_run_dq_guardrail_checks</code></li></ul></details>
  </div>
</article>
<article id="governance_review-_dq_failed_row_count" class="reference-catalogue-item" data-callable-row="true" data-callable-name="_dq_failed_row_count" data-callable-module="governance_review" data-callable-starter-path="—" data-function-type="internal" data-callable-purpose="Return the count of rows that failed at least one DQ rule.">
  <h3 class="reference-catalogue-item-name"><a class="reference-catalogue-item-title" href="internal/governance_review__dq_failed_row_count/"><code>_dq_failed_row_count</code></a></h3>
  <p class="reference-catalogue-item-purpose">Return the count of rows that failed at least one DQ rule.</p>
  <p class="reference-catalogue-item-meta reference-catalogue-item-badges"><a class="reference-module-link" href="../api/modules/governance_review/" title="Open governance_review module page" aria-label="Open governance_review module page">governance_review</a><span class="reference-chip reference-chip-type reference-chip-internal">Internal</span><span class="reference-chip">—</span></p>
  <div class="reference-catalogue-item-counts">
...
<article id="governance_review-_dq_rule_display_rows" class="reference-catalogue-item" data-callable-row="true" data-callable-name="_dq_rule_display_rows" data-callable-module="governance_review" data-callable-starter-path="—" data-function-type="internal" data-callable-purpose="Return table-shaped rows for active and inactive selected-table rules.">
  <h3 class="reference-catalogue-item-name"><a class="reference-catalogue-item-title" href="internal/governance_review__dq_rule_display_rows/"><code>_dq_rule_display_rows</code></a></h3>
  <p class="reference-catalogue-item-purpose">Return table-shaped rows for active and inactive selected-table rules.</p>
  <p class="reference-catalogue-item-meta reference-catalogue-item-badges"><a class="reference-module-link" href="../api/modules/governance_review/" title="Open governance_review module page" aria-label="Open governance_review module page">governance_review</a><span class="reference-chip reference-chip-type reference-chip-internal">Internal</span><span class="reference-chip">—</span></p>
  <div class="reference-catalogue-item-counts">
    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Outbound 2</span></summary><ul><li><code>_canonical_dq_rule_type</code></li><li><code>_dq_rule_parameters_summary</code></li></ul></details>
    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Inbound 1</span></summary><ul><li><code>widget_review_dq_rules</code></li></ul></details>
  </div>
</article>
<article id="governance_review-_dq_rule_parameter_payload" class="reference-catalogue-item" data-callable-row="true" data-callable-name="_dq_rule_parameter_payload" data-callable-module="governance_review" data-callable-starter-path="—" data-function-type="internal" data-callable-purpose="Return rule parameters stored inside ``rule_parameters_json``.">
  <h3 class="reference-catalogue-item-name"><a class="reference-catalogue-item-title" href="internal/governance_review__dq_rule_parameter_payload/"><code>_dq_rule_parameter_payload</code></a></h3>
  <p class="reference-catalogue-item-purpose">Return rule parameters stored inside ``rule_parameters_json``.</p>
  <p class="reference-catalogue-item-meta reference-catalogue-item-badges"><a class="reference-module-link" href="../api/modules/governance_review/" title="Open governance_review module page" aria-label="Open governance_review module page">governance_review</a><span class="reference-chip reference-chip-type reference-chip-internal">Internal</span><span class="reference-chip">—</span></p>
  <div class="reference-catalogue-item-counts">
...
<article id="governance_review-_dq_rule_parameters_summary" class="reference-catalogue-item" data-callable-row="true" data-callable-name="_dq_rule_parameters_summary" data-callable-module="governance_review" data-callable-starter-path="—" data-function-type="internal" data-callable-purpose="Return compact display text for non-identity DQ parameters.">
  <h3 class="reference-catalogue-item-name"><a class="reference-catalogue-item-title" href="internal/governance_review__dq_rule_parameters_summary/"><code>_dq_rule_parameters_summary</code></a></h3>
  <p class="reference-catalogue-item-purpose">Return compact display text for non-identity DQ parameters.</p>
  <p class="reference-catalogue-item-meta reference-catalogue-item-badges"><a class="reference-module-link" href="../api/modules/governance_review/" title="Open governance_review module page" aria-label="Open governance_review module page">governance_review</a><span class="reference-chip reference-chip-type reference-chip-internal">Internal</span><span class="reference-chip">—</span></p>
  <div class="reference-catalogue-item-counts">

    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Inbound 1</span></summary><ul><li><code>_dq_rule_display_rows</code></li></ul></details>
  </div>
</article>
<article id="governance_review-_dq_summary" class="reference-catalogue-item" data-callable-row="true" data-callable-name="_dq_summary" data-callable-module="governance_review" data-callable-starter-path="—" data-function-type="internal" data-callable-purpose="Build aggregate DQ fields for catalogue/profile evidence.">
  <h3 class="reference-catalogue-item-name"><a class="reference-catalogue-item-title" href="internal/governance_review__dq_summary/"><code>_dq_summary</code></a></h3>
  <p class="reference-catalogue-item-purpose">Build aggregate DQ fields for catalogue/profile evidence.</p>
  <p class="reference-catalogue-item-meta reference-catalogue-item-badges"><a class="reference-module-link" href="../api/modules/governance_review/" title="Open governance_review module page" aria-label="Open governance_review module page">governance_review</a><span class="reference-chip reference-chip-type reference-chip-internal">Internal</span><span class="reference-chip">—</span></p>
  <div class="reference-catalogue-item-counts">
    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Outbound 2</span></summary><ul><li><code>_current_audit_timestamp</code></li><li><code>_summarize_dq_guardrail</code></li></ul></details>
    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Inbound 1</span></summary><ul><li><code>enforce_dq_rules</code></li></ul></details>
  </div>
</article>
<article id="pipeline-_dq_summary_fields" class="reference-catalogue-item" data-callable-row="true" data-callable-name="_dq_summary_fields" data-callable-module="pipeline" data-callable-starter-path="—" data-function-type="internal" data-callable-purpose="Internal helper used by the package.">
  <h3 class="reference-catalogue-item-name"><a class="reference-catalogue-item-title" href="internal/pipeline__dq_summary_fields/"><code>_dq_summary_fields</code></a></h3>
  <p class="reference-catalogue-item-purpose">Internal helper used by the package.</p>
  <p class="reference-catalogue-item-meta reference-catalogue-item-badges"><a class="reference-module-link" href="../api/modules/pipeline/" title="Open pipeline module page" aria-label="Open pipeline module page">pipeline</a><span class="reference-chip reference-chip-type reference-chip-internal">Internal</span><span class="reference-chip">—</span></p>
  <div class="reference-catalogue-item-counts">
    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Outbound 1</span></summary><ul><li><code>_now_iso</code></li></ul></details>
    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Inbound 1</span></summary><ul><li><code>write_catalogue_evidence</code></li></ul></details>
  </div>
</article>
...
<article id="data_agreement-_ensure_metadata_tables" class="reference-catalogue-item" data-callable-row="true" data-callable-name="_ensure_metadata_tables" data-callable-module="data_agreement" data-callable-starter-path="—" data-function-type="internal" data-callable-purpose="Idempotently create or validate lightweight ``01_agreement`` metadata tables.">
  ...
  <p class="reference-catalogue-item-purpose">Idempotently create or validate lightweight ``01_agreement`` metadata tables.</p>
  <p class="reference-catalogue-item-meta reference-catalogue-item-badges"><a class="reference-module-link" href="../api/modules/data_agreement/" title="Open data_agreement module page" aria-label="Open data_agreement module page">data_agreement</a><span class="reference-chip reference-chip-type reference-chip-internal">Internal</span><span class="reference-chip">—</span></p>
  <div class="reference-catalogue-item-counts">
...
<article id="config-_get_active_metadata_tables" class="reference-catalogue-item" data-callable-row="true" data-callable-name="_get_active_metadata_tables" data-callable-module="config" data-callable-starter-path="—" data-function-type="internal" data-callable-purpose="Return the canonical active metadata tables prepared by ``00_env_config``.">
  <h3 class="reference-catalogue-item-name"><a class="reference-catalogue-item-title" href="internal/config__get_active_metadata_tables/"><code>_get_active_metadata_tables</code></a></h3>
  <p class="reference-catalogue-item-purpose">Return the canonical active metadata tables prepared by ``00_env_config``.</p>
  <p class="reference-catalogue-item-meta reference-catalogue-item-badges"><a class="reference-module-link" href="../api/modules/config/" title="Open config module page" aria-label="Open config module page">config</a><span class="reference-chip reference-chip-type reference-chip-internal">Internal</span><span class="reference-chip">—</span></p>
  <div class="reference-catalogue-item-counts">
    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Outbound 2</span></summary><ul><li><code>_validate_framework_config</code></li><li><code>_get_governance_metadata_schemas</code></li></ul></details>
    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Inbound 2</span></summary><ul><li><code>_validate_metadata_table_registration</code></li><li><code>setup_metadata_tables</code></li></ul></details>
  </div>
</article>
<article id="config-_get_audit_timezone" class="reference-catalogue-item" data-callable-row="true" data-callable-name="_get_audit_timezone" data-callable-module="config" data-callable-starter-path="—" data-function-type="internal" data-callable-purpose="Resolve the configured FabricOps audit timezone, defaulting to UTC.">
  <h3 class="reference-catalogue-item-name"><a class="reference-catalogue-item-title" href="internal/config__get_audit_timezone/"><code>_get_audit_timezone</code></a></h3>
  <p class="reference-catalogue-item-purpose">Resolve the configured FabricOps audit timezone, defaulting to UTC.</p>
  <p class="reference-catalogue-item-meta reference-catalogue-item-badges"><a class="reference-module-link" href="../api/modules/config/" title="Open config module page" aria-label="Open config module page">config</a><span class="reference-chip reference-chip-type reference-chip-internal">Internal</span><span class="reference-chip">—</span></p>
  <div class="reference-catalogue-item-counts">
    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Outbound 1</span></summary><ul><li><code>_validate_audit_timezone</code></li></ul></details>
    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Inbound 4</span></summary><ul><li><code>_audit_timestamp_expr</code></li><li><code>_current_audit_timestamp</code></li><li><code>_prepare_dq_profile_input_rows</code></li><li><code>run_table_guardrails</code></li></ul></details>
  </div>
</article>
...
<article id="governance_review-_get_governance_metadata_schemas" class="reference-catalogue-item" data-callable-row="true" data-callable-name="_get_governance_metadata_schemas" data-callable-module="governance_review" data-callable-starter-path="—" data-function-type="internal" data-callable-purpose="Return typed Spark schemas prepared by ``00_env_config`` for governance.">
  ...
  <div class="reference-catalogue-item-counts">
    ...
    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Inbound 2</span></summary><ul><li><code>_get_active_metadata_tables</code></li><li><code>_setup_governance_metadata_tables</code></li></ul></details>
  </div>
</article>
...
<article id="governance_review-_latest_dq_rule_versions" class="reference-catalogue-item" data-callable-row="true" data-callable-name="_latest_dq_rule_versions" data-callable-module="governance_review" data-callable-starter-path="—" data-function-type="internal" data-callable-purpose="Resolve latest append-only DQ metadata rows by stable rule identity.">
  ...
  <p class="reference-catalogue-item-purpose">Resolve latest append-only DQ metadata rows by stable rule identity.</p>
  <p class="reference-catalogue-item-meta reference-catalogue-item-badges"><a class="reference-module-link" href="../api/modules/governance_review/" title="Open governance_review module page" aria-label="Open governance_review module page">governance_review</a><span class="reference-chip reference-chip-type reference-chip-internal">Internal</span><span class="reference-chip">—</span></p>
  <div class="reference-catalogue-item-counts">
...
<article id="governance_review-_load_active_dq_rules" class="reference-catalogue-item" data-callable-row="true" data-callable-name="_load_active_dq_rules" data-callable-module="governance_review" data-callable-starter-path="—" data-function-type="internal" data-callable-purpose="Load active approved DQ rules from append-only metadata rows.">
  ...
  <p class="reference-catalogue-item-purpose">Load active approved DQ rules from append-only metadata rows.</p>
  <p class="reference-catalogue-item-meta reference-catalogue-item-badges"><a class="reference-module-link" href="../api/modules/governance_review/" title="Open governance_review module page" aria-label="Open governance_review module page">governance_review</a><span class="reference-chip reference-chip-type reference-chip-internal">Internal</span><span class="reference-chip">—</span></p>
  <div class="reference-catalogue-item-counts">
...
<article id="fabric_input_output-_normalize_table_name" class="reference-catalogue-item" data-callable-row="true" data-callable-name="_normalize_table_name" data-callable-module="fabric_input_output" data-callable-starter-path="—" data-function-type="internal" data-callable-purpose="Return a safe Spark table name, never a nested folder path.">
  ...
  <p class="reference-catalogue-item-purpose">Return a safe Spark table name, never a nested folder path.</p>
  <p class="reference-catalogue-item-meta reference-catalogue-item-badges"><a class="reference-module-link" href="../api/modules/fabric_input_output/" title="Open fabric_input_output module page" aria-label="Open fabric_input_output module page">fabric_input_output</a><span class="reference-chip reference-chip-type reference-chip-internal">Internal</span><span class="reference-chip">—</span></p>
  <div class="reference-catalogue-item-counts">

    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Inbound 3</span></summary><ul><li><code>_registered_table_identifier</code></li><li><code>read_lakehouse_table</code></li><li><code>write_lakehouse_table</code></li></ul></details>
  </div>
</article>
...
<article id="pipeline-_now_iso" class="reference-catalogue-item" data-callable-row="true" data-callable-name="_now_iso" data-callable-module="pipeline" data-callable-starter-path="—" data-function-type="internal" data-callable-purpose="Internal helper used by the package.">
  <h3 class="reference-catalogue-item-name"><a class="reference-catalogue-item-title" href="internal/pipeline__now_iso/"><code>_now_iso</code></a></h3>
  <p class="reference-catalogue-item-purpose">Internal helper used by the package.</p>
  <p class="reference-catalogue-item-meta reference-catalogue-item-badges"><a class="reference-module-link" href="../api/modules/pipeline/" title="Open pipeline module page" aria-label="Open pipeline module page">pipeline</a><span class="reference-chip reference-chip-type reference-chip-internal">Internal</span><span class="reference-chip">—</span></p>
  <div class="reference-catalogue-item-counts">
    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Outbound 1</span></summary><ul><li><code>_current_audit_timestamp</code></li></ul></details>
    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Inbound 5</span></summary><ul><li><code>_dq_summary_fields</code></li><li><code>_runtime_audit_fields</code></li><li><code>write_catalogue_evidence</code></li><li><code>write_pipeline_lineage</code></li><li><code>write_pipeline_run_summary</code></li></ul></details>
  </div>
</article>
...
<article id="governance_review-_parse_dq_ai_suggestions" class="reference-catalogue-item" data-callable-row="true" data-callable-name="_parse_dq_ai_suggestions" data-callable-module="governance_review" data-callable-starter-path="—" data-function-type="internal" data-callable-purpose="Parse and validate draft AI DQ suggestions without approving them.">
  <h3 class="reference-catalogue-item-name"><a class="reference-catalogue-item-title" href="internal/governance_review__parse_dq_ai_suggestions/"><code>_parse_dq_ai_suggestions</code></a></h3>
  <p class="reference-catalogue-item-purpose">Parse and validate draft AI DQ suggestions without approving them.</p>
  <p class="reference-catalogue-item-meta reference-catalogue-item-badges"><a class="reference-module-link" href="../api/modules/governance_review/" title="Open governance_review module page" aria-label="Open governance_review module page">governance_review</a><span class="reference-chip reference-chip-type reference-chip-internal">Internal</span><span class="reference-chip">—</span></p>
  <div class="reference-catalogue-item-counts">
    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Outbound 3</span></summary><ul><li><code>_canonical_dq_rule_type</code></li><li><code>_extract_assignment_payload</code></li><li><code>_validate_dq_rules</code></li></ul></details>
...
<article id="governance_review-_prepare_dq_profile_input_rows" class="reference-catalogue-item" data-callable-row="true" data-callable-name="_prepare_dq_profile_input_rows" data-callable-module="governance_review" data-callable-starter-path="—" data-function-type="internal" data-callable-purpose="Prepare DQ prompt profile rows from a profile DataFrame or raw DataFrame.">
  ...
  <p class="reference-catalogue-item-meta reference-catalogue-item-badges"><a class="reference-module-link" href="../api/modules/governance_review/" title="Open governance_review module page" aria-label="Open governance_review module page">governance_review</a><span class="reference-chip reference-chip-type reference-chip-internal">Internal</span><span class="reference-chip">—</span></p>
  <div class="reference-catalogue-item-counts">
    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Outbound 4</span></summary><ul><li><code>_current_audit_timestamp</code></li><li><code>_get_audit_timezone</code></li><li><code>profile_dataframe</code></li><li><code>_spark_sql_helpers</code></li></ul></details>
...
<article id="fabric_input_output-_quote_identifier" class="reference-catalogue-item" data-callable-row="true" data-callable-name="_quote_identifier" data-callable-module="fabric_input_output" data-callable-starter-path="—" data-function-type="internal" data-callable-purpose="Internal helper used by the package.">
  ...
  <div class="reference-catalogue-item-counts">
    ...
    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Inbound 1</span></summary><ul><li><code>_registered_table_identifier</code></li></ul></details>
  </div>
</article>
...
<article id="metadata-_register_current_notebook" class="reference-catalogue-item" data-callable-row="true" data-callable-name="_register_current_notebook" data-callable-module="metadata" data-callable-starter-path="—" data-function-type="internal" data-callable-purpose="Append a runtime notebook registration row.">
  ...
  <p class="reference-catalogue-item-meta reference-catalogue-item-badges"><a class="reference-module-link" href="../api/modules/metadata/" title="Open metadata module page" aria-label="Open metadata module page">metadata</a><span class="reference-chip reference-chip-type reference-chip-internal">Internal</span><span class="reference-chip">—</span></p>
  <div class="reference-catalogue-item-counts">
    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Outbound 7</span></summary><ul><li><code>_current_audit_timestamp</code></li><li><code>write_lakehouse_table</code></li><li><code>_context_get</code></li><li><code>_notebook_registration_key</code></li><li><code>_rows_for_spark</code></li><li><code>_runtime_context</code></li><li><code>_safe_str</code></li></ul></details>
    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Inbound 1</span></summary><ul><li><code>widget_select_agreement</code></li></ul></details>
  </div>
</article>
<article id="fabric_input_output-_registered_table_identifier" class="reference-catalogue-item" data-callable-row="true" data-callable-name="_registered_table_identifier" data-callable-module="fabric_input_output" data-callable-starter-path="—" data-function-type="internal" data-callable-purpose="Return a metadata lakehouse-qualified Spark table identifier.">
  <h3 class="reference-catalogue-item-name"><a class="reference-catalogue-item-title" href="internal/fabric_input_output__registered_table_identifier/"><code>_registered_table_identifier</code></a></h3>
  <p class="reference-catalogue-item-purpose">Return a metadata lakehouse-qualified Spark table identifier.</p>
  <p class="reference-catalogue-item-meta reference-catalogue-item-badges"><a class="reference-module-link" href="../api/modules/fabric_input_output/" title="Open fabric_input_output module page" aria-label="Open fabric_input_output module page">fabric_input_output</a><span class="reference-chip reference-chip-type reference-chip-internal">Internal</span><span class="reference-chip">—</span></p>
  <div class="reference-catalogue-item-counts">
...
<article id="pipeline-_runtime_audit_fields" class="reference-catalogue-item" data-callable-row="true" data-callable-name="_runtime_audit_fields" data-callable-module="pipeline" data-callable-starter-path="—" data-function-type="internal" data-callable-purpose="Internal helper used by the package.">
  <h3 class="reference-catalogue-item-name"><a class="reference-catalogue-item-title" href="internal/pipeline__runtime_audit_fields/"><code>_runtime_audit_fields</code></a></h3>
  <p class="reference-catalogue-item-purpose">Internal helper used by the package.</p>
  <p class="reference-catalogue-item-meta reference-catalogue-item-badges"><a class="reference-module-link" href="../api/modules/pipeline/" title="Open pipeline module page" aria-label="Open pipeline module page">pipeline</a><span class="reference-chip reference-chip-type reference-chip-internal">Internal</span><span class="reference-chip">—</span></p>
  <div class="reference-catalogue-item-counts">
    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Outbound 2</span></summary><ul><li><code>_build_runtime_audit_fields</code></li><li><code>_now_iso</code></li></ul></details>
    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Inbound 2</span></summary><ul><li><code>write_catalogue_evidence</code></li><li><code>write_pipeline_lineage</code></li></ul></details>
  </div>
</article>
...
<article id="governance_review-_schema" class="reference-catalogue-item" data-callable-row="true" data-callable-name="_schema" data-callable-module="governance_review" data-callable-starter-path="—" data-function-type="internal" data-callable-purpose="Internal helper used by the package.">
  ...
  <p class="reference-catalogue-item-meta reference-catalogue-item-badges"><a class="reference-module-link" href="../api/modules/governance_review/" title="Open governance_review module page" aria-label="Open governance_review module page">governance_review</a><span class="reference-chip reference-chip-type reference-chip-internal">Internal</span><span class="reference-chip">—</span></p>
  <div class="reference-catalogue-item-counts">
    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Outbound 2</span></summary><ul><li><code>_spark_types</code></li><li><code>_validate_schema_field_names</code></li></ul></details>
...
<article id="config-_show_tables_for_metadata_lakehouse" class="reference-catalogue-item" data-callable-row="true" data-callable-name="_show_tables_for_metadata_lakehouse" data-callable-module="config" data-callable-starter-path="—" data-function-type="internal" data-callable-purpose="Inspect registered tables for the configured metadata lakehouse.">
  ...
  <p class="reference-catalogue-item-purpose">Inspect registered tables for the configured metadata lakehouse.</p>
  <p class="reference-catalogue-item-meta reference-catalogue-item-badges"><a class="reference-module-link" href="../api/modules/config/" title="Open config module page" aria-label="Open config module page">config</a><span class="reference-chip reference-chip-type reference-chip-internal">Internal</span><span class="reference-chip">—</span></p>
  <div class="reference-catalogue-item-counts">
    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Outbound 1</span></summary><ul><li><code>_get_store</code></li></ul></details>
    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Inbound 1</span></summary><ul><li><code>_validate_metadata_table_registration</code></li></ul></details>
...
<article id="fabric_input_output-_uses_registered_metadata_table" class="reference-catalogue-item" data-callable-row="true" data-callable-name="_uses_registered_metadata_table" data-callable-module="fabric_input_output" data-callable-starter-path="—" data-function-type="internal" data-callable-purpose="Return whether a target should use Spark table registration.">
  <h3 class="reference-catalogue-item-name"><a class="reference-catalogue-item-title" href="internal/fabric_input_output__uses_registered_metadata_table/"><code>_uses_registered_metadata_table</code></a></h3>
  <p class="reference-catalogue-item-purpose">Return whether a target should use Spark table registration.</p>
  <p class="reference-catalogue-item-meta reference-catalogue-item-badges"><a class="reference-module-link" href="../api/modules/fabric_input_output/" title="Open fabric_input_output module page" aria-label="Open fabric_input_output module page">fabric_input_output</a><span class="reference-chip reference-chip-type reference-chip-internal">Internal</span><span class="reference-chip">—</span></p>
  <div class="reference-catalogue-item-counts">
...
<article id="config-_validate_audit_timezone" class="reference-catalogue-item" data-callable-row="true" data-callable-name="_validate_audit_timezone" data-callable-module="config" data-callable-starter-path="—" data-function-type="internal" data-callable-purpose="Return a valid IANA audit timezone name.">
  <h3 class="reference-catalogue-item-name"><a class="reference-catalogue-item-title" href="internal/config__validate_audit_timezone/"><code>_validate_audit_timezone</code></a></h3>
  <p class="reference-catalogue-item-purpose">Return a valid IANA audit timezone name.</p>
  <p class="reference-catalogue-item-meta reference-catalogue-item-badges"><a class="reference-module-link" href="../api/modules/config/" title="Open config module page" aria-label="Open config module page">config</a><span class="reference-chip reference-chip-type reference-chip-internal">Internal</span><span class="reference-chip">—</span></p>
  <div class="reference-catalogue-item-counts">

    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Inbound 3</span></summary><ul><li><code>_get_audit_timezone</code></li><li><code>_validate_framework_config</code></li><li><code>profile_dataframe</code></li></ul></details>
  </div>
</article>
...
<article id="governance_review-_validate_dq_rules" class="reference-catalogue-item" data-callable-row="true" data-callable-name="_validate_dq_rules" data-callable-module="governance_review" data-callable-starter-path="—" data-function-type="internal" data-callable-purpose="Validate canonical DQ rules before loading or enforcement.">
  ...
  <div class="reference-catalogue-item-counts">
    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Outbound 1</span></summary><ul><li><code>_canonical_dq_rule_type</code></li></ul></details>
    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Inbound 7</span></summary><ul><li><code>_build_dq_rule_records</code></li><li><code>_dq_failed_expression</code></li><li><code>_draft_dq_rules</code></li><li><code>_load_active_dq_rules</code></li><li><code>_parse_dq_ai_suggestions</code></li><li><code>_run_dq_guardrail_checks</code></li><li><code>widget_review_dq_rules</code></li></ul></details>
  </div>
</article>
<article id="config-_validate_framework_config" class="reference-catalogue-item" data-callable-row="true" data-callable-name="_validate_framework_config" data-callable-module="config" data-callable-starter-path="—" data-function-type="internal" data-callable-purpose="Validate and normalize framework configuration input.">
  ...
  <p class="reference-catalogue-item-meta reference-catalogue-item-badges"><a class="reference-module-link" href="../api/modules/config/" title="Open config module page" aria-label="Open config module page">config</a><span class="reference-chip reference-chip-type reference-chip-internal">Internal</span><span class="reference-chip">—</span></p>
  <div class="reference-catalogue-item-counts">
    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Outbound 3</span></summary><ul><li><code>FrameworkConfig</code></li><li><code>_validate_audit_timezone</code></li><li><code>keys</code></li></ul></details>
    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Inbound 3</span></summary><ul><li><code>_get_active_metadata_tables</code></li><li><code>_validate_metadata_table_registration</code></li><li><code>setup_notebook</code></li></ul></details>
  </div>
</article>
...
<article id="config-_validate_metadata_table_registration" class="reference-catalogue-item" data-callable-row="true" data-callable-name="_validate_metadata_table_registration" data-callable-module="config" data-callable-starter-path="—" data-function-type="internal" data-callable-purpose="Validate that active metadata tables are registered in the Spark catalog.">
  ...
  <p class="reference-catalogue-item-purpose">Validate that active metadata tables are registered in the Spark catalog.</p>
  <p class="reference-catalogue-item-meta reference-catalogue-item-badges"><a class="reference-module-link" href="../api/modules/config/" title="Open config module page" aria-label="Open config module page">config</a><span class="reference-chip reference-chip-type reference-chip-internal">Internal</span><span class="reference-chip">—</span></p>
  <div class="reference-catalogue-item-counts">
    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Outbound 4</span></summary><ul><li><code>_detect_nested_metadata_delta_folders</code></li><li><code>_get_active_metadata_tables</code></li><li><code>_show_tables_for_metadata_lakehouse</code></li><li><code>_validate_framework_config</code></li></ul></details>
    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Inbound 1</span></summary><ul><li><code>setup_metadata_tables</code></li></ul></details>
  </div>
</article>
...
<article id="governance_review-_validate_schema_field_names" class="reference-catalogue-item" data-callable-row="true" data-callable-name="_validate_schema_field_names" data-callable-module="governance_review" data-callable-starter-path="—" data-function-type="internal" data-callable-purpose="Validate that a metadata schema has no case-insensitive duplicates.">
  <h3 class="reference-catalogue-item-name"><a class="reference-catalogue-item-title" href="internal/governance_review__validate_schema_field_names/"><code>_validate_schema_field_names</code></a></h3>
  <p class="reference-catalogue-item-purpose">Validate that a metadata schema has no case-insensitive duplicates.</p>
  <p class="reference-catalogue-item-meta reference-catalogue-item-badges"><a class="reference-module-link" href="../api/modules/governance_review/" title="Open governance_review module page" aria-label="Open governance_review module page">governance_review</a><span class="reference-chip reference-chip-type reference-chip-internal">Internal</span><span class="reference-chip">—</span></p>
  <div class="reference-catalogue-item-counts">

    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Inbound 1</span></summary><ul><li><code>_schema</code></li></ul></details>
  </div>
</article>
<article id="governance_review-_value" class="reference-catalogue-item" data-callable-row="true" data-callable-name="_value" data-callable-module="governance_review" data-callable-starter-path="—" data-function-type="internal" data-callable-purpose="Internal helper used by the package.">
  ...
  <div class="reference-catalogue-item-counts">
    ...
    <details class="reference-count-details"><summary><span class="reference-chip reference-chip-count">Inbound 9</span></summary><ul><li><code>_approved_column_identity</code></li><li><code>_approved_review_context</code></li><li><code>_catalogue_table_options</code></li><li><code>_display_review_guidance</code></li><li><code>_is_success</code></li><li><code>_latest_row</code></li><li><code>_review_governance_evidence</code></li><li><code>load_catalogue_profile_rows</code></li><li><code>widget_review_dq_rules</code></li></ul></details>
  </div>
</article>
