...
<article id="governance_review-widget_select_catalogue_table" class="reference-catalogue-item" data-callable-row="true" data-callable-name="widget_select_catalogue_table" data-callable-module="governance_review" data-callable-starter-path="—" data-function-type="callable" data-callable-purpose="Render a searchable selector for latest successful catalogue profiles.">
