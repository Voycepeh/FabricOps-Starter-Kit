...
- Fully qualified function name: `fabricops_kit.metadata._coerce_row_dicts`
- Short name: `_coerce_row_dicts`
- Module: `metadata`
- Classification: Internal
- Related module: `metadata`
- Source file path: `src/fabricops_kit/metadata.py`
- Source reference: <a href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/5d3d97d1ce1ae47231e3567728d98d9a77733d95/src/fabricops_kit/metadata.py#L52-L57">View source on GitHub</a>
