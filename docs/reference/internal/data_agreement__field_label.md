...
- Fully qualified function name: `fabricops_kit.data_agreement._field_label`
- Short name: `_field_label`
- Module: `data_agreement`
- Classification: Internal helper
- Related module: `data_agreement`
- Source file path: `src/fabricops_kit/data_agreement.py`
- Source reference: <a href="../../api/modules/data_agreement/#_field_label">Module source anchor</a>
