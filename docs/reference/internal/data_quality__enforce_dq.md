...
- Fully qualified function name: `fabricops_kit.data_quality._enforce_dq`
- Short name: `_enforce_dq`
- Module: `data_quality`
- Classification: Internal
- Related module: `data_quality`
- Source file path: `src/fabricops_kit/data_quality.py`
- Source reference: <a href="../../api/modules/data_quality/#_enforce_dq">Module source anchor</a>
- Inbound references count: 0
- Outbound references count: 5

## Outbound references
- <a href="../internal/data_quality/DQEnforcementResult/"><code>fabricops_kit.data_quality.DQEnforcementResult</code></a>
