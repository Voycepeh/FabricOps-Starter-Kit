...
- Fully qualified function name: `fabricops_kit.governance_review._extract_column_context_suggestions`
- Short name: `_extract_column_context_suggestions`
- Module: `governance_review`
- Classification: Internal helper
- Related module: `governance_review`
- Source file path: `src/fabricops_kit/governance_review.py`
- Source reference: <a href="../../api/modules/governance_review/#_extract_column_context_suggestions">Module source anchor</a>
