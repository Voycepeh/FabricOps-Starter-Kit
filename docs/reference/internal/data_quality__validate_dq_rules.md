...
- Fully qualified function name: `fabricops_kit.data_quality._validate_dq_rules`
- Short name: `_validate_dq_rules`
- Module: `data_quality`
- Classification: Internal
- Related module: `data_quality`
- Source file path: `src/fabricops_kit/data_quality.py`
- Source reference: <a href="../../api/modules/data_quality/#_validate_dq_rules">Module source anchor</a>
