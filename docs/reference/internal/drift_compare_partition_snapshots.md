...
- Fully qualified function name: `fabricops_kit.drift.compare_partition_snapshots`
- Short name: `compare_partition_snapshots`
- Module: `drift`
- Classification: Internal helper
- Related module: `drift`
- Source file path: `src/fabricops_kit/drift.py`
- Source reference: <a href="../../api/modules/drift/#compare_partition_snapshots">Module source anchor</a>
...
- <a href="../internal/drift/_is_closed_partition/"><code>fabricops_kit.drift._is_closed_partition</code></a>
