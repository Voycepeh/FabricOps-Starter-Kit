...
- Fully qualified function name: `fabricops_kit.drift.load_latest_schema_snapshot`
- Short name: `load_latest_schema_snapshot`
- Module: `drift`
- Classification: Internal helper
- Related module: `drift`
- Source file path: `src/fabricops_kit/drift.py`
- Source reference: <a href="../../api/modules/drift/#load_latest_schema_snapshot">Module source anchor</a>
