...
- Fully qualified function name: `fabricops_kit.governance_review._row_metadata_table_key`
- Short name: `_row_metadata_table_key`
- Module: `governance_review`
- Classification: Internal helper
- Related module: `governance_review`
- Source file path: `src/fabricops_kit/governance_review.py`
- Source reference: <a href="../../api/modules/governance_review/#_row_metadata_table_key">Module source anchor</a>
