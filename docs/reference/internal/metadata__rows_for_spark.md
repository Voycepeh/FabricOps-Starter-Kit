...
- Fully qualified function name: `fabricops_kit.metadata._rows_for_spark`
- Short name: `_rows_for_spark`
- Module: `metadata`
- Classification: Internal
- Related module: `metadata`
- Source file path: `src/fabricops_kit/metadata.py`
- Source reference: <a href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/d7fae51cae8b101fbee48f365b462f6b6f647e79/src/fabricops_kit/metadata.py#L160-L169">View source on GitHub</a>
