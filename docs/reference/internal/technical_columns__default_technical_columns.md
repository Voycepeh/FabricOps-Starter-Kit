...
- Fully qualified function name: `fabricops_kit.technical_columns._default_technical_columns`
- Short name: `_default_technical_columns`
- Module: `technical_columns`
- Classification: Internal helper
