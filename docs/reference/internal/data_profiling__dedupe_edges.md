...
- Fully qualified function name: `fabricops_kit.data_profiling._dedupe_edges`
- Short name: `_dedupe_edges`
- Module: `data_profiling`
- Classification: Internal
- Related module: `data_profiling`
- Source file path: `src/fabricops_kit/data_profiling.py`
- Source reference: <a href="../../api/modules/data_profiling/#_dedupe_edges">Module source anchor</a>
