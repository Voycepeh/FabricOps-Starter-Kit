...
- Fully qualified function name: `fabricops_kit.governance_review._matches_identity`
- Short name: `_matches_identity`
- Module: `governance_review`
- Classification: Internal
- Related module: `governance_review`
- Source file path: `src/fabricops_kit/governance_review.py`
- Source reference: <a href="../../api/modules/governance_review/#_matches_identity">Module source anchor</a>
