...
- Fully qualified function name: `fabricops_kit.business_context._draft_business_context`
- Short name: `_draft_business_context`
- Module: `business_context`
- Classification: Internal
- Related module: `business_context`
- Source file path: `src/fabricops_kit/business_context.py`
- Source reference: <a href="../../api/modules/business_context/#_draft_business_context">Module source anchor</a>
