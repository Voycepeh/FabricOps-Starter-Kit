...
- Fully qualified function name: `fabricops_kit.data_profiling._is_numeric_type`
- Short name: `_is_numeric_type`
- Module: `data_profiling`
- Classification: Internal
- Related module: `data_profiling`
- Source file path: `src/fabricops_kit/data_profiling.py`
- Source reference: <a href="../../api/modules/data_profiling/#_is_numeric_type">Module source anchor</a>
