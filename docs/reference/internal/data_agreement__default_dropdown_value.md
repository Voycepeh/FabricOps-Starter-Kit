...
- Fully qualified function name: `fabricops_kit.data_agreement._default_dropdown_value`
- Short name: `_default_dropdown_value`
- Module: `data_agreement`
- Classification: Internal helper
- Related module: `data_agreement`
- Source file path: `src/fabricops_kit/data_agreement.py`
- Source reference: <a href="../../api/modules/data_agreement/#_default_dropdown_value">Module source anchor</a>
