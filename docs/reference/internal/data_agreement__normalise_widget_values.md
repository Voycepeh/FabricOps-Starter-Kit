...
- Fully qualified function name: `fabricops_kit.data_agreement._normalise_widget_values`
- Short name: `_normalise_widget_values`
- Module: `data_agreement`
- Classification: Internal helper
- Related module: `data_agreement`
- Source file path: `src/fabricops_kit/data_agreement.py`
- Source reference: <a href="../../api/modules/data_agreement/#_normalise_widget_values">Module source anchor</a>
