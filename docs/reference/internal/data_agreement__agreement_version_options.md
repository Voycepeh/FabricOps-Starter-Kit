...
- Fully qualified function name: `fabricops_kit.data_agreement._agreement_version_options`
- Short name: `_agreement_version_options`
- Module: `data_agreement`
- Classification: Internal helper
- Related module: `data_agreement`
- Source file path: `src/fabricops_kit/data_agreement.py`
- Source reference: <a href="../../api/modules/data_agreement/#_agreement_version_options">Module source anchor</a>
