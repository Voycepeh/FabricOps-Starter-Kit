...
| `activity_id` | `string` | `fabricops_kit.pipeline.profile_and_register_table._write_lineage_participation`, `fabricops_kit.config.audit.build_runtime_audit_fields` | Runtime Fabric activity identifier captured for the lineage row. |
| `notebook_id` | `string` | `fabricops_kit.pipeline.profile_and_register_table._write_lineage_participation`, `fabricops_kit.config.audit.build_runtime_audit_fields` | Fabric notebook identifier captured for the lineage row. |
| `notebook_name` | `string` | `fabricops_kit.pipeline.profile_and_register_table._write_lineage_participation`, `fabricops_kit.config.audit.build_runtime_audit_fields` | Fabric notebook name captured for the lineage row. |
| `workspace_id` | `string` | `fabricops_kit.pipeline.profile_and_register_table._write_lineage_participation`, `fabricops_kit.config.audit.build_runtime_audit_fields` | Fabric workspace identifier captured for the lineage row. |
| `workspace_name` | `string` | `fabricops_kit.pipeline.profile_and_register_table._write_lineage_participation`, `fabricops_kit.config.audit.build_runtime_audit_fields` | Fabric workspace name captured for the lineage row. |
| `metadata_table_key` | `string` | `fabricops_kit.pipeline.profile_and_register_table._write_lineage_participation`, `fabricops_kit.pipeline.profile_and_register_table._metadata_table_key` | Stable governed data asset key that identifies a table across environment, dataset, and table context. |
...
| `committed_by` | `string` | `fabricops_kit.pipeline.profile_and_register_table._write_lineage_participation`, `fabricops_kit.config.audit.build_runtime_audit_fields` | Actor recorded on the lineage row before standard runtime audit fields are appended. |
...
| `metadata_lakehouse_name` | `string` | `fabricops_kit.pipeline.profile_and_register_table._write_lineage_participation`, `fabricops_kit.config.audit.build_runtime_audit_fields` | Configured metadata lakehouse name captured on the lineage row. |
