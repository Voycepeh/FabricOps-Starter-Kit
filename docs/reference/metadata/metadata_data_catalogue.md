...
| `environment_name` | `string` | [`profile_and_register_dataframe`](../../api/reference/profile_and_register_dataframe.md), `fabricops_kit.pipeline.profile_and_register_dataframe._catalogue_dataframe_from_profiled` | Environment name recorded for the metadata row. |
| `store_type` | `string` | [`profile_and_register_dataframe`](../../api/reference/profile_and_register_dataframe.md), `fabricops_kit.pipeline.profile_and_register_dataframe._catalogue_dataframe_from_profiled` | Configured Fabric store type recorded for the profiled dataset. |
| `layer` | `string` | [`profile_and_register_dataframe`](../../api/reference/profile_and_register_dataframe.md), `fabricops_kit.pipeline.profile_and_register_dataframe._catalogue_dataframe_from_profiled` | Configured data layer recorded for the profiled dataset. |
| `schema_name` | `string` | [`profile_and_register_dataframe`](../../api/reference/profile_and_register_dataframe.md), `fabricops_kit.pipeline.profile_and_register_dataframe._catalogue_dataframe_from_profiled` | Lakehouse or warehouse schema name recorded for the dataset when available. |
| `table_name` | `string` | [`profile_and_register_dataframe`](../../api/reference/profile_and_register_dataframe.md), `fabricops_kit.pipeline.profile_and_register_dataframe._catalogue_dataframe_from_profiled` | Physical table name recorded for the metadata row. |
| `column_name` | `string` | [`profile_and_register_dataframe`](../../api/reference/profile_and_register_dataframe.md), `fabricops_kit.pipeline.profile_and_register_dataframe._catalogue_dataframe_from_profiled` | Physical column name recorded for the metadata row. |
| `data_type` | `string` | [`profile_and_register_dataframe`](../../api/reference/profile_and_register_dataframe.md), `fabricops_kit.pipeline.profile_and_register_dataframe._catalogue_dataframe_from_profiled` | Stable data type label recorded for the column. |
