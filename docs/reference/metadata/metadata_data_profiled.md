...
| `is_sampled` | `boolean` | [`profile_and_register_dataframe`](../../api/reference/profile_and_register_dataframe.md), `fabricops_kit.pipeline.profile_and_register_dataframe._canonical_profiled_dataframe` | Whether the profiled dataset snapshot was sampled. |
| `frequency_json` | `string` | `fabricops_kit.pipeline.profile_and_register_dataframe._canonical_profiled_dataframe`, `fabricops_kit.pipeline.profile_and_register_dataframe._frequency_json_dataframe` | Serialized top-value frequency distribution for the column when requested. |
