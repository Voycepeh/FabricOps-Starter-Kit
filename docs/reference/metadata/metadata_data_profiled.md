...
| --- | --- | --- | --- | --- |
| `profile_record_id` | `string` | **PK** | [`profile_and_register_table`](../../api/reference/profile_and_register_table.md), `fabricops_kit.pipeline.profile_and_register_table._canonical_profiled_dataframe` | Identifier stored for `profile_record_id`. |
...
| `metadata_column_key` | `string` | **FK** | `fabricops_kit.pipeline.profile_and_register_table._canonical_profiled_dataframe`, `fabricops_kit.config.shared.build_metadata_column_key` | Stable governed data asset key that identifies a column across environment, dataset, table, and column context. |
