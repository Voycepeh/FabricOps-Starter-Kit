...
| --- | --- | --- | --- |
| `source_id` | `string` | [`observe_table`](../../api/reference/observe_table.md) | Identifier stored for `source_id`. |
| `observation_definition_id` | `string` | [`observe_table`](../../api/reference/observe_table.md) | Identifier stored for `observation_definition_id`. |
| `source_type` | `string` | [`observe_table`](../../api/reference/observe_table.md) | Metadata Source Observation field `source_type`. |
| `source_target` | `string` | [`observe_table`](../../api/reference/observe_table.md) | Metadata Source Observation field `source_target`. |
| `source_schema` | `string` | [`observe_table`](../../api/reference/observe_table.md) | Metadata Source Observation field `source_schema`. |
| `source_table` | `string` | [`observe_table`](../../api/reference/observe_table.md) | Metadata Source Observation field `source_table`. |
