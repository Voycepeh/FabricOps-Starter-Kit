...
<a class="metadata-table-card metadata-table-card--governance" href="metadata_guardrail/" aria-label="Open METADATA_GUARDRAIL schema">
  ...
  <span class="metadata-table-card__purpose">Define enforced Schema, Freshness, Source Drift, Data Quality, and Sensitive Data requirements with Warn or Block actions.</span>
  <span class="metadata-table-card__meta">
    <strong>Grain</strong>
...
<a class="metadata-table-card metadata-table-card--engineering" href="metadata_guardrail_results/" aria-label="Open METADATA_GUARDRAIL_RESULTS schema">
  ...
  <span class="metadata-table-card__purpose">Store aggregate runtime and preflight Guardrail summaries and continuation decisions; caller-owned failed business rows are not persisted here.</span>
  <span class="metadata-table-card__meta">
    <strong>Grain</strong>
    <span>One Guardrail outcome for one exact Data Contract version in one runtime or preflight execution.</span>
  </span>
  <span class="metadata-table-card__meta">
    <strong>Primary key</strong>
