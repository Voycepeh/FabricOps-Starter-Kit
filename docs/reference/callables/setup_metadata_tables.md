...
`setup_metadata_tables` reaches this helper in its implementation path.

**Modify this if:**

You want to change the implementation behavior summarized above for `setup_metadata_tables` or another caller that reaches `_get_active_metadata_tables`.
...
You want to change the implementation behavior summarized above for `setup_metadata_tables` or another caller that reaches `_validate_framework_config`.
...
You want to change the implementation behavior summarized above for `setup_metadata_tables` or another caller that reaches `_validate_audit_timezone`.
...
You want to change the implementation behavior summarized above for `setup_metadata_tables` or another caller that reaches `_get_governance_metadata_schemas`.
...
You want to change the implementation behavior summarized above for `setup_metadata_tables` or another caller that reaches `_schema`.
...
You want to change the implementation behavior summarized above for `setup_metadata_tables` or another caller that reaches `_spark_types`.
...
You want to change the implementation behavior summarized above for `setup_metadata_tables` or another caller that reaches `_validate_schema_field_names`.
...
You want to change the implementation behavior summarized above for `setup_metadata_tables` or another caller that reaches `_metadata_tables_from_setup_results`.
...
You want to change the implementation behavior summarized above for `setup_metadata_tables` or another caller that reaches `_validate_metadata_table_registration`.
...
You want to change the implementation behavior summarized above for `setup_metadata_tables` or another caller that reaches `_detect_nested_metadata_delta_folders`.
...
You want to change the implementation behavior summarized above for `setup_metadata_tables` or another caller that reaches `_get_store`.
...
You want to change the implementation behavior summarized above for `setup_metadata_tables` or another caller that reaches `_show_tables_for_metadata_lakehouse`.
...
You want to change the implementation behavior summarized above for `setup_metadata_tables` or another caller that reaches `_setup_data_agreement_tables`.
...
You want to change the implementation behavior summarized above for `setup_metadata_tables` or another caller that reaches `_ensure_metadata_tables`.
...
You want to change the implementation behavior summarized above for `setup_metadata_tables` or another caller that reaches `_coerce_row_dicts`.
...
You want to change the implementation behavior summarized above for `setup_metadata_tables` or another caller that reaches `_config_value`.
...
You want to change the implementation behavior summarized above for `setup_metadata_tables` or another caller that reaches `_list_data_stewards`.
...
You want to change the implementation behavior summarized above for `setup_metadata_tables` or another caller that reaches `_active_steward`.
...
You want to change the implementation behavior summarized above for `setup_metadata_tables` or another caller that reaches `_to_bool`.
...
You want to change the implementation behavior summarized above for `setup_metadata_tables` or another caller that reaches `_latest_by_key`.
...
You want to change the implementation behavior summarized above for `setup_metadata_tables` or another caller that reaches `_setup_governance_metadata_tables`.
...
You want to change the implementation behavior summarized above for `setup_metadata_tables` or another caller that reaches `_coerce_rows`.
...
You want to change the implementation behavior summarized above for `setup_metadata_tables` or another caller that reaches `_is_table_not_found_error`.
...
You want to change the implementation behavior summarized above for `setup_metadata_tables` or another caller that reaches `_schema_field_names`.
...
You want to change the implementation behavior summarized above for `setup_metadata_tables` or another caller that reaches `_setup_notebook_registry_table`.
...
You want to change the implementation behavior summarized above for `setup_metadata_tables` or another caller that reaches `_registry_rows_with_defaults`.
...
You want to change the implementation behavior summarized above for `setup_metadata_tables` or another caller that reaches `_notebook_registration_key`.
...
You want to change the implementation behavior summarized above for `setup_metadata_tables` or another caller that reaches `_safe_str`.
...
You want to change the implementation behavior summarized above for `setup_metadata_tables` or another caller that reaches `_rows_for_spark`.
