...
<table class="reference-function-table">
  ...
  <tbody>
    <tr>
      ...
      <td data-label="Details">Render the standalone agreement-evidence widget.</td>
    </tr>
    <tr>
...
??? info "Nested helper functions: 19"
    ...
    These helpers support `widget_render_agreement_evidence` by handling shared implementation tasks reached from the public call flow; expand the source block only when you need maintainer-level details.
    ...
    <table class="reference-function-table">
      ...
      <tbody>
        <tr>
          ...
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/data_agreement.py#L1341-L1459"><code>src/fabricops_kit/data_agreement.py#L1341-L1459</code></a></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/data_agreement.py#L822-L853"><code>src/fabricops_kit/data_agreement.py#L822-L853</code></a></td>
        </tr>
        <tr>
          ...
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/data_agreement.py#L770-L820"><code>src/fabricops_kit/data_agreement.py#L770-L820</code></a></td>
        </tr>
        <tr>
          ...
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/data_agreement.py#L758-L767"><code>src/fabricops_kit/data_agreement.py#L758-L767</code></a></td>
        </tr>
        <tr>
    ...
    ??? example "View helper source code"
        ...
        **`def _render_agreement_evidence_widget(*, spark: Any, config: Any, env_name: str, display_widget: bool=True) -> dict[str, Any]`**
        ...
        Used by `widget_render_agreement_evidence` through the implementation path shown above.
