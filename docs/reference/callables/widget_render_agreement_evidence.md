...
`widget_render_agreement_evidence` reaches this helper in its implementation path.

**Modify this if:**

You want to change the implementation behavior summarized above for `widget_render_agreement_evidence` or another caller that reaches `_render_agreement_evidence_widget`.
...
You want to change the implementation behavior summarized above for `widget_render_agreement_evidence` or another caller that reaches `_list_all_data_agreement_rows`.
...
You want to change the implementation behavior summarized above for `widget_render_agreement_evidence` or another caller that reaches `_coerce_row_dicts`.
...
You want to change the implementation behavior summarized above for `widget_render_agreement_evidence` or another caller that reaches `_config_value`.
...
You want to change the implementation behavior summarized above for `widget_render_agreement_evidence` or another caller that reaches `_render_searchable_selector`.
...
You want to change the implementation behavior summarized above for `widget_render_agreement_evidence` or another caller that reaches `_html_escape`.
...
You want to change the implementation behavior summarized above for `widget_render_agreement_evidence` or another caller that reaches `_widget_common`.
...
You want to change the implementation behavior summarized above for `widget_render_agreement_evidence` or another caller that reaches `_require_ipywidgets`.
...
You want to change the implementation behavior summarized above for `widget_render_agreement_evidence` or another caller that reaches `_save_agreement_evidence_records`.
...
You want to change the implementation behavior summarized above for `widget_render_agreement_evidence` or another caller that reaches `_prepare_evidence_file_references`.
...
You want to change the implementation behavior summarized above for `widget_render_agreement_evidence` or another caller that reaches `_get_notebookutils`.
...
You want to change the implementation behavior summarized above for `widget_render_agreement_evidence` or another caller that reaches `_write_row`.
...
You want to change the implementation behavior summarized above for `widget_render_agreement_evidence` or another caller that reaches `_build_runtime_audit_fields`.
...
You want to change the implementation behavior summarized above for `widget_render_agreement_evidence` or another caller that reaches `_current_audit_timestamp`.
...
You want to change the implementation behavior summarized above for `widget_render_agreement_evidence` or another caller that reaches `_get_audit_timezone`.
...
You want to change the implementation behavior summarized above for `widget_render_agreement_evidence` or another caller that reaches `_validate_audit_timezone`.
...
You want to change the implementation behavior summarized above for `widget_render_agreement_evidence` or another caller that reaches `_context_get`.
...
You want to change the implementation behavior summarized above for `widget_render_agreement_evidence` or another caller that reaches `_runtime_context`.
...
You want to change the implementation behavior summarized above for `widget_render_agreement_evidence` or another caller that reaches `_safe_str`.
