...
- <a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/427905557f281c2de218c8d2213dc8798864c090/src/fabricops_kit/data_agreement.py#L1462-L1495">View widget_render_agreement_evidence on GitHub</a>
...
??? info "Nested helper functions: 19"

    These nested helpers support `widget_render_agreement_evidence` by handling lower-level implementation steps; expand this section only when maintaining or debugging the package internals.
    ...
    <table class="reference-function-table">
      ...
      <tbody>
        <tr>
          <td data-label="Helper"><code>_render_agreement_evidence_widget</code></td>
          <td data-label="Role">Render optional agreement evidence upload controls.</td>
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/427905557f281c2de218c8d2213dc8798864c090/src/fabricops_kit/data_agreement.py#L1341-L1459">src/fabricops_kit/data_agreement.py</a></td>
        </tr>
        <tr>
        ...
        <tr>
          <td data-label="Helper"><code>_save_agreement_evidence_records</code></td>
          <td data-label="Role">Append manually uploaded evidence file-reference metadata rows.</td>
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/427905557f281c2de218c8d2213dc8798864c090/src/fabricops_kit/data_agreement.py#L822-L853">src/fabricops_kit/data_agreement.py</a></td>
        </tr>
        <tr>
          <td data-label="Helper"><code>_prepare_evidence_file_references</code></td>
          <td data-label="Role">Parse and validate manually supplied evidence file paths before writes.</td>
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/427905557f281c2de218c8d2213dc8798864c090/src/fabricops_kit/data_agreement.py#L770-L820">src/fabricops_kit/data_agreement.py</a></td>
        </tr>
        <tr>
          <td data-label="Helper"><code>_get_notebookutils</code></td>
          <td data-label="Role">Return a notebookutils-like object when the Fabric runtime exposes one.</td>
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/427905557f281c2de218c8d2213dc8798864c090/src/fabricops_kit/data_agreement.py#L758-L767">src/fabricops_kit/data_agreement.py</a></td>
        </tr>
        <tr>
    ...
    ??? example "View helper source code"
        ...
        **`def _render_agreement_evidence_widget(*, spark: Any, config: Any, env_name: str, display_widget: bool=True) -> dict[str, Any]`**
        ...
        Source: [`src/fabricops_kit/data_agreement.py`](https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/427905557f281c2de218c8d2213dc8798864c090/src/fabricops_kit/data_agreement.py#L1341-L1459)
...
```
        ...
        **`def _save_agreement_evidence_records(*, spark: Any, config: Any, env_name: str, agreement_id: str, contract_version: str, evidence_type: str, evidence_file_paths: Any, committed_by: str | None=None, committed_at: str | None=None, runtime_context: dict[str, Any] | None=None) -> list[dict[str, Any]]`**
        ...
        Source: [`src/fabricops_kit/data_agreement.py`](https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/427905557f281c2de218c8d2213dc8798864c090/src/fabricops_kit/data_agreement.py#L822-L853)
...
```
        ...
        **`def _prepare_evidence_file_references(paths_value: Any) -> list[dict[str, str]]`**
        ...
        Source: [`src/fabricops_kit/data_agreement.py`](https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/427905557f281c2de218c8d2213dc8798864c090/src/fabricops_kit/data_agreement.py#L770-L820)
...
```
        ...
        **`def _get_notebookutils() -> Any`**
        ...
        Source: [`src/fabricops_kit/data_agreement.py`](https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/427905557f281c2de218c8d2213dc8798864c090/src/fabricops_kit/data_agreement.py#L758-L767)
...
- Source file path: `src/fabricops_kit/data_agreement.py`
- GitHub source URL: <a href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/427905557f281c2de218c8d2213dc8798864c090/src/fabricops_kit/data_agreement.py#L1462-L1495">https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/427905557f281c2de218c8d2213dc8798864c090/src/fabricops_kit/data_agreement.py#L1462-L1495</a>
- Start line: `1462`
- End line: `1495`
- Signature:
