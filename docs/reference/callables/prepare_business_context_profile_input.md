...
## Use this when
Use `prepare_business_context_profile_input` during template-driven notebook execution.
...
- `fabricops_kit.business_context._prepare_business_context_profile_input`
