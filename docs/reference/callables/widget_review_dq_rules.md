...
- <a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/427905557f281c2de218c8d2213dc8798864c090/src/fabricops_kit/governance_review.py#L661-L824">View widget_review_dq_rules on GitHub</a>
...
??? info "Nested helper functions: 16"
    ...
    These nested helpers support `widget_review_dq_rules` by handling lower-level implementation steps; expand this section only when maintaining or debugging the package internals.
    ...
    <table class="reference-function-table">
      ...
      <tbody>
        ...
        <tr>
          <td data-label="Helper"><code>_dq_parameter_fields_for_rule_type</code></td>
          <td data-label="Role">Return parameter names a reviewer should fill for a rule type.</td>
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/427905557f281c2de218c8d2213dc8798864c090/src/fabricops_kit/governance_review.py#L623-L641">src/fabricops_kit/governance_review.py</a></td>
        </tr>
        <tr>
          <td data-label="Helper"><code>_dq_rule_display_rows</code></td>
          <td data-label="Role">Return table-shaped rows for active and inactive selected-table rules.</td>
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/427905557f281c2de218c8d2213dc8798864c090/src/fabricops_kit/governance_review.py#L590-L620">src/fabricops_kit/governance_review.py</a></td>
        </tr>
        <tr>
          <td data-label="Helper"><code>_dq_rule_parameters_summary</code></td>
          <td data-label="Role">Return compact display text for non-identity DQ parameters.</td>
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/427905557f281c2de218c8d2213dc8798864c090/src/fabricops_kit/governance_review.py#L572-L587">src/fabricops_kit/governance_review.py</a></td>
        </tr>
        <tr>
          <td data-label="Helper"><code>_draft_dq_rules</code></td>
          <td data-label="Role">Draft candidate DQ rules from metadata profiles or a raw DataFrame fallback.</td>
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/427905557f281c2de218c8d2213dc8798864c090/src/fabricops_kit/governance_review.py#L1622-L1630">src/fabricops_kit/governance_review.py</a></td>
        </tr>
        <tr>
          <td data-label="Helper"><code>_extract_assignment_payload</code></td>
          <td data-label="Role">Extract dictionary payloads from AI response rows with optional table-key narrowing.</td>
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/427905557f281c2de218c8d2213dc8798864c090/src/fabricops_kit/governance_review.py#L1166-L1180">src/fabricops_kit/governance_review.py</a></td>
        </tr>
        <tr>
        ...
        <tr>
          <td data-label="Helper"><code>_parse_ai_dict_response</code></td>
          <td data-label="Role">Parse JSON/Python-dict AI response text into a dictionary.</td>
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/427905557f281c2de218c8d2213dc8798864c090/src/fabricops_kit/governance_review.py#L1148-L1163">src/fabricops_kit/governance_review.py</a></td>
        </tr>
        <tr>
          <td data-label="Helper"><code>_prepare_dq_profile_input_rows</code></td>
          <td data-label="Role">Prepare DQ prompt profile rows from a profile DataFrame or raw DataFrame.</td>
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/427905557f281c2de218c8d2213dc8798864c090/src/fabricops_kit/governance_review.py#L1595-L1619">src/fabricops_kit/governance_review.py</a></td>
        </tr>
        <tr>
        ...
        <tr>
          <td data-label="Helper"><code>_run_fabric_ai_drafting</code></td>
          <td data-label="Role">Run Fabric AI prompt drafting against prepared profile rows.</td>
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/427905557f281c2de218c8d2213dc8798864c090/src/fabricops_kit/governance_review.py#L1130-L1135">src/fabricops_kit/governance_review.py</a></td>
        </tr>
        <tr>
...
```
        ...
        **`def _dq_parameter_fields_for_rule_type(rule_type: str) -> list[str]`**
        ...
        Source: [`src/fabricops_kit/governance_review.py`](https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/427905557f281c2de218c8d2213dc8798864c090/src/fabricops_kit/governance_review.py#L623-L641)
...
```
        ...
        **`def _dq_rule_display_rows(rules: list[dict[str, Any]]) -> list[dict[str, Any]]`**
        ...
        Source: [`src/fabricops_kit/governance_review.py`](https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/427905557f281c2de218c8d2213dc8798864c090/src/fabricops_kit/governance_review.py#L590-L620)
...
```
        ...
        **`def _dq_rule_parameters_summary(rule: dict[str, Any]) -> str`**
        ...
        Source: [`src/fabricops_kit/governance_review.py`](https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/427905557f281c2de218c8d2213dc8798864c090/src/fabricops_kit/governance_review.py#L572-L587)
...
```
        ...
        **`def _draft_dq_rules(*, profile_df=None, df=None, table_name: str, business_context: str='', prompt_template: str | None=None, output_col: str='response', config: Any=None) -> list[dict[str, Any]]`**
        ...
        Source: [`src/fabricops_kit/governance_review.py`](https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/427905557f281c2de218c8d2213dc8798864c090/src/fabricops_kit/governance_review.py#L1622-L1630)
...
```
        ...
        **`def _extract_assignment_payload(response_rows, *, response_col: str, assignment_key: str | None=None, table_name: str | None=None) -> list[dict[str, Any]]`**
        ...
        Source: [`src/fabricops_kit/governance_review.py`](https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/427905557f281c2de218c8d2213dc8798864c090/src/fabricops_kit/governance_review.py#L1166-L1180)
...
```
        ...
        **`def _parse_ai_dict_response(text: str) -> dict[str, Any]`**
        ...
        Source: [`src/fabricops_kit/governance_review.py`](https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/427905557f281c2de218c8d2213dc8798864c090/src/fabricops_kit/governance_review.py#L1148-L1163)
...
```
        ...
        **`def _prepare_dq_profile_input_rows(*, profile_df=None, df=None, table_name: str, business_context: str='', config: Any=None)`**
        ...
        Source: [`src/fabricops_kit/governance_review.py`](https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/427905557f281c2de218c8d2213dc8798864c090/src/fabricops_kit/governance_review.py#L1595-L1619)
...
```
        ...
        **`def _run_fabric_ai_drafting(prepared_profile_df, *, prompt: str, output_col: str)`**
        ...
        Source: [`src/fabricops_kit/governance_review.py`](https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/427905557f281c2de218c8d2213dc8798864c090/src/fabricops_kit/governance_review.py#L1130-L1135)
...
- Source file path: `src/fabricops_kit/governance_review.py`
- GitHub source URL: <a href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/427905557f281c2de218c8d2213dc8798864c090/src/fabricops_kit/governance_review.py#L661-L824">https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/427905557f281c2de218c8d2213dc8798864c090/src/fabricops_kit/governance_review.py#L661-L824</a>
- Start line: `661`
- End line: `824`
- Signature:
