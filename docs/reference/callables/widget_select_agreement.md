...
<table class="reference-function-table">
  ...
  <tbody>
    <tr>
      ...
      <td data-label="Details">Use in 02_pipeline or 99_explore notebooks to let a user select an approved data agreement before reading, profiling, or writing governed data.</td>
    </tr>
    <tr>
      <td data-label="Item">Do not use when</td>
      <td data-label="Details">Do not use when an agreement has already been programmatically selected and validated, or for catalogue table review selection in 03_governance.</td>
    </tr>
    <tr>
...
```</td>
    ...
    <tr>
      ...
      <td data-label="Details">Raises metadata read, widget dependency, or configuration errors when agreement metadata cannot be loaded.</td>
    </tr>
    <tr>
      <td data-label="Item">Side effects</td>
      <td data-label="Details">Displays an IPython widget and may register the active notebook selection in metadata when requested.</td>
    </tr>
    <tr>
      <td data-label="Item">Related functions</td>
      <td data-label="Details">- <a href="../get_selected_agreement/"><code>fabricops_kit.data_agreement.get_selected_agreement</code></a><br>- <a href="../setup_metadata_tables/"><code>fabricops_kit.config.setup_metadata_tables</code></a></td>
    </tr>
  </tbody>
</table>
</div>
...
- <a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/data_agreement.py#L856-L1080">View widget_select_agreement on GitHub</a>
...
??? info "Nested helper functions: 23"
    ...
    These helpers support `widget_select_agreement` by handling shared implementation tasks reached from the public call flow; expand the source block only when you need maintainer-level details.
    ...
    <table class="reference-function-table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/metadata.py#L476-L526"><code>src/fabricops_kit/metadata.py#L476-L526</code></a></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td data-label="Role">Internal helper used by the package implementation.</td>
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/metadata.py#L422-L473"><code>src/fabricops_kit/metadata.py#L422-L473</code></a></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/metadata.py#L292-L405"><code>src/fabricops_kit/metadata.py#L292-L405</code></a></td>
        </tr>
        <tr>
    ...
    ??? example "View helper source code"
        ...
        **`def _html_escape(value: Any) -> str`**
        ...
        Used by `widget_select_agreement` through the implementation path shown above.
...
- Source file path: `src/fabricops_kit/data_agreement.py`
- GitHub source URL: <a href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/data_agreement.py#L856-L1080">https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/data_agreement.py#L856-L1080</a>
- Start line: `856`
- End line: `1080`
- Signature:
