...
Enrich profile evidence with guardrail context and write catalogue rows.

## What this is for and when to use it

Enrich profile evidence with guardrail context and write catalogue rows.

- Use after profiling and guardrails to persist source or target catalogue evidence through the metadata route.
...
<table class="reference-function-table">
  ...
  <tbody>
    <tr>
      ...
      <td data-label="Meaning">Profile DataFrames returned by :func:`profile_pipeline_datasets`.</td>
    </tr>
    <tr>
...
- <a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/01cad12186fe15942524ddfa6effa011f04aecb5/src/fabricops_kit/pipeline.py#L297-L405">View write_catalogue_evidence on GitHub</a>
...
- **inputs:** profiles, dataset_definitions, config, env, run_id, agreement context, and guardrail results.
...
- Source file path: `src/fabricops_kit/pipeline.py`
- GitHub source URL: <a href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/01cad12186fe15942524ddfa6effa011f04aecb5/src/fabricops_kit/pipeline.py#L297-L405">https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/01cad12186fe15942524ddfa6effa011f04aecb5/src/fabricops_kit/pipeline.py#L297-L405</a>
- Start line: `297`
- End line: `405`
- Signature:
