...
- Source file path: `src/fabricops_kit/pipeline.py`
- <a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/ab4a3b9225b7e46ac2079370f27b99d4ec21a78d/src/fabricops_kit/pipeline.py#L260-L448">View run_table_guardrails on GitHub</a>
    ...
    ??? example "View helper source by area"
        ...
        ??? example "Metadata loading helpers"
            ...
            **`def _build_guardrail_evidence_definitions(table_configs: list[Mapping[str, Any]]) -> dict[str, dict[str, Any]]`**
            ...
            Source: [`src/fabricops_kit/pipeline.py`](https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/ab4a3b9225b7e46ac2079370f27b99d4ec21a78d/src/fabricops_kit/pipeline.py#L228-L257)
            ...
            **`def _table_key(table_config: Mapping[str, Any]) -> str`**
            ...
            Source: [`src/fabricops_kit/pipeline.py`](https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/ab4a3b9225b7e46ac2079370f27b99d4ec21a78d/src/fabricops_kit/pipeline.py#L216-L217)
            ...
            **`def _table_name(table_config: Mapping[str, Any]) -> str`**
            ...
            Source: [`src/fabricops_kit/pipeline.py`](https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/ab4a3b9225b7e46ac2079370f27b99d4ec21a78d/src/fabricops_kit/pipeline.py#L220-L221)
        ...
        ??? example "Other helpers"
            ...
            **`def _guardrail_can_continue(result: Mapping[str, Any] | None) -> bool`**
            ...
            Source: [`src/fabricops_kit/pipeline.py`](https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/ab4a3b9225b7e46ac2079370f27b99d4ec21a78d/src/fabricops_kit/pipeline.py#L224-L225)
...
- Source file path: `src/fabricops_kit/pipeline.py`
- GitHub source URL: <a href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/ab4a3b9225b7e46ac2079370f27b99d4ec21a78d/src/fabricops_kit/pipeline.py#L260-L448">https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/ab4a3b9225b7e46ac2079370f27b99d4ec21a78d/src/fabricops_kit/pipeline.py#L260-L448</a>
- Start line: `260`
- End line: `448`
- Signature:
