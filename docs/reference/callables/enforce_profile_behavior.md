...
<table class="reference-function-table">
  ...
  <tbody>
    <tr>
      ...
      <td data-label="Details">Use in 02_pipeline to enforce load_behavior expectations against previous accepted catalogue profile evidence.</td>
    </tr>
    <tr>
      <td data-label="Item">Do not use when</td>
      <td data-label="Details">Do not use for simple schema validation or DQ-rule enforcement; use validate_schema or enforce_dq_rules for those checks.</td>
    </tr>
    <tr>
...
```</td>
    ...
    <tr>
      ...
      <td data-label="Details">Raises Spark or metadata-read errors when baseline profile evidence cannot be loaded or compared.</td>
    </tr>
    <tr>
      <td data-label="Item">Side effects</td>
      <td data-label="Details">Reads baseline profile metadata and computes current profile evidence; it does not write target data.</td>
    </tr>
    <tr>
      <td data-label="Item">Related functions</td>
      <td data-label="Details">- <a href="../profile_dataframe/"><code>fabricops_kit.data_profiling.profile_dataframe</code></a><br>- <a href="../validate_schema/"><code>fabricops_kit.guardrails.validate_schema</code></a><br>- <a href="../enforce_freshness/"><code>fabricops_kit.guardrails.enforce_freshness</code></a><br>- <a href="../stop_if_failed/"><code>fabricops_kit.guardrails.stop_if_failed</code></a></td>
    </tr>
  </tbody>
</table>
</div>
...
??? info "Nested helper functions: 12"
    ...
    These helpers support `enforce_profile_behavior` by handling shared implementation tasks reached from the public call flow; expand the source block only when you need maintainer-level details.
    ...
    <table class="reference-function-table">
      ...
      <tbody>
        <tr>
          ...
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/guardrails.py#L467-L478"><code>src/fabricops_kit/guardrails.py#L467-L478</code></a></td>
        </tr>
        <tr>
          <td data-label="Helper"><code>_guardrail_exclude_columns</code></td>
          <td data-label="Role">Internal helper used by the package implementation.</td>
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/guardrails.py#L282-L286"><code>src/fabricops_kit/guardrails.py#L282-L286</code></a></td>
        </tr>
        <tr>
          <td data-label="Helper"><code>_is_greater_than</code></td>
          <td data-label="Role">Internal helper used by the package implementation.</td>
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/guardrails.py#L507-L514"><code>src/fabricops_kit/guardrails.py#L507-L514</code></a></td>
        </tr>
        <tr>
          <td data-label="Helper"><code>_comparable_value</code></td>
          <td data-label="Role">Internal helper used by the package implementation.</td>
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/guardrails.py#L485-L494"><code>src/fabricops_kit/guardrails.py#L485-L494</code></a></td>
        </tr>
        <tr>
          <td data-label="Helper"><code>_is_less_than</code></td>
          <td data-label="Role">Internal helper used by the package implementation.</td>
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/guardrails.py#L497-L504"><code>src/fabricops_kit/guardrails.py#L497-L504</code></a></td>
        </tr>
        <tr>
          <td data-label="Helper"><code>_is_missing_table_error</code></td>
          <td data-label="Role">Internal helper used by the package implementation.</td>
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/guardrails.py#L834-L837"><code>src/fabricops_kit/guardrails.py#L834-L837</code></a></td>
        </tr>
        <tr>
          <td data-label="Helper"><code>_latest_catalogue_behavior_profile_row</code></td>
          <td data-label="Role">Internal helper used by the package implementation.</td>
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/guardrails.py#L527-L636"><code>src/fabricops_kit/guardrails.py#L527-L636</code></a></td>
        </tr>
        <tr>
          <td data-label="Helper"><code>_row_to_dict</code></td>
          <td data-label="Role">Internal helper used by the package implementation.</td>
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/guardrails.py#L272-L279"><code>src/fabricops_kit/guardrails.py#L272-L279</code></a></td>
        </tr>
        <tr>
          <td data-label="Helper"><code>_string_value</code></td>
          <td data-label="Role">Internal helper used by the package implementation.</td>
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/guardrails.py#L481-L482"><code>src/fabricops_kit/guardrails.py#L481-L482</code></a></td>
        </tr>
        <tr>
          <td data-label="Helper"><code>_profile_row_count</code></td>
          <td data-label="Role">Internal helper used by the package implementation.</td>
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/guardrails.py#L294-L306"><code>src/fabricops_kit/guardrails.py#L294-L306</code></a></td>
        </tr>
        <tr>
          <td data-label="Helper"><code>_normalize_profile</code></td>
          <td data-label="Role">Internal helper used by the package implementation.</td>
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/guardrails.py#L201-L269"><code>src/fabricops_kit/guardrails.py#L201-L269</code></a></td>
        </tr>
        <tr>
          <td data-label="Helper"><code>_profile_watermark_bounds</code></td>
          <td data-label="Role">Internal helper used by the package implementation.</td>
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/guardrails.py#L517-L524"><code>src/fabricops_kit/guardrails.py#L517-L524</code></a></td>
        </tr>
      </tbody>
    </table>
    ...
    ??? example "View helper source code"
        ...
        **`def _catalogue_value(row: dict, *names: str)`**
        ...
        Used by `enforce_profile_behavior` through the implementation path shown above.
