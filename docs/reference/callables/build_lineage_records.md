...
<table class="reference-function-table">
  ...
  <tbody>
    <tr>
      ...
      <td data-label="Details">Use in pipeline notebooks to build source-to-target lineage evidence rows for a completed transformation run.</td>
    </tr>
    <tr>
      <td data-label="Item">Do not use when</td>
      <td data-label="Details">Do not use to scan notebooks automatically or persist metadata; it only builds records from supplied lineage inputs.</td>
    </tr>
    <tr>
...
```</td>
    ...
    <tr>
      ...
      <td data-label="Details">Raises normal Python errors if required lineage inputs are missing or malformed.</td>
    </tr>
    <tr>
      <td data-label="Item">Side effects</td>
      <td data-label="Details">Pure record-building helper; it does not write metadata, tables, or files.</td>
    </tr>
    <tr>
      <td data-label="Item">Related functions</td>
      <td data-label="Details">- <a href="../setup_notebook/"><code>fabricops_kit.config.setup_notebook</code></a><br>- <a href="../write_lakehouse_table/"><code>fabricops_kit.fabric_input_output.write_lakehouse_table</code></a></td>
    </tr>
  </tbody>
</table>
</div>
...
- <a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/data_lineage.py#L212-L236">View build_lineage_records on GitHub</a>
...
??? info "Nested helper functions: 3"
    ...
    These helpers support `build_lineage_records` by handling shared implementation tasks reached from the public call flow; expand the source block only when you need maintainer-level details.
    ...
    ??? example "View helper source code"
        ...
        **`def _current_audit_timestamp(config: Any=None, timezone_name: str | None=None, *, drop_microseconds: bool=True) -> str`**
        ...
        Used by `build_lineage_records` through the implementation path shown above.
...
- Source file path: `src/fabricops_kit/data_lineage.py`
- GitHub source URL: <a href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/data_lineage.py#L212-L236">https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/data_lineage.py#L212-L236</a>
- Start line: `212`
- End line: `236`
- Signature:
