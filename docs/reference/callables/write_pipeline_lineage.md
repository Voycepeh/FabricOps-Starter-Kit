...
<table class="reference-function-table">
  ...
  <tbody>
    <tr>
      ...
      <td data-label="Details">Use after target writes to persist lineage relationships tied to agreement and notebook registry context.</td>
    </tr>
    <tr>
...
```</td>
    ...
    <tr>
      ...
      <td data-label="Details">Writes METADATA_DATA_LINEAGE_TABLE through the configured metadata lakehouse target.</td>
    </tr>
    <tr>
      <td data-label="Item">Related functions</td>
      <td data-label="Details">- <a href="../write_catalogue_evidence/"><code>fabricops_kit.pipeline.write_catalogue_evidence</code></a><br>- <a href="../build_lineage_records/"><code>fabricops_kit.data_lineage.build_lineage_records</code></a><br>- <a href="../write_pipeline_run_summary/"><code>fabricops_kit.pipeline.write_pipeline_run_summary</code></a></td>
    </tr>
  </tbody>
</table>
</div>
...
- <a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/pipeline.py#L558-L642">View write_pipeline_lineage on GitHub</a>
...
??? info "Nested helper functions: 12"
    ...
    These helpers support `write_pipeline_lineage` by handling shared implementation tasks reached from the public call flow; expand the source block only when you need maintainer-level details.
    ...
    ??? example "View helper source code"
        ...
        **`def _build_metadata_table_key(environment_name, dataset_name, table_name) -> str`**
        ...
        Used by `write_pipeline_lineage` through the implementation path shown above.
...
- Source file path: `src/fabricops_kit/pipeline.py`
- GitHub source URL: <a href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/pipeline.py#L558-L642">https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/pipeline.py#L558-L642</a>
- Start line: `558`
- End line: `642`
- Signature:
