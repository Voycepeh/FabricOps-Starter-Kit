...
<table class="reference-function-table">
  ...
  <tbody>
    <tr>
      ...
      <td data-label="Details">Use before target writes to enforce active approved DQ rules for a dataset/table as a pipeline guardrail.</td>
    </tr>
    <tr>
      <td data-label="Item">Do not use when</td>
      <td data-label="Details">Do not use to filter bad rows, author new DQ rules, or bypass governance review approval.</td>
    </tr>
    <tr>
...
```</td>
    ...
    <tr>
      ...
      <td data-label="Details">Raises configuration, metadata-read, or Spark expression errors when approved rules cannot be loaded or evaluated.</td>
    </tr>
    <tr>
      <td data-label="Item">Side effects</td>
      <td data-label="Details">Reads approved DQ-rule metadata and evaluates checks against the DataFrame; it does not filter the DataFrame or write target data.</td>
    </tr>
    <tr>
      <td data-label="Item">Related functions</td>
      <td data-label="Details">- <a href="../record_table_governance/"><code>fabricops_kit.governance_review.record_table_governance</code></a><br>- <a href="../stop_if_failed/"><code>fabricops_kit.guardrails.stop_if_failed</code></a></td>
    </tr>
  </tbody>
</table>
</div>
...
- <a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/governance_review.py#L1536-L1593">View enforce_dq_rules on GitHub</a>
...
??? info "Nested helper functions: 16"
    ...
    These helpers support `enforce_dq_rules` by handling shared implementation tasks reached from the public call flow; expand the source block only when you need maintainer-level details.
    ...
    <table class="reference-function-table">
      ...
      <tbody>
        <tr>
          ...
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/governance_review.py#L1485-L1495"><code>src/fabricops_kit/governance_review.py#L1485-L1495</code></a></td>
        </tr>
        <tr>
          ...
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/governance_review.py#L1321-L1403"><code>src/fabricops_kit/governance_review.py#L1321-L1403</code></a></td>
        </tr>
        <tr>
          ...
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/governance_review.py#L1120-L1127"><code>src/fabricops_kit/governance_review.py#L1120-L1127</code></a></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/governance_review.py#L1498-L1513"><code>src/fabricops_kit/governance_review.py#L1498-L1513</code></a></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td data-label="Role">Internal helper used by the package implementation.</td>
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/governance_review.py#L1516-L1533"><code>src/fabricops_kit/governance_review.py#L1516-L1533</code></a></td>
        </tr>
        <tr>
          ...
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/governance_review.py#L1449-L1482"><code>src/fabricops_kit/governance_review.py#L1449-L1482</code></a></td>
        </tr>
        <tr>
          ...
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/governance_review.py#L1282-L1317"><code>src/fabricops_kit/governance_review.py#L1282-L1317</code></a></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/governance_review.py#L1258-L1279"><code>src/fabricops_kit/governance_review.py#L1258-L1279</code></a></td>
        </tr>
        <tr>
          ...
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/governance_review.py#L1411-L1446"><code>src/fabricops_kit/governance_review.py#L1411-L1446</code></a></td>
        </tr>
        <tr>
          <td data-label="Helper"><code>_dq_check_status</code></td>
          <td data-label="Role">Internal helper used by the package implementation.</td>
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/governance_review.py#L1405-L1408"><code>src/fabricops_kit/governance_review.py#L1405-L1408</code></a></td>
        </tr>
      </tbody>
    </table>
    ...
    ??? example "View helper source code"
        ...
        **`def _dq_failed_row_count(df, rules: list[dict[str, Any]]) -> int`**
        ...
        Used by `enforce_dq_rules` through the implementation path shown above.
...
- Source file path: `src/fabricops_kit/governance_review.py`
- GitHub source URL: <a href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/governance_review.py#L1536-L1593">https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/governance_review.py#L1536-L1593</a>
- Start line: `1536`
- End line: `1593`
- Signature:
