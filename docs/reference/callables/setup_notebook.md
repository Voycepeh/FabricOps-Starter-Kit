...
<table class="reference-function-table">
  ...
  <tbody>
    <tr>
      ...
      <td data-label="Details">Starting a FabricOps notebook from 00_env_config<br>Validating configured environment targets before downstream helpers run<br>Capturing runtime metadata for later lineage, review, or handover steps</td>
    </tr>
    <tr>
      <td data-label="Item">Do not use when</td>
      <td data-label="Details">Do not use as a replacement for metadata table setup or per-table governance writes; call setup_metadata_tables for metadata storage preparation.</td>
    </tr>
    <tr>
...
```</td>
    ...
    <tr>
      ...
      <td data-label="Details">ValueError for invalid configuration sections, missing required paths, or unresolved required targets.</td>
    </tr>
    <tr>
      <td data-label="Item">Side effects</td>
      <td data-label="Details">Runs configuration validation and Fabric readiness checks; it does not write FabricOps metadata tables.</td>
    </tr>
    <tr>
      <td data-label="Item">Related functions</td>
      <td data-label="Details">- <a href="../setup_metadata_tables/"><code>fabricops_kit.config.setup_metadata_tables</code></a></td>
    </tr>
  </tbody>
</table>
</div>
...
- <a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/config.py#L777-L886">View setup_notebook on GitHub</a>
...
??? info "Nested helper functions: 7"
    ...
    These helpers support `setup_notebook` by handling shared implementation tasks reached from the public call flow; expand the source block only when you need maintainer-level details.
    ...
    <table class="reference-function-table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/config.py#L675-L774"><code>src/fabricops_kit/config.py#L675-L774</code></a></td>
        </tr>
        <tr>
          <td data-label="Helper"><code>_check_spark_session</code></td>
          <td data-label="Role">Check whether a Spark session is available.</td>
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/config.py#L1102-L1107"><code>src/fabricops_kit/config.py#L1102-L1107</code></a></td>
        </tr>
        <tr>
          ...
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/config.py#L1110-L1149"><code>src/fabricops_kit/config.py#L1110-L1149</code></a></td>
        </tr>
        <tr>
          ...
          <td data-label="Source"><a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/config.py#L661-L672"><code>src/fabricops_kit/config.py#L661-L672</code></a></td>
        </tr>
        <tr>
    ...
    ??? example "View helper source code"
        ...
        **`def _get_store(config: FrameworkConfig | PathConfig | None, env: str, target: str) -> Any`**
        ...
        Used by `setup_notebook` through the implementation path shown above.
...
- Source file path: `src/fabricops_kit/config.py`
- GitHub source URL: <a href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/config.py#L777-L886">https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/config.py#L777-L886</a>
- Start line: `777`
- End line: `886`
- Signature:
