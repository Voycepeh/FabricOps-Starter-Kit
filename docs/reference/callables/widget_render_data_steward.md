...
- <a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/data_agreement.py#L1130-L1338">View `_render_maintenance_widget` on GitHub</a>
...
`widget_render_data_steward` reaches this helper in its implementation path.

**Modify this if:**

You want to change the implementation behavior summarized above for `widget_render_data_steward` or another caller that reaches `_render_maintenance_widget`.
...
- `src/fabricops_kit/data_agreement.py`
- <a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/data_agreement.py#L1117-L1127">View `_agreement_identity_text` on GitHub</a>
...
You want to change the implementation behavior summarized above for `widget_render_data_steward` or another caller that reaches `_agreement_identity_text`.
...
- `src/fabricops_kit/data_agreement.py`
- <a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/data_agreement.py#L647-L650">View `_next_minor_version` on GitHub</a>
...
You want to change the implementation behavior summarized above for `widget_render_data_steward` or another caller that reaches `_next_minor_version`.
...
- `src/fabricops_kit/data_agreement.py`
- <a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/data_agreement.py#L638-L644">View `_parse_contract_version` on GitHub</a>
...
You want to change the implementation behavior summarized above for `widget_render_data_steward` or another caller that reaches `_parse_contract_version`.
...
- `src/fabricops_kit/data_agreement.py`
- <a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/data_agreement.py#L362-L394">View `_collect_custom_fields` on GitHub</a>
...
You want to change the implementation behavior summarized above for `widget_render_data_steward` or another caller that reaches `_collect_custom_fields`.
...
- `src/fabricops_kit/data_agreement.py`
- <a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/data_agreement.py#L698-L701">View `_to_iso_date` on GitHub</a>
...
You want to change the implementation behavior summarized above for `widget_render_data_steward` or another caller that reaches `_to_iso_date`.
...
You want to change the implementation behavior summarized above for `widget_render_data_steward` or another caller that reaches `_config_value`.
...
- `src/fabricops_kit/data_agreement.py`
- <a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/data_agreement.py#L711-L755">View `_create_or_update_data_agreement` on GitHub</a>
...
You want to change the implementation behavior summarized above for `widget_render_data_steward` or another caller that reaches `_create_or_update_data_agreement`.
...
- `src/fabricops_kit/data_agreement.py`
- <a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/data_agreement.py#L704-L708">View `_business_agreement_snapshot` on GitHub</a>
...
You want to change the implementation behavior summarized above for `widget_render_data_steward` or another caller that reaches `_business_agreement_snapshot`.
...
- `src/fabricops_kit/data_agreement.py`
- <a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/data_agreement.py#L118-L146">View `_deserialize_custom_fields` on GitHub</a>
...
You want to change the implementation behavior summarized above for `widget_render_data_steward` or another caller that reaches `_deserialize_custom_fields`.
...
- `src/fabricops_kit/data_agreement.py`
- <a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/data_agreement.py#L102-L115">View `_serialize_custom_fields` on GitHub</a>
...
You want to change the implementation behavior summarized above for `widget_render_data_steward` or another caller that reaches `_serialize_custom_fields`.
...
- `src/fabricops_kit/data_agreement.py`
- <a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/data_agreement.py#L694-L695">View `_generate_agreement_id` on GitHub</a>
...
You want to change the implementation behavior summarized above for `widget_render_data_steward` or another caller that reaches `_generate_agreement_id`.
...
You want to change the implementation behavior summarized above for `widget_render_data_steward` or another caller that reaches `_list_all_data_agreement_rows`.
...
You want to change the implementation behavior summarized above for `widget_render_data_steward` or another caller that reaches `_coerce_row_dicts`.
...
You want to change the implementation behavior summarized above for `widget_render_data_steward` or another caller that reaches `_list_data_stewards`.
...
You want to change the implementation behavior summarized above for `widget_render_data_steward` or another caller that reaches `_active_steward`.
...
You want to change the implementation behavior summarized above for `widget_render_data_steward` or another caller that reaches `_to_bool`.
...
You want to change the implementation behavior summarized above for `widget_render_data_steward` or another caller that reaches `_latest_by_key`.
...
- `src/fabricops_kit/data_agreement.py`
- <a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/data_agreement.py#L572-L582">View `_parse_iso_date` on GitHub</a>
...
You want to change the implementation behavior summarized above for `widget_render_data_steward` or another caller that reaches `_parse_iso_date`.
...
You want to change the implementation behavior summarized above for `widget_render_data_steward` or another caller that reaches `_write_row`.
...
You want to change the implementation behavior summarized above for `widget_render_data_steward` or another caller that reaches `_build_runtime_audit_fields`.
...
You want to change the implementation behavior summarized above for `widget_render_data_steward` or another caller that reaches `_current_audit_timestamp`.
...
You want to change the implementation behavior summarized above for `widget_render_data_steward` or another caller that reaches `_get_audit_timezone`.
...
You want to change the implementation behavior summarized above for `widget_render_data_steward` or another caller that reaches `_validate_audit_timezone`.
...
You want to change the implementation behavior summarized above for `widget_render_data_steward` or another caller that reaches `_context_get`.
...
You want to change the implementation behavior summarized above for `widget_render_data_steward` or another caller that reaches `_runtime_context`.
...
You want to change the implementation behavior summarized above for `widget_render_data_steward` or another caller that reaches `_safe_str`.
...
- `src/fabricops_kit/data_agreement.py`
- <a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/data_agreement.py#L585-L635">View `_create_or_update_data_steward` on GitHub</a>
...
You want to change the implementation behavior summarized above for `widget_render_data_steward` or another caller that reaches `_create_or_update_data_steward`.
...
- `src/fabricops_kit/data_agreement.py`
- <a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/data_agreement.py#L529-L533">View `_generate_steward_id` on GitHub</a>
...
You want to change the implementation behavior summarized above for `widget_render_data_steward` or another caller that reaches `_generate_steward_id`.
...
- `src/fabricops_kit/data_agreement.py`
- <a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/data_agreement.py#L156-L177">View `_get_widget_visible_fields` on GitHub</a>
...
You want to change the implementation behavior summarized above for `widget_render_data_steward` or another caller that reaches `_get_widget_visible_fields`.
...
- `src/fabricops_kit/data_agreement.py`
- <a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/data_agreement.py#L684-L691">View `_list_data_agreements` on GitHub</a>
...
You want to change the implementation behavior summarized above for `widget_render_data_steward` or another caller that reaches `_list_data_agreements`.
...
- `src/fabricops_kit/data_agreement.py`
- <a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/data_agreement.py#L653-L669">View `_latest_agreement_versions` on GitHub</a>
...
You want to change the implementation behavior summarized above for `widget_render_data_steward` or another caller that reaches `_latest_agreement_versions`.
...
- `src/fabricops_kit/data_agreement.py`
- <a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/data_agreement.py#L310-L359">View `_render_custom_fields` on GitHub</a>
...
You want to change the implementation behavior summarized above for `widget_render_data_steward` or another caller that reaches `_render_custom_fields`.
...
You want to change the implementation behavior summarized above for `widget_render_data_steward` or another caller that reaches `_require_ipywidgets`.
...
You want to change the implementation behavior summarized above for `widget_render_data_steward` or another caller that reaches `_widget_common`.
...
You want to change the implementation behavior summarized above for `widget_render_data_steward` or another caller that reaches `_render_searchable_selector`.
...
You want to change the implementation behavior summarized above for `widget_render_data_steward` or another caller that reaches `_html_escape`.
...
- `src/fabricops_kit/data_agreement.py`
- <a class="reference-source-link" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/83d4716971843467c062fedf57d0ef56cc62beea/src/fabricops_kit/data_agreement.py#L1101-L1114">View `_standard_widget` on GitHub</a>
...
You want to change the implementation behavior summarized above for `widget_render_data_steward` or another caller that reaches `_standard_widget`.
