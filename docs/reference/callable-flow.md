...
??? info "Full searchable inventory"
    ...
    <td class="flow-cell-number">3</td>
    <td class="flow-cell-number">1</td>
    <td class="flow-cell-wide">Inspect manually</td>
    </tr>
    <tr>
...
??? info "Inventory by signal"
    ...
    ??? info "Single-use internal helper"
