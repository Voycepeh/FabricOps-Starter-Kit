...
For the Governance Review operating model, see [Governance Review](../../guided-demo/review-guardrails.md).
...
- **Example JSON**: a small public-safe example that can be adapted in `03_review`.
