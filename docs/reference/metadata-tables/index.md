...
-   **[METADATA_DATA_ACCESS](metadata-data-access.md)**
...
-   **[METADATA_DATA_LINEAGE_TABLE](metadata-data-lineage-table.md)**

    Source-to-target lineage evidence written by pipeline runs.

    `02_pipeline.ipynb`

-   **[METADATA_DATA_STEWARD](metadata-data-steward.md)**

    Active and historical data steward records used by agreement intake.

    `01_agreement.ipynb`

-   **[METADATA_ENRICHMENT_RULES](metadata-enrichment-rules.md)**
