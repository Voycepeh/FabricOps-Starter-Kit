...
| --- | --- |
| [Read and write across multiple Fabric items](multiple-fabric-items.md) | Keep Lakehouse and Warehouse routing in `00_env_config` instead of hardcoding environment-specific paths throughout a notebook. |
...
| [ETL Guardrails](etl-guardrails.md) | Govern source observation, source DQ, transformation, and environment-specific target validation and profiling. |
