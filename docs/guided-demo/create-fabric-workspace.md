...
Create or choose the Microsoft Fabric workspace that will host the copied demo notebooks and runtime items.
...
4. Upload the FabricOps wheel to the Environment by following [Install](../install.md).
...
For the detailed role of each notebook, see [Template Notebooks](../how-fabricops-works/notebook-templates.md).
