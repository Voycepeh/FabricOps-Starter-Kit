...
FabricOps, short for **Fabric Operations**, is a governed Data Engineering and Data Governance practice for Microsoft Fabric.
...
The [FabricOps Glossary](https://voycepeh.github.io/FabricOps-Starter-Kit/glossary/) is the terminology source of truth for this repository. Microsoft Fabric terms follow Microsoft terminology where possible, established Data Governance and Data Engineering terms keep their broader meaning, and FabricOps concepts describe the framework's specific operating model and implementation.
