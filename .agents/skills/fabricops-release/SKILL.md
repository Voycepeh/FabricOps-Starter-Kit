...
5. **Verification** - successful canonical CI for the candidate commit, release-specific consistency checks, generated-output provenance checks, and a clean working tree.
