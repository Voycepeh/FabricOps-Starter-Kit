...
PUBLIC_SYMBOL_DOCS = [
 ...
 {'kind': 'function',
  'module': 'pipeline',
  'function_type': 'callable',
  'summary_override': 'Detect mutation of previously processed source data against the source table load strategy.',
  ...
  'parameters': 'Canonical governed source table_id.',
 ...
 'preferred_example': 'stability_result = check_source_stability(table_id)',
