...
MODULE_DOCS_METADATA = [{'module_name': 'config',
 ...
 {'module_name': 'io',
  'visibility': 'internal',
  'module_summary': 'Owns shared internal IO helpers used by one-function IO owner modules.',
  'sidebar_group': 'Internal architecture',
  'sidebar_include': False},
 {'module_name': 'io_core',
  'visibility': 'internal',
  'module_summary': 'Owns lower-level Fabric IO implementations shared by package internals.',
  'sidebar_group': 'Internal architecture',
  'sidebar_include': True},
...
TEMPLATE_FLOW_DOCS = [{'notebook_key': '00_env_config',
 ...
 {'notebook_key': '02_pipeline',
  ...
  'segments': [{'symbols': ['start_pipeline_run',
...
PUBLIC_SYMBOL_DOCS = [{'kind': 'function',
 ...
 {'kind': 'function',
  'module': 'fabric_input_output',
  'function_type': 'callable',
  'summary_override': 'Read a CSV file from a Fabric resolved path.',
  'symbol_name': 'read_lakehouse_csv',
  'template_notebook': '02_pipeline / optional 99_explore',
  'template_segment': 'Fabric IO',
  'use_when': 'Use when reading a CSV file from a relative path resolved through get_path.',
  ...
  'parameters': 'config, env, target, relative_path, CSV read options, verbose flag, and optional '
                'spark_session.',
  'returns': 'Spark DataFrame loaded from the resolved CSV path.',
  'raises': 'Raises ValueError for invalid file paths and configuration/Spark errors when the file '
            'cannot be read.',
  'side_effects': 'Reads from the resolved Fabric path; it does not write metadata, tables, or files.',
  'fabric_context': 'Requires the FrameworkConfig or compatible CONFIG from 00_env_config plus the '
                    'intended env name; never hardcode Fabric workspace or item identifiers.',
  'ai_verification': 'Verify relative_path resolves through get_path, then check row count and schema after reading.',
  ...
  'expanded_purpose': 'Reads a CSV file from a Fabric resolved path and returns it as a Spark DataFrame.',
  'when_to_use': 'Use for file-based source ingestion when the source is CSV and should be resolved through get_path.',
  ...
  'common_failure_causes': ['The resolved file path is wrong or unavailable.',
                            'CSV options do not match the file shape.',
                            'Spark cannot access the file.',
                            'The selected environment is missing the configured source target.'],
  'related_guides': [{'title': 'Notebook Templates Implementation Guide',
                      'path': '../../notebook-templates-implementation-guide/index.md'}]},
 {'kind': 'function',
  'module': 'fabric_input_output',
  'function_type': 'callable',
  'summary_override': 'Read a Parquet path from a Fabric resolved path.',
  'symbol_name': 'read_lakehouse_parquet',
  'template_notebook': '02_pipeline / optional 99_explore',
  'template_segment': 'Fabric IO',
  'use_when': 'Use when reading a Parquet file or path from a relative path resolved through get_path.',
  ...
  'side_effects': 'Reads from the resolved Fabric path and may create a local timestamp-converted fallback for single-file Parquet precision issues; it does not write metadata tables.',
  'fabric_context': 'Requires the FrameworkConfig or compatible CONFIG from 00_env_config plus the '
                    'intended env name; never hardcode Fabric workspace or item identifiers.',
  'ai_verification': 'Verify the resolved Parquet path and check row count/schema after reading.',
  ...
  'expanded_purpose': 'Reads a Parquet file or folder from a Fabric resolved path into a Spark DataFrame.',
 ...
 {'kind': 'function',
  ...
  'function_type': 'callable',
  'summary_override': 'Fetch the latest metadata catalogue rows for a table without writing metadata.',
  'symbol_name': 'get_latest_metadata_catalogue',
  'template_notebook': '99_explore',
  'template_segment': 'Read-only catalogue context',
  'use_when': 'Use in 99_explore after selecting agreement context and reading a source table to inspect existing catalogue evidence.',
  'do_not_use_when': 'Do not use as an enforcement, approval, or metadata persistence step; it is read-only exploration support.',
  'parameters': 'table_name, optional agreement context, metadata_schema, spark_session, and advanced context override.',
  'returns': 'Latest matching catalogue rows as a Spark DataFrame when possible, otherwise a list of dictionaries. Missing catalogue evidence returns a friendly not_found row.',
  'side_effects': 'Reads METADATA_DATA_CATALOGUE from the configured metadata target only; does not write metadata.',
  ...
  'return_interpretation': 'Rows describe the latest available catalogue profile for the requested table, or a friendly not_found message when none exists.',
  'common_failure_causes': ['The metadata catalogue table does not exist yet.', 'No profile has been written for the selected table.', 'The metadata lakehouse cannot be read.'],
  'related_guides': [{'title': 'Notebook Templates Implementation Guide', 'path': '../../notebook-templates-implementation-guide/index.md'}]},
 {'kind': 'function',
 ...
 {'kind': 'function',
  'module': 'pipeline',
  'function_type': 'callable',
  'summary_override': 'Start a guided notebook run and store runtime defaults.',
  'symbol_name': 'start_pipeline_run',
  'template_notebook': '02_pipeline',
  'template_segment': 'Runtime context setup',
  ...
  'preferred_example': 'PIPELINE = start_pipeline_run(notebook_type="02_pipeline", select_agreement=True, register_notebook=True)',
  'related_functions': ['run_table_guardrails', 'write_pipeline_run_summary', 'widget_select_agreement'],
  ...
  'related_guides': [{'title': 'Notebook Templates Implementation Guide', 'path': '../../notebook-templates-implementation-guide/index.md'}, {'title': 'Pipeline Execution', 'path': '../../notebook-templates-implementation-guide/pipeline-execution.md'}]},
 {'kind': 'function',
  'module': 'pipeline',
  'function_type': 'callable',
...
PUBLIC_SYMBOL_DOCS_SUPPLEMENTAL = {'setup_notebook': {'expanded_purpose': 'Validates the selected FabricOps environment, resolves '
 ...
 'read_lakehouse_csv': {'expanded_purpose': 'Reads a CSV file from a Fabric resolved path and returns it as a Spark DataFrame.',
                        'when_to_use': 'Use for file-based source ingestion when the source is CSV and should be resolved through get_path.',
                        'glossary_terms': ['source data', 'notebook template'],
                        ...
                        'common_failure_causes': ['The file path is wrong or outside the '
                                                  ...
                                                  'lakehouse target.']},
 'read_lakehouse_parquet': {'expanded_purpose': 'Reads a Parquet file or folder from a Fabric resolved path into a Spark DataFrame.',
 ...
 'write_warehouse_table': {'expanded_purpose': 'Writes a DataFrame to a configured Fabric '
                           ...
                           'common_failure_causes': ['The warehouse target is missing from '
                                                     ...
                                                     'Warehouse connector support is unavailable.',
                                                     'The caller lacks write permission.']},
 'get_latest_metadata_catalogue': {'expanded_purpose': 'Fetches existing METADATA_DATA_CATALOGUE evidence for a selected table and agreement context so 99_explore can stay context-aware and read-only.',
                                  'when_to_use': 'Use in 99_explore for discovery, profiling, troubleshooting, or investigation when existing catalogue context may help.',
                                  'glossary_terms': ['metadata lakehouse', 'profile', 'data agreement'],
                                  'return_interpretation': 'Rows describe the latest available catalogue profile for the requested table, or a friendly not_found message when none exists.',
                                  'common_failure_causes': ['The metadata catalogue table does not exist yet.',
 ...
 'start_pipeline_run': {'expanded_purpose': 'Resolves runtime and agreement context once so template notebooks can call guardrail and summary helpers with concise defaults.',
                        'when_to_use': 'Use near the top of 02_pipeline or read-only exploration notebooks that need agreement-aware runtime defaults.',
                        'glossary_terms': ['notebook template', 'data agreement', 'metadata lakehouse'],
                        'return_interpretation': 'The returned context can be assigned to PIPELINE for target config and lineage fields while downstream helpers read the same active defaults automatically. The concrete context class is internal and not a primary public API.',
...
RELATED_GUIDES_BY_SYMBOL = {'setup_notebook': [{'title': 'Notebook Templates Implementation Guide',
                     'path': '../../notebook-templates-implementation-guide/index.md'},
                    {'title': 'Metadata Tables',
                     'path': '../../reference/metadata.md'}],
 'setup_metadata_tables': [{'title': 'Notebook Templates Implementation Guide',
                            'path': '../../notebook-templates-implementation-guide/index.md'},
                           {'title': 'Metadata Tables',
                            'path': '../../reference/metadata.md'}],
 'widget_render_data_steward': [{'title': 'Notebook Templates Implementation Guide',
                                 'path': '../../notebook-templates-implementation-guide/index.md'}],
 'widget_render_data_agreement': [{'title': 'Notebook Templates Implementation Guide',
                                   'path': '../../notebook-templates-implementation-guide/index.md'}],
 'widget_render_agreement_evidence': [{'title': 'Notebook Templates Implementation Guide',
                                       'path': '../../notebook-templates-implementation-guide/index.md'},
                                      {'title': 'Metadata Tables',
                                       'path': '../../reference/metadata.md'}],
 'read_lakehouse_table': [{'title': 'Notebook Templates Implementation Guide',
                           'path': '../../notebook-templates-implementation-guide/index.md'}],
 'write_lakehouse_table': [{'title': 'Notebook Templates Implementation Guide',
                            'path': '../../notebook-templates-implementation-guide/index.md'},
                           {'title': 'Metadata Tables',
                            'path': '../../reference/metadata.md'}],
 'read_lakehouse_csv': [{'title': 'Notebook Templates Implementation Guide',
                         'path': '../../notebook-templates-implementation-guide/index.md'}],
 'read_lakehouse_parquet': [{'title': 'Notebook Templates Implementation Guide',
                             'path': '../../notebook-templates-implementation-guide/index.md'}],
 'read_lakehouse_excel': [{'title': 'Notebook Templates Implementation Guide',
                           'path': '../../notebook-templates-implementation-guide/index.md'}],
 'read_warehouse_table': [{'title': 'Notebook Templates Implementation Guide',
                           'path': '../../notebook-templates-implementation-guide/index.md'}],
 'write_warehouse_table': [{'title': 'Notebook Templates Implementation Guide',
                            'path': '../../notebook-templates-implementation-guide/index.md'}],
 ...
 'stop_if_failed': [{'title': 'Pipeline Execution',
                     'path': '../../notebook-templates-implementation-guide/pipeline-execution.md'}],
 'prepare_pipeline_table_configs': [{'title': 'Notebook Templates Implementation Guide',
                                     'path': '../../notebook-templates-implementation-guide/index.md'},
                                    {'title': 'Pipeline Execution',
                                     'path': '../../notebook-templates-implementation-guide/pipeline-execution.md'}],
 ...
 'write_catalogue_evidence': [{'title': 'Pipeline Execution',
                              ...
                              {'title': 'Metadata Tables',
                               'path': '../../reference/metadata.md'}],
 'write_pipeline_lineage': [{'title': 'Notebook Templates Implementation Guide',
                             'path': '../../notebook-templates-implementation-guide/index.md'},
                            {'title': 'Metadata Tables',
                             'path': '../../reference/metadata.md'}],
