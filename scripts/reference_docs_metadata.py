...
METADATA_TABLE_MODELS = {
    ...
    "METADATA_GUARDRAIL": {
        "purpose": "Define enforced Schema, Freshness, Source Stability, Data Quality, and Sensitive Data requirements with Warn or Block actions.",
...
METADATA_COLUMN_OWNERS = {
    ...
    "METADATA_GUARDRAIL_RESULTS": {
        "__default__": [
            ...
            "fabricops_kit.pipeline.check_source_stability.check_source_stability",
...
TEMPLATE_FLOW_DOCS = [{'notebook_key': '00_env_config',
 ...
 {'notebook_key': '02_pipeline',
  ...
  'segments': [{'symbols': ['widget_select_data_contract'],
               ...
               {'symbols': ['pipeline_read', 'check_schema', 'check_freshness', 'check_source_stability', 'check_dq'],
...
PUBLIC_SYMBOL_DOCS = [
 ...
 {'kind': 'function',
  ...
  'related_functions': ['check_freshness', 'check_source_stability']},
 {'kind': 'function',
  'module': 'pipeline',
  'function_type': 'callable',
  ...
  'related_functions': ['check_schema', 'check_source_stability', 'enforce_freshness']},
 {'kind': 'function',
  'module': 'pipeline',
  'function_type': 'callable',
  'summary_override': 'Validate source changes against one target consumption baseline and load strategy.',
  'symbol_name': 'check_source_stability',
  'use_when': 'Normally rely on pipeline_write; call directly only to inspect one explicit source-to-target relationship.',
  'do_not_use_when': 'Do not evaluate Source Stability without the consuming target identity.',
  ...
  'side_effects': 'Persists the Source Stability Guardrail evaluation result; it never defines or executes target processing.',
 'preferred_example': 'stability_result = check_source_stability(table_id, target_table_id=target_table_id)',
 ...
 'preferred_example': 'dq_result = check_dq(source_df, table_id=table_id, row_identity_columns=["order_id"])',
  'related_functions': ['check_schema', 'check_freshness', 'check_source_stability']},
 {'kind': 'function',
 ...
 {'kind': 'function',
  ...
  'when_to_use': 'Use after Engineering registers a table to create or reopen its agreement-free draft and author descriptive Enrichment plus normalized Schema, Freshness, Source Stability, Data Quality, and Sensitive Data Guardrails.',
 ...
 {'kind': 'function',
  ...
  'related_functions': ['widget_author_data_contract', 'check_schema', 'check_freshness', 'check_source_stability', 'check_dq'],
 ...
 {'kind': 'function',
  ...
  'related_functions': ['widget_activate_data_contract', 'pipeline_read', 'check_schema', 'check_freshness', 'check_source_stability', 'check_dq'],
