...
PUBLIC_SYMBOL_DOCS = [
 ...
 {'kind': 'function',
  ...
  'function_type': 'callable',
  'summary_override': 'Link an exact Data Agreement version and activate one validated frozen Data Contract for Production.',
  'symbol_name': 'widget_activate_data_contract',
  'template_notebook': '01_governance',
  'template_segment': 'Data Contract activation',
  'use_when': 'Use after Engineering validates an exact frozen Data Contract version and Governance is ready to activate it for Production.',
  'parameters': 'Optional canonical table_id, optional frozen contract_version, a Fabric Spark session, and an optional active Fabric context.',
  'returns': 'Activation state, selected immutable identities, validation evidence, the displayed UI, and the activation result.',
  'raises': 'Raises widget, Spark, configured metadata routing, validation evidence, or contract activation errors.',
  'related_functions': ['widget_data_contract', 'widget_select_data_contract'],
  'expanded_purpose': 'Provides the final Governance gate for selecting a frozen contract, confirming exact-version Engineering validation, linking an exact Data Agreement version, and deliberately making that contract the governed Production definition.',
  'when_to_use': 'Use only after the selected immutable contract version has successful Engineering validation evidence.',
  'do_not_use_when': 'Do not use to author or freeze contracts, run pipeline validation, or promote and deploy 02_pipeline.',
  'glossary_terms': ['data contract', 'data agreement', 'guardrails', 'metadata lakehouse'],
  'return_interpretation': 'The returned state identifies the selected frozen contract and Data Agreement version plus the exact validation evidence used by the activation gate.',
  'common_failure_causes': ['No frozen contract exists for the selected table.',
