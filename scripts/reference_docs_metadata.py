...
PUBLIC_SYMBOL_DOCS = [
 ...
 {'kind': 'function',
  ...
  'returns': 'Standalone three-pane browser state with table and column selectors, draft-aware controls, explicit AI suggestion, record building, and save callbacks.',
  ...
  'expanded_purpose': 'Uses the environment-specific Catalogue table_id and column_id identities to distinguish editable current columns from grey, read-only historically removed columns with their last-observed dates. It maintains configured Description and Classification fields for tables and columns, with optional transient AI-assisted suggestions.',
 ...
 {'kind': 'function',
  ...
  'related_functions': ['widget_register_data_contract', 'widget_activate_data_contract'],
