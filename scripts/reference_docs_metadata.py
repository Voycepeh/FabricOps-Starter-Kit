...
PUBLIC_SYMBOL_DOCS = [
 ...
 {'kind': 'function',
  'module': 'pipeline',
  'function_type': 'callable',
  'summary_override': 'Detect mutation of previously processed source data and validate compatibility with the governed target load strategy.',
  ...
  'parameters': 'Canonical source observation and governed target_table_id.',
 ...
 'preferred_example': 'stability_result = check_source_stability(observation, target_table_id=target_table_id)',
 'related_functions': ['check_schema', 'check_freshness', 'pipeline_read']},
 {'kind': 'function',
  'module': 'pipeline',
  'function_type': 'callable',
  'summary_override': 'Persist deterministic partition evidence for one physical source table.',
 ...
 {'kind': 'function',
  ...
  'use_when': 'Use when source observations or target Guardrails need canonical target identity before the physical target exists.',
