...
TEMPLATE_FLOW_DOCS = [{'notebook_key': '00_env_config',
 ...
 {'notebook_key': '02_pipeline',
  ...
  'segments': [{'symbols': ['widget_select_data_contract'],
               ...
               {'symbols': ['read_pipeline_prep', 'check_schema', 'check_freshness', 'check_changes', 'check_dq'],
               ...
               {'symbols': ['check_and_profile_source',
                            'profile_dataframe',
...
PUBLIC_SYMBOL_DOCS = [
 ...
 {'kind': 'function',
  'module': 'pipeline.check_and_profile_source',
  'function_type': 'callable',
  'summary_override': 'Apply governed source DQ and canonical-or-diagnostic profiling.',
  'symbol_name': 'check_and_profile_source',
  'template_notebook': '02_pipeline',
  'template_segment': 'Source check and profile',
  'use_when': 'Use after a physical source read prepared by read_pipeline_prep.',
  'do_not_use_when': 'Do not call it for a skipped source or use a query aggregate as a canonical table profile.',
  'parameters': 'Source DataFrame, its read_pipeline_prep result, and whether a complete read represents the canonical table.',
  'returns': 'Governed DQ result, profile DataFrame, and canonical or diagnostic profile kind.',
  'side_effects': 'Persists Guardrail results and, for canonical full-source profiles, Profiled, Profile Frequency, and Catalogue metadata.',
  'preferred_example': 'source_result = check_and_profile_source(source_df, source_prep=source_prep)',
  'related_functions': ['read_pipeline_prep', 'profile_and_register_table', 'profile_dataframe', 'check_dq']},
 {'kind': 'function',
 ...
 {'kind': 'function',
  ...
  'use_when': 'Use before the visible source reader to resolve one registered source and its governed physical scope.',
  'do_not_use_when': 'Do not use as a replacement for the physical Lakehouse or SQL endpoint reader.',
  'parameters': 'Canonical source table_id, governed target table_id for watermark processing, read strategy, and optional watermark or partition column.',
  'returns': 'Registered source identity, target identity for watermark processing, observation and change state, and skip, full, or incremental read scope.',
  'side_effects': 'Persists compact source observation and change evidence; it does not read business rows or write the target.',
  'preferred_example': 'read_prep = read_pipeline_prep(source_table_id=source["table_id"], target_table_id=target["table_id"], source_read_strategy="incremental_watermark", source_watermark_column="change_sequence")',
 ...
 {'kind': 'function',
  ...
  'returns': 'Audited DataFrame, target identity, resolved target processing, writer settings, execution scope, and target Lineage.',
  'side_effects': 'Resolves run audit context, persists target Lineage, and transforms the DataFrame lazily; it does not physically write the target.',
 ...
 {'kind': 'function',
  ...
  'when_to_use': 'Use after Engineering registers a table to create or reopen its agreement-free draft and author descriptive Enrichment plus normalized Schema, Freshness, Changes, Data Quality, and Sensitive Data Guardrails.',
 ...
 {'kind': 'function',
  ...
  'related_functions': ['widget_author_data_contract', 'check_schema', 'check_freshness', 'check_changes', 'check_dq'],
 ...
 {'kind': 'function',
  ...
  'related_functions': ['widget_activate_data_contract', 'read_pipeline_prep', 'check_schema', 'check_freshness', 'check_changes', 'check_dq'],
