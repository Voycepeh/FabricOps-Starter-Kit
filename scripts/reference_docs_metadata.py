...
PUBLIC_SYMBOL_DOCS = [
 ...
 {'kind': 'function',
  ...
  'expanded_purpose': 'An immutable snapshot-based inventory of logical datasets linked to a Data Agreement. Each save records the complete inventory, while the widget displays only the latest saved snapshot and reactively reloads when the supplied agreement selector changes.',
