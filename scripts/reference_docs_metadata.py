...
PUBLIC_SYMBOL_DOCS = [{'kind': 'function',
  ...
  'related_functions': ['setup_metadata_tables', 'run_table_guardrails'],
  ...
  'related_guides': [{'title': 'Notebook Templates',
                     ...
                     {'title': 'Metadata Tables',
                      'path': '../../reference/metadata-tables/index.md'}]},
 {'kind': 'function',
  'module': 'config',
  'function_type': 'callable',
 ...
 {'kind': 'function',
  'module': 'data_agreement',
  'function_type': 'callable',
  'summary_override': 'Render an agreement selector and establish downstream runtime context.',
  ...
  'do_not_use_when': 'Do not use for guardrail target selection; use '
                     ...
                     'review targets.',
  'parameters': 'agreement_rows, context, spark_session, metadata_schema, register_notebook, notebook_type, environment_name, dataset_name, table_name, topic, pipeline_name, read_only, run_context, and run_id.',
  'returns': 'Agreement runtime context exposing run_id, pipeline_started_at, pipeline_name, spark_session, metadata_schema, notebook_type, notebook_id, notebook_registry_id, agreement_id, agreement_contract_version, agreement, context, read_only, and selector.',
  ...
  'fabric_context': 'Requires agreement metadata created through 01_agreement and metadata routing '
                    'from 00_env_config.',
  'ai_verification': 'Verify the returned AGREEMENT_CONTEXT has agreement_id and run_id before generating pipeline code that depends on agreement context.',
  'preferred_example': 'AGREEMENT_CONTEXT = widget_select_agreement(notebook_type="02_pipeline", register_notebook=True)\n'
  ...
  'glossary_terms': ['notebook template'],
  'return_interpretation': 'Use the returned context attributes as the stable notebook-facing agreement and runtime contract.',
 ...
 {'kind': 'function',
  ...
  'related_guides': [{'title': 'Notebook Templates', 'path': '../../how-fabricops-works/notebook-templates/index.md'}]},
 {'kind': 'function',
  'module': 'fabric_input_output',
  'function_type': 'callable',
 ...
 {'kind': 'function',
  ...
  'related_guides': [{'title': 'Pipeline Guardrails',
                      'path': '../../how-fabricops-works/guardrails/pipeline-guardrails.md'},
                     {'title': 'Governance Review',
                      'path': '../../how-fabricops-works/notebook-templates/governance-review.md'}]},
 {'kind': 'function',
  'module': 'guardrails',
  'function_type': 'callable',
