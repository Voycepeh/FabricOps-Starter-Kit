...
TEMPLATE_FLOW_DOCS = [{'notebook_key': '00_env_config',
 ...
 {'notebook_key': 'example_pipeline_smoke_test',
  'notebook_label': '`example_pipeline_smoke_test`',
  'segment_intro': 'Smoke-test data seeding for the real pipeline template.',
  'segments': [{'symbols': ['write_lakehouse_table'],
                'title': 'Pipeline smoke setup'}],
  'template_path': 'templates/notebooks/example_pipeline_smoke_test.ipynb'},
