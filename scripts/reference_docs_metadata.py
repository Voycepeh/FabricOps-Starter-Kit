...
PUBLIC_SYMBOL_DOCS = [
 ...
 {'kind': 'function',
  ...
  'function_type': 'callable',
  'summary_override': 'Manage an agreement-level logical dataset inventory.',
  'symbol_name': 'widget_register_data_contract',
  'template_notebook': '01_agreement',
  'template_segment': 'Agreement intake',
  'use_when': 'Use in 01_agreement to review and save the complete draft dataset inventory for a selected agreement.',
  ...
  'returns': 'Mutable inventory state with existing draft and non-draft memberships, pending additions and removals, save results, and a get_rows callable.',
  ...
  'expanded_purpose': 'Loads the complete agreement inventory, locks non-draft memberships, and narrowly replaces draft METADATA_DATA_CONTRACT rows linking the agreement to environment-independent metadata_table_key values.',
  'when_to_use': 'Use to inspect and authoritatively save draft logical dataset membership for one Data Agreement.',
  ...
  'return_interpretation': 'Existing memberships load immediately; pending lists explain the exact draft additions and removals before save, while non-draft and unknown identities remain non-writable.',
