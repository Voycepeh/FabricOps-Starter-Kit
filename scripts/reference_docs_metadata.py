...
PUBLIC_SYMBOL_DOCS = [
 ...
 {'kind': 'function',
  ...
  'use_when': 'Use in pipeline, governance-review, and exploration notebooks for a consistent read-only metadata trace of one registered dataset.',
  ...
  'returns': 'Mutable widget state whose get_views callable returns the selection and raw, filtered canonical metadata DataFrames.',
  ...
  'return_interpretation': 'The returned state updates as selectors change; call state["get_views"] to retrieve selection details and raw metadata-history DataFrames ordered newest commit first.',
