...
PUBLIC_SYMBOL_DOCS = [
 ...
 {'kind': 'function',
  ...
  'parameters': 'See the source docstring for optional agreement, direct or restricted metadata identities, schema version, metadata target, Spark session, and context parameters.',
  ...
  'expanded_purpose': 'Resolves one metadata_table_key through discovery, direct, agreement-linked, or pipeline-restricted selection; joins current catalogue, enrichment, and guardrail intent; and displays profiling, guardrail-result, and access history separately.',
