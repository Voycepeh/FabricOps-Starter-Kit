...
PUBLIC_SYMBOL_DOCS = [
 ...
 {'kind': 'function',
  ...
  'returns': 'Audited DataFrame, target identity, authoritative load strategy, writer settings, write scope, and target Lineage.',
  'side_effects': 'Resolves contract processing and writer ownership, persists target Lineage, and transforms the DataFrame; it does not physically write the target.',
