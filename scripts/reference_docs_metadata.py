...
PUBLIC_SYMBOL_DOCS = [
 ...
 {'kind': 'function',
  ...
  'do_not_use_when': 'Do not use for lakehouse table writes, lakehouse Files writes, or metadata '
                     'evidence writes.',
  'parameters': 'df, schema, table_name, target, write mode, optional Spark repartition count, optional connector writer options, and optional context.',
  ...
  'expanded_purpose': 'Resolves the configured Warehouse table target, optionally applies numeric Spark repartitioning to control write parallelism without creating a physically partitioned Warehouse table, then delegates writes to the Fabric Warehouse Spark connector with supplied writer options.',
