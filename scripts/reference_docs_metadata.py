...
METADATA_COLUMN_OWNERS = {
    ...
    "METADATA_GUARDRAIL_RESULTS": {
        "__default__": [
            ...
            "fabricops_kit.pipeline.metadata_evidence.write_guardrail_result_row",
        ],
        "__audit__": ["fabricops_kit.config.audit.build_runtime_audit_fields"],
        "guardrail_result_id": ["fabricops_kit.pipeline.metadata_evidence.write_guardrail_result_row"],
        "guardrail_rule_id": ["fabricops_kit.pipeline.metadata_evidence.write_guardrail_result_row"],
        "result_id": ["fabricops_kit.pipeline.metadata_evidence.write_guardrail_result_row"],
        "rule_key": ["fabricops_kit.pipeline.metadata_evidence.write_guardrail_result_row"],
        "metadata_table_key": [
            "fabricops_kit.pipeline.metadata_evidence.write_guardrail_result_row",
            "fabricops_kit.config.shared.build_metadata_table_key",
        ],
        "expected_value_json": ["fabricops_kit.pipeline.metadata_evidence.write_guardrail_result_row"],
        "actual_value_json": ["fabricops_kit.pipeline.metadata_evidence.write_guardrail_result_row"],
        "result_payload_json": ["fabricops_kit.pipeline.metadata_evidence.write_guardrail_result_row"],
    },
...
PUBLIC_SYMBOL_DOCS = [
 ...
 {'kind': 'function',
  ...
  'related_functions': ['check_freshness', 'check_changes', 'run_table_guardrails']},
 {'kind': 'function',
  'module': 'pipeline',
  'function_type': 'callable',
  ...
  'related_functions': ['check_schema', 'check_changes', 'enforce_freshness', 'run_table_guardrails']},
 {'kind': 'function',
  'module': 'pipeline',
  'function_type': 'callable',
