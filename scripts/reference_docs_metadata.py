...
METADATA_TABLE_PURPOSES = {
    ...
    "METADATA_GUARDRAIL_ROW_RESULTS": "Failed source-row and failed-DQ-rule evidence linked to runtime guardrail outcomes.",
...
TEMPLATE_FLOW_DOCS = [{'notebook_key': '00_env_config',
 ...
 {'notebook_key': '02_pipeline',
  ...
  'segment_intro': 'Simple v0.2 Lakehouse-first pipeline with complete-table Warehouse read and '
                   'write alternatives.',
  'segments': [{'symbols': ['observe_table', 'check_schema', 'check_freshness', 'check_changes', 'check_dq'],
...
PUBLIC_SYMBOL_DOCS = [
 ...
 'related_functions': ['check_schema', 'check_freshness', 'observe_table']},
 {'kind': 'function',
  'module': 'pipeline',
  'function_type': 'callable',
