...
PUBLIC_SYMBOL_DOCS = [
 ...
 {'kind': 'function',
  ...
  'parameters': 'Canonical source table_id plus its engineer-authored read strategy and optional watermark or partition column.',
  'returns': 'Registered source identity, observation and change state, candidate completion state, and skip, full, or incremental read scope.',
  'side_effects': 'Persists compact source observation and change evidence; it does not read business rows or write the target.',
  'preferred_example': 'read_prep = read_pipeline_prep(source_table_id=source["table_id"], source_read_strategy="incremental_watermark", source_watermark_column="change_sequence")',
 ...
 {'kind': 'function',
  ...
  'function_type': 'callable',
  'summary_override': 'Commit a prepared watermark after the governed target write succeeds.',
  'symbol_name': 'commit_pipeline_checkpoint',
  'template_notebook': '02_pipeline',
  'template_segment': 'Target persistence',
  'use_when': 'Use immediately after a successful physical target write for incremental_watermark processing.',
  'do_not_use_when': 'Do not call after a failed target write or for full_dataset and incremental_partition processing.',
