...
PUBLIC_SYMBOL_DOCS = [
 ...
 {'kind': 'function',
  ...
  'preferred_example': 'profiled_df = profile_and_register_dataframe(df_customer, profile_role="source", target="source", schema=SOURCE_SCHEMA, table_name="customer")',
...
FOCUSED_FUNCTION_DOC_UPDATES = {
    ...
    "profile_and_register_dataframe": {
        ...
        "preferred_example": 'profiled_df = profile_and_register_dataframe(source_df, profile_role="source", target="source", schema=SOURCE_SCHEMA, table_name="student_enrolment", frequency_profile_df=profile_sample_df)',
    },
}
