...
PUBLIC_SYMBOL_DOCS = [
 ...
 {'kind': 'function',
  ...
  'function_type': 'callable',
  'summary_override': 'Legacy explicit watermark checkpoint commit retained for later cleanup.',
  'symbol_name': 'commit_pipeline_checkpoint',
  'template_notebook': '02_pipeline',
  'template_segment': 'Target persistence',
  'use_when': 'Do not add new callers; target _watermark_value now owns incremental_watermark progress.',
  'do_not_use_when': 'Do not use for current incremental_watermark correctness or for full_dataset and incremental_partition processing.',
  'parameters': 'The exact read_pipeline_prep result whose candidate checkpoint was processed successfully.',
  'returns': 'The committed checkpoint record, or None when no watermark candidate exists.',
  'side_effects': 'Appends the successful watermark to configured metadata only after the caller confirms target persistence succeeded.',
  'preferred_example': 'committed = commit_pipeline_checkpoint(read_prep)',
  'related_functions': ['read_pipeline_prep', 'write_pipeline_prep', 'write_lakehouse_table', 'write_warehouse_table']},
 {'kind': 'function',
  ...
  'returns': 'Audited DataFrame, target identity, resolved target processing, writer settings, execution scope, and completion context.',
