...
PUBLIC_SYMBOL_DOCS = [{'kind': 'function',
 ...
 {'kind': 'function',
  ...
  'related_guides': [{'title': 'Notebook Templates', 'path': '../../how-fabricops-works/notebook-templates/index.md'}, {'title': 'Pipeline Guardrails', 'path': '../../how-fabricops-works/guardrails/pipeline-guardrails.md'}]},
 {'kind': 'function',
  'module': 'pipeline',
  'function_type': 'callable',
