...
PUBLIC_SYMBOL_DOCS = [{'kind': 'function',
 ...
 {'kind': 'function',
  ...
  'returns': 'Internal runtime context object with run_id, pipeline_name, notebook identity, agreement identity, and Spark context for downstream defaults.',
  ...
  'return_interpretation': 'The returned context can be assigned to PIPELINE for target config and lineage fields while downstream helpers read the same active defaults automatically.',
  ...
  'related_guides': [{'title': 'Notebook Templates', 'path': '../../how-fabricops-works/notebook-templates.md'}, {'title': 'Pipeline Guardrails', 'path': '../../how-fabricops-works/pipeline-guardrails.md'}]},
 {'kind': 'function',
  'module': 'pipeline',
  'function_type': 'callable',
