...
METADATA_COLUMN_OWNERS = {
    ...
    "METADATA_GUARDRAIL_RESULTS": {
        "__default__": [
            ...
            "fabricops_kit.pipeline.check_pii_guardrail.check_pii_guardrail",
...
TEMPLATE_FLOW_DOCS = [{'notebook_key': '00_env_config',
 ...
 {'notebook_key': '02_pipeline',
  ...
  'segments': [{'symbols': ['widget_select_data_contract'],
               ...
               {'symbols': ['read_pipeline_prep', 'check_schema', 'check_pii_guardrail', 'check_freshness', 'check_changes', 'check_dq'],
...
PUBLIC_SYMBOL_DOCS = [
 ...
 {'kind': 'function',
  'module': 'pipeline',
  'function_type': 'callable',
  'summary_override': 'Require Direct PII to be absent or represented by an approved token-vault token.',
  'symbol_name': 'check_pii_guardrail',
  'template_notebook': '02_pipeline',
  'template_segment': 'Source guardrails',
  'use_when': 'Use immediately after schema validation on a governed source or supplied DataFrame.',
  'do_not_use_when': 'Do not use to detokenise values or to protect indirect PII.',
  'parameters': 'Canonical table_id and an optional incoming DataFrame.',
  'returns': 'Structured PII guardrail status, continuation decision, and classified, present, and untreated columns.',
  'side_effects': 'Appends an outcome to METADATA_GUARDRAIL_RESULTS when an active PII Guardrail rule exists.',
  'preferred_example': 'pii_result = check_pii_guardrail(table_id=table_id, dataframe=df)',
  'related_functions': ['check_schema', 'write_pipeline_prep']},
 {'kind': 'function',
  'module': 'pipeline',
  'function_type': 'callable',
