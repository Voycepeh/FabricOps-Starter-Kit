...
PUBLIC_SYMBOL_DOCS = [
 ...
 {'kind': 'function',
  ...
  'parameters': 'df, profile_role, environment_name, store_type, layer, table_name, optional schema_name, optional frequency_columns, and frequency_top_n.',
  ...
  'expanded_purpose': 'Orchestrates DataFrame profiling, default full frequency evidence, canonical profiled schema mapping, catalogue identity derivation, deterministic key creation, and append-only profiled evidence registration and catalogue identity upsert while accepting profile_role as execution participation context. The role is validated but not stored in METADATA_DATA_PROFILED or METADATA_DATA_CATALOGUE; automatic lineage registration follows separately.',
