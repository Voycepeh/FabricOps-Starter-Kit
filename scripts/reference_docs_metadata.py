...
TEMPLATE_FLOW_DOCS = [{'notebook_key': '00_env_config',
 ...
 {'notebook_key': '02_pipeline',
  ...
  'segments': [{'symbols': ['widget_select_data_contract'],
               ...
               {'symbols': ['pipeline_read', 'check_schema', 'check_freshness', 'check_source_drift', 'check_dq', 'validate_data_contract'],
...
PUBLIC_SYMBOL_DOCS = [
 ...
 {'kind': 'function',
  ...
  'side_effects': 'Reads target business data and appends aggregate validate evidence to METADATA_GUARDRAIL_RESULTS; never writes business data or failed rows.',
