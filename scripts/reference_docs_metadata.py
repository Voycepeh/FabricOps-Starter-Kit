...
PUBLIC_SYMBOL_DOCS = [
 ...
 {'kind': 'function',
  'module': 'pipeline',
  'function_type': 'callable',
  'summary_override': 'Validate deterministic source-observation changes against one approved expectation.',
  ...
  'side_effects': 'Persists the Changes Guardrail evaluation result; it never defines or executes target processing.',
