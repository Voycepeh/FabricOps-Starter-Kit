...
PUBLIC_SYMBOL_DOCS = [
 ...
 {'kind': 'function',
  ...
  'function_type': 'callable',
  'summary_override': 'Render the governed data contract for one registered dataset.',
  'symbol_name': 'widget_view_data_contract',
  'template_notebook': '99_explore',
  'template_segment': 'View data contract',
  'use_when': 'Use in exploration notebooks to inspect the joined contract and separate historical metadata surfaces for one canonical dataset identity.',
  'parameters': 'See the source docstring for metadata target, schema, Spark session, and context parameters.',
  ...
  'expanded_purpose': 'Resolves one metadata_table_key through dependent canonical location selectors, joins current catalogue, enrichment, and guardrail intent, and displays profiling, guardrail-result, and access history separately.',
  'when_to_use': 'Use in 99_explore to understand how the governed metadata model is wired together for one registered dataset.',
  ...
  'return_interpretation': 'The returned state updates as selectors change; call state["get_views"] to retrieve the selected summary, contract, profiling, results, and access DataFrames.',
