...
METADATA_COLUMN_OWNERS = {
    ...
    "METADATA_DATA_CONTRACT": {
        "__default__": ["fabricops_kit.widgets.widget_author_data_contract.widget_author_data_contract", "fabricops_kit.data_contract.shared.freeze_contract", "fabricops_kit.widgets.widget_activate_data_contract.widget_activate_data_contract"],
        "__audit__": ["fabricops_kit.config.audit.build_runtime_audit_fields"],
    },
    "METADATA_DATA_CATALOGUE": {
        "__default__": [
...
PUBLIC_SYMBOL_DOCS = [
 {'kind': 'function',
  ...
  'use_when': 'Use when you need a snapshot of observable SQL permissions for tables already registered in METADATA_DATA_CATALOGUE.',
  'do_not_use_when': 'Do not use as a complete Fabric authorization inventory; workspace roles, item sharing, OneLake Security, and Power BI security are outside this scanner.',
  'parameters': 'catalogue_df, one or more configured workspace data item target keys, optional environment_name, optional access_snapshot_id, optional spark_session, and optional FabricOps context.',
  'returns': 'Dictionary with access rows aligned to METADATA_DATA_ACCESS and unmatched observed permissions that could not be linked to a registered table.',
  'raises': 'Raises ValueError when no valid workspace data item target is supplied and propagates configured SQL endpoint read or Spark errors.',
  'side_effects': 'Reads SQL permission catalogue views from configured workspace data item targets; it does not persist access rows or change permissions.',
  ...
  'ai_verification': 'Confirm configured targets resolve to the physical items represented by canonical Catalogue table_id values, inspect unmatched observations, and persist only the returned access DataFrame when appropriate.',
  'preferred_example': 'result = scan_workspace_access(catalogue_df, targets="warehouse", spark_session=spark)',
  'related_functions': ['read_warehouse_query'],
 ...
 {'kind': 'function',
  ...
  'related_functions': ['widget_activate_data_contract'],
  'expanded_purpose': 'Replaces fragmented normal authoring with Overview, Enrichment, Guardrails, and Review sections for one exact Data Contract version. It uses HTML-first passive rendering and mounts ipywidgets only for current interactions to improve Microsoft Fabric notebook reliability.',
  ...
  'do_not_use_when': 'Do not use for runtime Guardrail evaluation or Production activation.',
 ...
 {'kind': 'function',
  ...
  'function_type': 'callable',
  'summary_override': 'Explicitly link an exact Data Agreement version and activate a frozen table Data Contract.',
  'symbol_name': 'widget_activate_data_contract',
  'template_notebook': '01_governance',
  'template_segment': 'Contract activation',
  'use_when': 'Use after Development validates a frozen Data Contract to link the required exact Data Agreement version and make the contract active for its governed table.',
  'related_functions': ['widget_author_data_contract', 'check_schema', 'check_freshness', 'check_source_drift', 'check_dq'],
  'return_interpretation': 'review combines the immutable payload with the proposed Agreement linkage; activate writes the linkage and lifecycle fields and reports whether an atomic update occurred.',
 ...
 {'kind': 'function',
  ...
  'related_functions': ['widget_activate_data_contract', 'pipeline_read', 'check_schema', 'check_freshness', 'check_source_drift', 'check_dq'],
