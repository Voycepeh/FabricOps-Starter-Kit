...
MODULE_DOCS_METADATA: list[ModuleDocMetadata] = [
    ...
    {"module_name": "governance_review", "visibility": "public", "module_summary": "Owns table-scoped governance review, approved metadata recording, and migrated internal AI drafting/enforcement helpers for business context, sensitivity/PII classification, and DQ rules after removing the standalone business_context.py, data_governance.py, and data_quality.py modules.", "sidebar_group": "1. Governance steward", "sidebar_include": True},
