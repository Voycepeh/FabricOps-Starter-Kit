...
USAGE_NOTE_BY_FUNCTION = {
    ...
    "widget_metadata_explorer": CATALOGUE_WIDGET_USAGE_NOTE,
}
...
PUBLIC_SYMBOL_DOCS = [
 ...
 {'kind': 'function',
  'module': 'widgets.widget_metadata_explorer',
  'function_type': 'callable',
  'summary_override': 'Inspect persisted metadata by table, Data Agreement, Data Steward, or Pipeline Notebook scope.',
  'symbol_name': 'widget_metadata_explorer',
  'template_notebook': '99_explore',
  'template_segment': 'Persisted metadata exploration',
  'use_when': 'Use for read-only, current-environment investigation across meaningful metadata grains.',
  'related_functions': ['widget_view_catalogue', 'profile_table'],
  'return_interpretation': 'Call state["get_views"]() to receive assets, columns, governance, execution, frequency, and access Spark DataFrames.'},
