...
PUBLIC_SYMBOL_DOCS: list[PublicSymbolDocMetadata] = [{'kind': 'function',
 ...
 {'kind': 'function',
  'module': 'governance_review',
  'function_type': 'callable',
  'summary_override': 'Render shared schema, freshness, profile-behavior, and DQ guardrail authoring guidance.',
  'symbol_name': 'widget_review_table_guardrails',
  'template_notebook': '03_governance',
  'template_segment': 'Governance review'},
 {'kind': 'function',
  'module': 'governance_review',
...
PUBLIC_SYMBOL_DOCS_SUPPLEMENTAL: dict[str, dict[str, object]] = {
    ...
    "widget_review_table_guardrails": {
        "expanded_purpose": "Renders shared guardrail authoring so engineering and governance can append schema, freshness, profile-behavior, and DQ rule metadata.",
        "when_to_use": "Use in 02_pipeline for engineering first-pass guardrails and in 03_governance for governance review before record_table_governance persists guardrail_reviews.",
        "glossary_terms": ["guardrail", "metadata lakehouse", "notebook template"],
        "return_interpretation": "The widget captures committed guardrail review rows for METADATA_GUARDRAIL_RULES; runtime enforcement still happens only in 02_pipeline.",
        "common_failure_causes": ["Profile rows are missing.", "Changing data was selected without a watermark column.", "Unsupported guardrail status or severity was selected.", "Widget state was not committed through record_table_governance."],
    },
    "widget_review_column_classification": {
...
RELATED_GUIDES_BY_SYMBOL: dict[str, list[dict[str, str]]] = {
    ...
    "widget_review_table_guardrails": [RELATED_GUIDE_GOVERNANCE_REVIEW, RELATED_GUIDE_PIPELINE_GUARDRAILS],
