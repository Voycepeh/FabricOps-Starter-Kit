...
PUBLIC_SYMBOL_DOCS = [
 ...
 {'kind': 'function',
  ...
  'template_notebook': '02_pipeline',
  'template_segment': 'Profiling',
  'use_when': 'Use when a source or target DataFrame should be profiled and registered as catalogue evidence with one cloneable call.',
  ...
  'when_to_use': 'Use in 02_pipeline once for each source or target DataFrame that should produce catalogue profile evidence.',
  'glossary_terms': ['evidence', 'source data', 'target table'],
