...
MODULE_DOCS_METADATA: list[ModuleDocMetadata] = [
    ...
    {"module_name": "governance_review", "visibility": "public", "module_summary": "Owns table-scoped 04_gov catalogue selection, business context review, AI-assisted business context drafting, DQ review and internal enforcement helpers, classification review, AI-assisted sensitivity/PII drafting, and approved metadata commit through record_table_governance.", "sidebar_group": "1. Governance steward", "sidebar_include": True},
