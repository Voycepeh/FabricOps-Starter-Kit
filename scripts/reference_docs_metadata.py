...
PUBLIC_SYMBOL_DOCS = [
 ...
 {'kind': 'function',
  ...
  'function_type': 'callable',
  'summary_override': 'Manage an immutable agreement dataset inventory.',
  'symbol_name': 'widget_register_data_contract',
  'template_notebook': '01_agreement',
  'template_segment': 'Agreement intake',
  'use_when': 'Use in 01_agreement to save draft agreement-to-logical-dataset membership as a complete new immutable snapshot.',
  ...
  'expanded_purpose': 'A draft immutable inventory of logical datasets linked to a Data Agreement. Membership uses environment-independent logical identities shared across environments; each save reuses one audit dictionary so _activity_id groups the complete inventory and _committed_at orders saves. The widget displays only the latest activity and reactively reloads when the supplied agreement selector changes.',
  ...
  'return_interpretation': 'The inventory reflects only the latest audit activity plus unsaved valid additions; each save appends one complete non-empty membership set without changing history.',
