...
TEMPLATE_FLOW_DOCS = [{'notebook_key': '00_env_config',
 ...
 {'notebook_key': '01_governance',
  ...
  'segments': [{'symbols': ['widget_render_data_steward',
                ...
                'title': 'Agreement, Data Contract authoring, and catalogue review'}],
 ...
 {'notebook_key': '02_pipeline',
  ...
  'segments': [{'symbols': ['widget_select_data_contract'],
                'title': 'Select target Data Contract'},
...
PUBLIC_SYMBOL_DOCS = [
 ...
 {'kind': 'function',
  ...
  'function_type': 'callable',
  'summary_override': 'Author one exact Data Contract version through a unified, contract-centric widget.',
  'symbol_name': 'widget_author_data_contract',
  'template_notebook': '01_governance',
  'template_segment': 'Data Contract authoring',
  'use_when': 'Use as the primary UX for preparing and freezing one exact draft Data Contract version.',
  'parameters': 'Exact contract_id and contract_version, a Fabric Spark session, and an optional active Fabric context.',
  ...
  'when_to_use': 'Use after creating a draft to author descriptive Enrichment and normalized Schema, Freshness, Changes, Data Quality, and Sensitive Data Guardrails.',
  ...
  'return_interpretation': 'The returned state remains pinned to the requested contract_id and contract_version; saves delegate to contract-authoring services.',
  'common_failure_causes': ['The exact draft version does not exist.',
 ...
 {'kind': 'function',
  ...
  'function_type': 'callable',
  'summary_override': 'Choose current authoring or one exact frozen Data Contract version for a canonical target table identity.',
  'symbol_name': 'widget_select_data_contract',
  'template_notebook': '02_pipeline',
  'template_segment': 'Select target Data Contract',
  'use_when': 'Use after the canonical target table_id is known and before pipeline processing and target validation resolve current authoring or one exact frozen Data Contract version.',
  ...
  'expanded_purpose': 'This read-only Development testing tool does not activate contracts. Current authoring is the default; an exact selection governs frozen schema expectations, Guardrails, and target processing together, while Production uses the active Data Contract automatically.',
  'common_failure_causes': ['The canonical target table_id is empty or has no Data Contract versions.',
