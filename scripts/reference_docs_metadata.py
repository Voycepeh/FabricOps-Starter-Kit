...
METADATA_TABLE_PURPOSES = {
    ...
    "METADATA_DATA_CATALOGUE": "Maintain the stable table and column identities that connect FabricOps metadata.",
    "METADATA_DATA_PROFILED": "Compact per-column summary statistics captured from a profiled dataset snapshot.",
    "METADATA_DATA_PROFILED_FREQUENCY": "Flattened distinct-value frequency rows linked to their exact profile_record_id.",
