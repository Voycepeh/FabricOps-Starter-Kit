...
TEMPLATE_FLOW_DOCS = [{'notebook_key': '00_env_config',
 ...
 {'notebook_key': '02_pipeline',
  ...
  'segments': [{'symbols': ['start_pipeline_run_with_agreement',
                            'read_data',
...
PUBLIC_SYMBOL_DOCS = [{'kind': 'function',
 ...
 {'kind': 'class',
  'module': 'pipeline',
  'function_type': 'callable',
  'summary_override': 'Store resolved runtime values for guided pipeline notebook wrappers.',
  'symbol_name': 'PipelineRunContext',
  'template_notebook': '02_pipeline',
  'template_segment': 'Guided pipeline context',
  'use_when': 'Use the object returned by start_pipeline_run_with_agreement when business cells need the run id or pipeline name.',
  'do_not_use_when': 'Use lower-level explicit APIs directly when an advanced custom notebook must pass runtime context manually.',
  'parameters': 'See the source docstring for optional advanced overrides.',
  'returns': 'PipelineRunContext with run, pipeline, agreement, notebook, and Spark context.',
  'side_effects': 'May read or store active notebook runtime context for downstream guided wrappers.',
  'fabric_context': 'Defaults to RUN_CONTEXT, spark, and METADATA_SCHEMA from 00_env_config when available.',
  'ai_verification': 'Verify guided notebooks call start_pipeline_run_with_agreement before profile or enforcement wrappers.',
  'preferred_example': 'PIPELINE = start_pipeline_run_with_agreement()',
  'related_functions': ['run_table_guardrails', 'write_pipeline_run_summary'],
  'expanded_purpose': 'Store resolved runtime values for guided pipeline notebook wrappers.',
  'when_to_use': 'Use the object returned by start_pipeline_run_with_agreement when business cells need the run id or pipeline name.',
  'glossary_terms': ['notebook template', 'guardrails', 'metadata lakehouse'],
  'return_interpretation': 'PipelineRunContext with run, pipeline, agreement, notebook, and Spark context.',
  'common_failure_causes': ['No active pipeline context exists.', 'Fabric runtime variables are unavailable.', 'Configured metadata routing is unavailable.'],
  'related_guides': [{'title': 'Pipeline Guardrails', 'path': '../../how-fabricops-works/pipeline-guardrails.md'}]},
 {'kind': 'function',
  'module': 'pipeline',
  'function_type': 'callable',
  'summary_override': 'Start a guided pipeline run and store active runtime context.',
  'symbol_name': 'start_pipeline_run',
  'template_notebook': '02_pipeline',
  'template_segment': 'Guided pipeline context',
  'use_when': 'Use in advanced guided pipelines that do not need agreement selection.',
  'do_not_use_when': 'Use lower-level explicit APIs directly when an advanced custom notebook must pass runtime context manually.',
  'parameters': 'See the source docstring for optional advanced overrides.',
  'returns': 'Active PipelineRunContext.',
  'side_effects': 'May read or store active notebook runtime context for downstream guided wrappers.',
  'fabric_context': 'Defaults to RUN_CONTEXT, spark, and METADATA_SCHEMA from 00_env_config when available.',
  'ai_verification': 'Verify guided notebooks call start_pipeline_run_with_agreement before profile or enforcement wrappers.',
  'preferred_example': 'PIPELINE = start_pipeline_run_with_agreement()',
  'related_functions': ['run_table_guardrails', 'write_pipeline_run_summary'],
  'expanded_purpose': 'Start a guided pipeline run and store active runtime context.',
  'when_to_use': 'Use in advanced guided pipelines that do not need agreement selection.',
  'glossary_terms': ['notebook template', 'guardrails', 'metadata lakehouse'],
  'return_interpretation': 'Active PipelineRunContext.',
  'common_failure_causes': ['No active pipeline context exists.', 'Fabric runtime variables are unavailable.', 'Configured metadata routing is unavailable.'],
  'related_guides': [{'title': 'Pipeline Guardrails', 'path': '../../how-fabricops-works/pipeline-guardrails.md'}]},
 {'kind': 'function',
  'module': 'pipeline',
  'function_type': 'callable',
  'summary_override': 'Start a guided pipeline run and resolve the active agreement selection.',
  'symbol_name': 'start_pipeline_run_with_agreement',
  'template_notebook': '02_pipeline',
  'template_segment': 'Guided pipeline context',
  'use_when': 'Use near the top of guided 02_pipeline notebooks.',
  'do_not_use_when': 'Use lower-level explicit APIs directly when an advanced custom notebook must pass runtime context manually.',
  'parameters': 'See the source docstring for optional advanced overrides.',
  'returns': 'Active PipelineRunContext populated with selected agreement context.',
  'side_effects': 'May read or store active notebook runtime context for downstream guided wrappers.',
  'fabric_context': 'Defaults to RUN_CONTEXT, spark, and METADATA_SCHEMA from 00_env_config when available.',
  'ai_verification': 'Verify guided notebooks call start_pipeline_run_with_agreement before profile or enforcement wrappers.',
  'preferred_example': 'PIPELINE = start_pipeline_run_with_agreement()',
  'related_functions': ['run_table_guardrails', 'write_pipeline_run_summary'],
  'expanded_purpose': 'Start a guided pipeline run and resolve the active agreement selection.',
  'when_to_use': 'Use near the top of guided 02_pipeline notebooks.',
  'glossary_terms': ['notebook template', 'guardrails', 'metadata lakehouse'],
  'return_interpretation': 'Active PipelineRunContext populated with selected agreement context.',
  'common_failure_causes': ['No active pipeline context exists.', 'Fabric runtime variables are unavailable.', 'Configured metadata routing is unavailable.'],
  'related_guides': [{'title': 'Pipeline Guardrails', 'path': '../../how-fabricops-works/pipeline-guardrails.md'}]},
 {'kind': 'function',
  'module': 'pipeline',
  'function_type': 'callable',
  'summary_override': 'Return the active guided pipeline context.',
  'symbol_name': 'get_active_pipeline_context',
  'template_notebook': '02_pipeline',
  'template_segment': 'Guided pipeline context',
  'use_when': 'Use inside guided wrappers or custom notebook cells that need resolved runtime context.',
  'do_not_use_when': 'Use lower-level explicit APIs directly when an advanced custom notebook must pass runtime context manually.',
  'parameters': 'See the source docstring for optional advanced overrides.',
  'returns': 'Active PipelineRunContext.',
  'side_effects': 'May read or store active notebook runtime context for downstream guided wrappers.',
  ...
  'preferred_example': 'PIPELINE = start_pipeline_run_with_agreement()',
  'related_functions': ['run_table_guardrails', 'write_pipeline_run_summary'],
  'expanded_purpose': 'Return the active guided pipeline context.',
  'when_to_use': 'Use inside guided wrappers or custom notebook cells that need resolved runtime context.',
  'glossary_terms': ['notebook template', 'guardrails', 'metadata lakehouse'],
  'return_interpretation': 'Active PipelineRunContext.',
  'common_failure_causes': ['No active pipeline context exists.', 'Fabric runtime variables are unavailable.', 'Configured metadata routing is unavailable.'],
  'related_guides': [{'title': 'Pipeline Guardrails', 'path': '../../how-fabricops-works/pipeline-guardrails.md'}]},
 {'kind': 'function',
  'module': 'pipeline',
  'function_type': 'callable',
  'summary_override': 'Profile source tables using the active guided pipeline context.',
  'symbol_name': 'profile_source_tables',
  'template_notebook': '02_pipeline',
  'template_segment': 'Guided pipeline context',
  'use_when': 'Use before transformations in guided 02_pipeline.',
  'do_not_use_when': 'Use lower-level explicit APIs directly when an advanced custom notebook must pass runtime context manually.',
  'parameters': 'See the source docstring for optional advanced overrides.',
  'returns': 'Guardrail result bundle returned by run_table_guardrails.',
  'side_effects': 'May read or store active notebook runtime context for downstream guided wrappers.',
  'fabric_context': 'Defaults to RUN_CONTEXT, spark, and METADATA_SCHEMA from 00_env_config when available.',
  'ai_verification': 'Verify guided notebooks call start_pipeline_run_with_agreement before profile or enforcement wrappers.',
  'preferred_example': 'PIPELINE = start_pipeline_run_with_agreement()',
  'related_functions': ['run_table_guardrails', 'write_pipeline_run_summary'],
  'expanded_purpose': 'Profile source tables using the active guided pipeline context.',
  'when_to_use': 'Use before transformations in guided 02_pipeline.',
  'glossary_terms': ['notebook template', 'guardrails', 'metadata lakehouse'],
  'return_interpretation': 'Guardrail result bundle returned by run_table_guardrails.',
  'common_failure_causes': ['No active pipeline context exists.', 'Fabric runtime variables are unavailable.', 'Configured metadata routing is unavailable.'],
  'related_guides': [{'title': 'Pipeline Guardrails', 'path': '../../how-fabricops-works/pipeline-guardrails.md'}]},
 {'kind': 'function',
  'module': 'pipeline',
  'function_type': 'callable',
  'summary_override': 'Profile target tables using the active guided pipeline context.',
  'symbol_name': 'profile_target_tables',
  'template_notebook': '02_pipeline',
  'template_segment': 'Guided pipeline context',
  'use_when': 'Use after transformations and target config preparation in guided 02_pipeline.',
  'do_not_use_when': 'Use lower-level explicit APIs directly when an advanced custom notebook must pass runtime context manually.',
  'parameters': 'See the source docstring for optional advanced overrides.',
  'returns': 'Guardrail result bundle returned by run_table_guardrails.',
  'side_effects': 'May read or store active notebook runtime context for downstream guided wrappers.',
  ...
  'preferred_example': 'PIPELINE = start_pipeline_run_with_agreement()',
  'related_functions': ['run_table_guardrails', 'write_pipeline_run_summary'],
  'expanded_purpose': 'Profile target tables using the active guided pipeline context.',
  'when_to_use': 'Use after transformations and target config preparation in guided 02_pipeline.',
  'glossary_terms': ['notebook template', 'guardrails', 'metadata lakehouse'],
  'return_interpretation': 'Guardrail result bundle returned by run_table_guardrails.',
  'common_failure_causes': ['No active pipeline context exists.', 'Fabric runtime variables are unavailable.', 'Configured metadata routing is unavailable.'],
  'related_guides': [{'title': 'Pipeline Guardrails', 'path': '../../how-fabricops-works/pipeline-guardrails.md'}]},
 {'kind': 'function',
  'module': 'pipeline',
  'function_type': 'callable',
  'summary_override': 'Enforce blocking source guardrails using the active pipeline context.',
  'symbol_name': 'enforce_source_guardrails',
  'template_notebook': '02_pipeline',
  'template_segment': 'Guided pipeline context',
  'use_when': 'Use before target writes in guided 02_pipeline.',
  'do_not_use_when': 'Use lower-level explicit APIs directly when an advanced custom notebook must pass runtime context manually.',
  'parameters': 'See the source docstring for optional advanced overrides.',
  'returns': 'Guardrail result bundle; blocking failures stop execution.',
  'side_effects': 'May read or store active notebook runtime context for downstream guided wrappers.',
  'fabric_context': 'Defaults to RUN_CONTEXT, spark, and METADATA_SCHEMA from 00_env_config when available.',
  'ai_verification': 'Verify guided notebooks call start_pipeline_run_with_agreement before profile or enforcement wrappers.',
  'preferred_example': 'PIPELINE = start_pipeline_run_with_agreement()',
  'related_functions': ['run_table_guardrails', 'write_pipeline_run_summary'],
  'expanded_purpose': 'Enforce blocking source guardrails using the active pipeline context.',
  'when_to_use': 'Use before target writes in guided 02_pipeline.',
  'glossary_terms': ['notebook template', 'guardrails', 'metadata lakehouse'],
  'return_interpretation': 'Guardrail result bundle; blocking failures stop execution.',
  'common_failure_causes': ['No active pipeline context exists.', 'Fabric runtime variables are unavailable.', 'Configured metadata routing is unavailable.'],
  'related_guides': [{'title': 'Pipeline Guardrails', 'path': '../../how-fabricops-works/pipeline-guardrails.md'}]},
 {'kind': 'function',
  'module': 'pipeline',
  'function_type': 'callable',
  'summary_override': 'Enforce blocking target guardrails using the active pipeline context.',
  'symbol_name': 'enforce_target_guardrails',
  'template_notebook': '02_pipeline',
  'template_segment': 'Guided pipeline context',
  'use_when': 'Use before target writes in guided 02_pipeline.',
  'do_not_use_when': 'Use lower-level explicit APIs directly when an advanced custom notebook must pass runtime context manually.',
  ...
  'preferred_example': 'PIPELINE = start_pipeline_run_with_agreement()',
  'related_functions': ['run_table_guardrails', 'write_pipeline_run_summary'],
  'expanded_purpose': 'Enforce blocking target guardrails using the active pipeline context.',
  'when_to_use': 'Use before target writes in guided 02_pipeline.',
  'glossary_terms': ['notebook template', 'guardrails', 'metadata lakehouse'],
  'return_interpretation': 'Guardrail result bundle; blocking failures stop execution.',
  'common_failure_causes': ['No active pipeline context exists.', 'Fabric runtime variables are unavailable.', 'Configured metadata routing is unavailable.'],
 ...
 {'kind': 'function',
  'module': 'pipeline',
  'function_type': 'callable',
  'summary_override': 'Write the guided pipeline run summary from active context and results.',
  'symbol_name': 'complete_pipeline_run',
  'template_notebook': '02_pipeline',
  'template_segment': 'Guided pipeline context',
  'use_when': 'Use at the end of guided 02_pipeline after enforcement, writes, and lineage.',
  'do_not_use_when': 'Use lower-level explicit APIs directly when an advanced custom notebook must pass runtime context manually.',
  'parameters': 'See the source docstring for optional advanced overrides.',
  'returns': 'Summary row returned by write_pipeline_run_summary.',
  'side_effects': 'May read or store active notebook runtime context for downstream guided wrappers.',
  'fabric_context': 'Defaults to RUN_CONTEXT, spark, and METADATA_SCHEMA from 00_env_config when available.',
  'ai_verification': 'Verify guided notebooks call start_pipeline_run_with_agreement before profile or enforcement wrappers.',
  'preferred_example': 'PIPELINE = start_pipeline_run_with_agreement()',
  'related_functions': ['run_table_guardrails', 'write_pipeline_run_summary'],
  'expanded_purpose': 'Write the guided pipeline run summary from active context and results.',
  'when_to_use': 'Use at the end of guided 02_pipeline after enforcement, writes, and lineage.',
  'glossary_terms': ['notebook template', 'guardrails', 'metadata lakehouse'],
  'return_interpretation': 'Summary row returned by write_pipeline_run_summary.',
  'common_failure_causes': ['No active pipeline context exists.', 'Fabric runtime variables are unavailable.', 'Configured metadata routing is unavailable.'],
  'related_guides': [{'title': 'Pipeline Guardrails', 'path': '../../how-fabricops-works/pipeline-guardrails.md'}]},
 {'kind': 'function',
  'module': 'pipeline',
 ...
 {'kind': 'function',
  ...
  'do_not_use_when': 'Do not use in 02_pipeline or for enforcement results; runtime results belong in METADATA_GUARDRAIL_RESULTS.',
  'glossary_terms': ['guardrails', 'metadata lakehouse', 'notebook template'],
...
PUBLIC_SYMBOL_DOCS_SUPPLEMENTAL = {'setup_notebook': {'expanded_purpose': 'Validates the selected FabricOps environment, resolves '
 ...
 'PipelineRunContext': {'expanded_purpose': 'Stores resolved run, agreement, notebook, and Spark context for guided 02_pipeline wrappers.',
                       'when_to_use': 'Use the object returned by start_pipeline_run_with_agreement when a template needs the resolved run id or pipeline name for business-level steps such as target config preparation.',
                       'do_not_use_when': 'Do not construct manually for routine notebooks; call start_pipeline_run_with_agreement instead.',
                       'glossary_terms': ['notebook template', 'metadata lakehouse', 'guardrails'],
                       'return_interpretation': 'The object contains runtime context values used by downstream guided wrappers.',
                       'common_failure_causes': ['The pipeline run has not been started.', 'RUN_CONTEXT or spark is unavailable outside Fabric.']},
 'start_pipeline_run': {'expanded_purpose': 'Creates the active guided pipeline context without requiring agreement selection.',
                        'when_to_use': 'Use in custom 02_pipeline variants that do not need an agreement selector but still want simplified wrapper calls.',
                        'do_not_use_when': 'Use start_pipeline_run_with_agreement for governed notebook templates that should select and register an agreement.',
                        'glossary_terms': ['notebook template', 'metadata lakehouse'],
                        'return_interpretation': 'Returns and stores the active PipelineRunContext for downstream wrappers.',
                        'common_failure_causes': ['RUN_CONTEXT is unavailable.', 'spark is unavailable for downstream wrappers.']},
 'start_pipeline_run_with_agreement': {'expanded_purpose': 'Creates the active guided pipeline context, renders agreement selection, and stores selected agreement and notebook registration values.',
                                       'when_to_use': 'Use near the top of guided 02_pipeline notebooks before source and target profiling.',
                                       'do_not_use_when': 'Use lower-level widget_select_agreement and run_table_guardrails directly only for advanced custom notebooks that need explicit runtime plumbing.',
                                       'glossary_terms': ['notebook template', 'data agreement', 'metadata lakehouse'],
                                       'return_interpretation': 'Returns a PipelineRunContext populated with run, pipeline, agreement, and notebook identity.',
                                       'common_failure_causes': ['No agreement exists.', 'The selector has not produced a selected agreement.', 'spark or metadata routing is unavailable.']},
 'get_active_pipeline_context': {'expanded_purpose': 'Returns the active guided pipeline context established by a start helper.',
                                 'when_to_use': 'Use inside custom guided wrappers or notebook cells that need resolved runtime values without repeating plumbing.',
                                 'do_not_use_when': 'Do not call before start_pipeline_run or start_pipeline_run_with_agreement.',
                                 'glossary_terms': ['notebook template'],
                                 'return_interpretation': 'Returns the stored PipelineRunContext.',
                                 'common_failure_causes': ['No active pipeline context has been started.']},
 'profile_source_tables': {'expanded_purpose': 'Profiles source table configs using the active guided pipeline context.',
                           'when_to_use': 'Use in guided 02_pipeline before transformations to collect non-blocking source profile evidence.',
                           'glossary_terms': ['source data', 'guardrails', 'evidence'],
                           'return_interpretation': 'Returns the standard run_table_guardrails result bundle.',
                           'common_failure_causes': ['No active pipeline context exists.', 'Source table configs are incomplete.']},
 'profile_target_tables': {'expanded_purpose': 'Profiles target table configs using the active guided pipeline context.',
                           'when_to_use': 'Use in guided 02_pipeline after transformations and target config preparation to collect non-blocking target profile evidence.',
                           'glossary_terms': ['target table', 'guardrails', 'evidence'],
                           'return_interpretation': 'Returns the standard run_table_guardrails result bundle.',
                           'common_failure_causes': ['No active pipeline context exists.', 'Target table configs are incomplete.']},
 'enforce_source_guardrails': {'expanded_purpose': 'Runs blocking source guardrail enforcement with runtime context resolved from the active guided pipeline context.',
                               'when_to_use': 'Use in guided 02_pipeline before target writes.',
                               'glossary_terms': ['source data', 'guardrails', 'can_continue'],
                               'return_interpretation': 'Returns the standard guardrail bundle and stops when blocking failures cannot continue.',
                               'common_failure_causes': ['A blocking source guardrail fails.', 'No active pipeline context exists.']},
 'enforce_target_guardrails': {'expanded_purpose': 'Runs blocking target guardrail enforcement with runtime context resolved from the active guided pipeline context.',
                               'when_to_use': 'Use in guided 02_pipeline before target writes.',
                               'glossary_terms': ['target table', 'guardrails', 'can_continue'],
                               'return_interpretation': 'Returns the standard guardrail bundle and stops when blocking failures cannot continue.',
                               'common_failure_causes': ['A blocking target guardrail fails.', 'No active pipeline context exists.']},
 'complete_pipeline_run': {'expanded_purpose': 'Writes the run summary for guided 02_pipeline notebooks from active context and enforcement results.',
                           'when_to_use': 'Use at the end of guided 02_pipeline after enforcement, target writes, and lineage evidence.',
                           'glossary_terms': ['guardrails', 'evidence', 'metadata lakehouse'],
                           'return_interpretation': 'Returns the summary row produced by write_pipeline_run_summary.',
                           'common_failure_causes': ['No active pipeline context exists.', 'Summary metadata cannot be written.', 'Guardrail result bundles are malformed.']},
 ...
 'widget_review_table_governance': {'expanded_purpose': 'Renders 03-only formal review controls for enrichment and guardrail records.',
                                    ...
                                    'do_not_use_when': 'Do not use from 02_pipeline or to write enforcement results.',
                                    'glossary_terms': ['guardrails', 'metadata lakehouse', 'notebook template'],
