...
PUBLIC_SYMBOL_DOCS = [{'kind': 'function',
 ...
 {'kind': 'function',
  'module': 'governance_review',
  'function_type': 'callable',
  'summary_override': 'Render clear guardrail authoring widgets for the selected table.',
  'symbol_name': 'widget_author_guardrail_rules',
  'template_notebook': '03_governance',
  'template_segment': 'Guardrail authoring',
  'use_when': 'Use this public FabricOps helper from the matching notebook workflow when guardrail authoring is required.',
  ...
  'returns': 'Nested notebook-facing state for schema/freshness/profile and DQ authoring widgets.',
  'related_functions': ['widget_author_schema_freshness_profile_rules', 'widget_author_dq_rules', 'widget_review_table_governance'],
  'expanded_purpose': 'Groups guardrail authoring controls so governance notebooks can author rules separately from formal review decisions.',
  'when_to_use': 'Use in 03_governance after target selection when governance users need to create guardrail rule records before review.',
  ...
  'return_interpretation': 'The returned dictionary contains the nested authoring widget states and save helpers.',
  'common_failure_causes': ['No target state is selected.', 'The selected table has no columns.', 'The metadata target cannot be written.']},
 {'kind': 'function',
  'module': 'governance_review',
  'function_type': 'callable',
  'summary_override': 'Render the 03-only formal table governance review widget.',
  'symbol_name': 'widget_review_table_governance',
  'template_notebook': '03_governance',
  'template_segment': 'Formal governance review',
  'use_when': 'Use this public FabricOps helper from 03_governance when formal review decisions are required.',
  'parameters': 'See the source docstring for the notebook runtime, Spark session, state, and context parameters accepted by this helper.',
  'returns': 'Widget state with grouped review sections, controls, buttons, and action helpers.',
  'related_functions': ['widget_enrich_table_metadata', 'widget_author_guardrail_rules', 'enforce_dq_rules'],
  'expanded_purpose': 'Reviews enrichment and guardrail records for a selected table and appends approve, approve-and-activate, reject, replace, deactivate, and history decisions to the rule history tables.',
  'when_to_use': 'Use in 03_governance after selecting a profiled table and optionally authoring enrichment or guardrail records.',
  'do_not_use_when': 'Do not use from 02_pipeline or for runtime enforcement results; runtime outcomes belong in METADATA_GUARDRAIL_RESULTS.',
  'glossary_terms': ['guardrail', 'metadata lakehouse', 'notebook template'],
  'return_interpretation': 'Needs-review, active, inactive/rejected, and superseded sections show append-only governance history; action helpers append new lifecycle rows.',
  'common_failure_causes': ['The helper is called outside 03_governance.', 'No reviewable records are selected.', 'The metadata target cannot be written.']},
 {'kind': 'function',
  'module': 'governance_review',
  'function_type': 'callable',
