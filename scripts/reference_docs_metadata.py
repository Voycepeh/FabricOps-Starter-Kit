...
PUBLIC_SYMBOL_DOCS = [
 {'kind': 'function',
  ...
  'common_failure_causes': ['A workspace data item target is not configured or accessible.', 'Catalogue layer/schema/table identity does not match the observed SQL object.', 'The scanning identity cannot read the SQL permission catalogue views.'],
