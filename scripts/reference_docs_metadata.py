...
TEMPLATE_FLOW_DOCS = [{'notebook_key': '00_env_config',
 ...
 {'notebook_key': '02_pipeline',
  ...
  'segment_intro': 'Simple v0.2 Lakehouse-first pipeline with complete-table Warehouse read and '
                   'write alternatives.',
  'segments': [{'symbols': ['widget_select_data_contract', 'observe_table', 'check_schema', 'check_freshness', 'check_changes', 'check_dq'],
...
PUBLIC_SYMBOL_DOCS = [
 ...
 {'kind': 'function',
  'module': 'pipeline',
  'function_type': 'callable',
  'summary_override': 'Select incremental source scope and an explicit target maintenance strategy.',
  'symbol_name': 'plan_incremental_processing',
  'template_notebook': '02_pipeline',
  'template_segment': 'Source guardrails',
  'use_when': 'Use after check_changes to plan a recurring Lakehouse load.',
  'do_not_use_when': 'Do not use for change detection, transformation, or target execution.',
  'parameters': 'Change result, target strategy, and optional partition, key, and effective columns.',
  'returns': 'Plain dictionary describing read scope and target write semantics.',
  'side_effects': 'None.',
  'preferred_example': 'plan = plan_incremental_processing(changes_result, "merge", key_columns=["order_id"])',
  'related_functions': ['check_changes', 'read_lakehouse_table', 'write_incremental_lakehouse_table']},
 {'kind': 'function',
  'module': 'io',
  'function_type': 'callable',
  'summary_override': 'Apply overwrite, append, merge/SCD1, or SCD2 to a Lakehouse Delta target.',
  'symbol_name': 'write_incremental_lakehouse_table',
  'template_notebook': '02_pipeline',
  'template_segment': 'Source guardrails',
  'use_when': 'Use after transformation and validation with a processing plan.',
  'do_not_use_when': 'Do not use for Warehouse targets or source change detection.',
  'parameters': 'DataFrame, target identity, processing plan, and optional SCD2 tracked columns.',
  'returns': 'None.',
  'side_effects': 'Writes or merges a configured Lakehouse Delta target.',
  'preferred_example': 'write_incremental_lakehouse_table(df, "orders", plan, target="curated")',
  'related_functions': ['plan_incremental_processing', 'write_lakehouse_table']},
 {'kind': 'function',
  'module': 'pipeline',
  'function_type': 'callable',
