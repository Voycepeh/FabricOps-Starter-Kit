...
MODULE_DOCS_METADATA: list[ModuleDocMetadata] = [
    ...
    {"module_name": "governance_review", "visibility": "public", "module_summary": "Owns table-scoped governance review, approved metadata recording, and internal DQ drafting/enforcement helpers migrated from the removed standalone data_quality.py module for the upcoming production enforcement track.", "sidebar_group": "1. Governance steward", "sidebar_include": True},
