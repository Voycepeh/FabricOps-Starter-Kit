...
PUBLIC_SYMBOL_DOCS = [
 ...
 {'kind': 'function',
  ...
  'parameters': 'Prepared DataFrame, target identity or physical coordinates, and optional Development processing proposal.',
  ...
  'preferred_example': 'write_result = pipeline_write(prepared_df, target="unified", schema="dbo", table_name="orders")',
