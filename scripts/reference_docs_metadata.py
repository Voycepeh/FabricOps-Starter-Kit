...
PUBLIC_SYMBOL_DOCS = [
 ...
 {'kind': 'function',
  ...
  'expanded_purpose': 'Resolves one metadata_table_key through discovery, direct, agreement-linked, explicit restricted, or historical current-notebook lineage scope; joins current catalogue, enrichment, and guardrail intent; and displays profiling, guardrail-result, and access history separately.',
