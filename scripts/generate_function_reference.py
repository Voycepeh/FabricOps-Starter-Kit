...
ACTION_LEGEND = {
    ...
    "Review for merge": "Helper has one distinct caller, one call site, and is not recursive; review whether merging improves readability.",
    "Used by one function": "Helper has one distinct caller. This is a review hint, not an automatic judgment.",
    "Used several times in one function": "Helper has one distinct caller, but that caller uses it more than once; this weakens merge or inline suggestions.",
