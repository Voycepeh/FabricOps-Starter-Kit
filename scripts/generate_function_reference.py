...
""".replace("public functions", "public callables").replace("Public functions", "Public callables").replace("public function", "public callable").replace("Public function", "Public callable").replace("<!--CALLABLE_GENERATION_BANNER-->", generation_banner).replace("<!--CALLABLE_PAGE_SHELL_CSS-->", _callable_page_shell_css()).replace("<!--CALLABLE_PAGE_NAV-->", _render_callable_page_nav("architecture")).replace("<!--ARCHITECTURE_SCOPE_ROWS-->", architecture_scope_rows).replace("<!--ARCHITECTURE_SUMMARY_PUBLIC-->", str(architecture_summary_counts["public"])).replace("<!--ARCHITECTURE_SUMMARY_SHARED-->", str(architecture_summary_counts["shared"])).replace("<!--ARCHITECTURE_SUMMARY_PRIVATE-->", str(architecture_summary_counts["private"])).replace("<!--ARCHITECTURE_SUMMARY_REVIEW-->", str(architecture_summary_counts["review"])).replace("<!--ARCHITECTURE_SUMMARY_ISSUES-->", str(architecture_summary_counts["issues"])).replace("<!--ARCHITECTURE_SUMMARY_SIGNALS-->", str(architecture_summary_counts["healthy"])).replace("<!--EMBEDDED_FUNCTION_CALL_GRAPH_DATA-->", embedded_graph_data)
