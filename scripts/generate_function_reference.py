...
def _build_function_inventory(
    ...
    def is_inventory_function(qn: str) -> bool:
        ...
        if layer in {"public", PUBLIC_CLASS_LAYER}:
            return True
        if layer in {"internal", HIDDEN_PRIVATE_LAYER}:
            return qn in runtime_reachable_qns
        return False
