...
def _render_callable_generation_banner(flow_data: dict[str, Any]) -> str:
    ...
    parts = [
        ...
        f"<span><strong>Dashboard asset version:</strong> {html.escape(metadata.get('generated_at_utc') or 'unknown')}</span>",
        '<span><strong>Boot code version:</strong> boot-dashboard-v1</span>',
    ]
