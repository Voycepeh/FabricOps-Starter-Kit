...
<main>
  ...
  <p id="resultCount"></p>
  <section class="table-wrap" aria-label="Combined callable inventory"><table><thead><tr><th class="col-select"><input id="selectAllVisible" type="checkbox" aria-label="Select all visible rows"></th><th class="col-view">View</th><th class="col-callable"><button type="button" data-sort="function_name">Callable</button></th><th class="col-qualified"><button type="button" data-sort="qualified_name">Qualified name</button></th><th class="col-kind"><button type="button" data-sort="callable_kind">Kind</button></th><th class="col-classification"><button type="button" data-sort="function_type">Classification</button></th><th class="col-review"><button type="button" data-sort="review_status_label">Review status</button></th><th class="col-module"><button type="button" data-sort="module">Module</button></th><th class="col-used-by num"><button type="button" data-sort="used_by_count">Used by</button></th><th class="col-calls num"><button type="button" data-sort="calls_count">Calls</button></th><th class="col-signal">Signal</th><th class="col-action">Recommended action</th><th class="col-risk"><button type="button" data-sort="priority">Compatibility risk</button></th><th class="col-notes">Notes / rationale</th></tr></thead><tbody id="inventoryBody"></tbody></table></section>
</main>
<script>
