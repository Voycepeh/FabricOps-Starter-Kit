...
def generate_landing_stats(
    *,
    ...
    public_function_count = summary_counts.get("public_api_surface", {}).get("public_api_entrypoints", len(public_exports))
    total_callable_records = summary_counts.get("total_callables", 0)
    function_callable_count = summary_counts.get("callable_kind", {}).get("function", 0)
    stats = {
        "public_function_count": public_function_count,
        "total_callable_records": total_callable_records,
        "function_callable_count": function_callable_count,
...
def update_landing_page_counts(stats: dict[str, int]) -> None:
    ...
    replacements = {
        "FABRICOPS_PUBLIC_FUNCTION_COUNT": _landing_count_text(
            stats["public_function_count"], "public Starter Kit functions"
        ),
        "FABRICOPS_CALLABLE_RECORD_COUNT": _landing_count_text(
            stats["total_callable_records"], "discovered callable records"
        ),
...
def main() -> None:
    ...
    callable_summary = callable_flow_data.get("summary_counts", {})
    callable_kind_counts = callable_summary.get("callable_kind", {})
    public_function_count = callable_summary.get("public_api_surface", {}).get("public_api_entrypoints", len(function_symbol_map))
    total_callable_records = callable_summary.get("total_callables", 0)
    function_callable_count = callable_kind_counts.get("function", 0)
    non_function_callable_count = total_callable_records - function_callable_count
    ref = [
        "# Function Reference",
        "",
        ...
        f'    <strong class="reference-kpi-value">{public_function_count}</strong>',
        ...
        '  </section>',
        '  <section class="reference-kpi-card surface-card">',
        f'    <strong class="reference-kpi-value">{total_callable_records}</strong>',
        ...
        '  </section>',
        '  <section class="reference-kpi-card surface-card">',
        f'    <strong class="reference-kpi-value">{function_callable_count}</strong>',
        ...
        '  </section>',
        '  <section class="reference-kpi-card surface-card">',
        f'    <strong class="reference-kpi-value">{non_function_callable_count}</strong>',
