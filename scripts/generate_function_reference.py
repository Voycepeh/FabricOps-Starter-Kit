...
def _render_combined_refactor_dashboard_html(flow_data: dict[str, Any]) -> str:
    ...
    dashboard = dashboard.replace('<section class="table-actions">', f'{export_html}<section class="table-actions">', 1)
    dashboard = dashboard.replace("</main><script>", f"{runtime_inventory_html}</main><script>", 1)
