...
def _decision_action(flow: dict[str, Any], callee_rows: list[dict[str, Any]]) -> str:
    ...
    if flow["maximum_chain_depth"] >= 4 or flow["downstream_callable_count"] >= 12 or flow["modules_touched_count"] >= 4:
