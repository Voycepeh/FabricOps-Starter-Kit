...
def _render_callable_page_nav(active_page: str) -> str:
    ...
    return (
        ...
        f'{tab("architecture", "Function Call Graph", "callable-functions-dashboard.html")}'
        f'{tab("inventory", "Function Inventory", "callable-functions-inventory.html")}'
        '</div>'
