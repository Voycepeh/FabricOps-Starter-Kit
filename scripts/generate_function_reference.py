...
def _call_tree_label(
    ...
    *,
    ...
    if context.get("architecture_result") == "Violation" or context.get("architecture_violation_count"):
        label += ' <span class="reference-call-tree-note">[violation]</span>'
    elif context.get("architecture_result") == "Warning":
        label += ' <span class="reference-call-tree-note">[warning]</span>'
    elif context.get("helper_cleanup_candidate") or str(context.get("recommended_action") or "").lower() == "shared dependency":
        label += ' <span class="reference-call-tree-note">[shared dependency]</span>'
    if recursive:
        label += ' <span class="reference-call-tree-note">[warning]</span>'
    return label
