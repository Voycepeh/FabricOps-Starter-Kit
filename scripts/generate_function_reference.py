...
""".replace("<!--CALLABLE_GENERATION_BANNER-->", generation_banner).replace("<!--CALLABLE_PAGE_NAV_CSS-->", _callable_page_nav_css()).replace("<!--CALLABLE_PAGE_NAV-->", _render_callable_page_nav("architecture"))
...
""".replace("<!--CALLABLE_GENERATION_BANNER-->", generation_banner).replace("<!--CALLABLE_PAGE_NAV_CSS-->", _callable_page_nav_css()).replace("<!--CALLABLE_PAGE_NAV-->", _render_callable_page_nav("inventory"))
