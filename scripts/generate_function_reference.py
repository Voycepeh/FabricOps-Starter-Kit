...
def _format_generated_at_sgt(value: str | None) -> str:
    """Return the visible Singapore time label for callable dashboard metadata."""
    if not value:
        return "Unknown"
