...
def _render_callable_page_nav(active_page: str) -> str:
    ...
    return (
        ...
        '<a id="openCallableFlowJson" class="callable-page-action" href="../reference/_data/callable-flow.json">Open JSON data</a>'
