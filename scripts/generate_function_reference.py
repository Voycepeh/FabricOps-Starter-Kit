...
def main() -> None:
    ...
    for flow in template_flow_docs:
        ...
        for segment in flow["segments"]:
            ...
            if not unique_symbols:
                continue
            chips = [function_chip(symbol_name, public_reference_link(symbol_name, docs_metadata, context="notebook")) for symbol_name in unique_symbols]
            template_function_map.extend([
    ...
    for generated_page in [*CALLABLE_REFERENCE_DIR.glob("*.md"), *LEGACY_CALLABLE_REFERENCE_DIR.glob("*.md"), *INTERNAL_REFERENCE_DIR.glob("*.md")]:
        generated_page.unlink()
