...
ACTION_LEGEND = {
    ...
    "Architecture violation": "Callable dependency direction breaks the role-aware callable dependency rule.",
...
const refactorGuidance = {
  ...
  'Architecture violation': ['architecture_violation', 'Dependency direction breaks the role-aware callable dependency rule. Review upward dependencies, workflow coupling, and utility/model project-callable dependencies before cleanup.'],
