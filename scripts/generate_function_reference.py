...
def main() -> None:
    ...
    ref = [
        ...
        '  </section>',
        '  <section class="reference-kpi-card surface-card">',
        f'    <strong class="reference-kpi-value">{supporting_internal_count}</strong>',
