...
def _build_callable_flow_data(
    ...
    summary_counts["public_api_surface"] = {
        ...
        "boundary_violations": sum(1 for flow in public_entrypoint_flow if flow["architecture_violation_count"]),
