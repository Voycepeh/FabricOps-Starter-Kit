...
def _render_refactor_dashboard_html(flow_data: dict[str, Any]) -> str:
    ...
    embedded_flow_data_json = json.dumps(flow_data, ensure_ascii=False, separators=(",", ":"))
