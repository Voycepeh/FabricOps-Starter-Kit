...
def _runtime_inventory_embed_css() -> str:
    ...
    return (
        ...
        "#runtime-inventory .callable-review-table .col-details{width:7rem;min-width:7rem;white-space:nowrap}"
        "#runtime-inventory .callable-review-table .details-toggle{white-space:nowrap;word-break:keep-all;overflow-wrap:normal}"
        "@media(max-width:720px){#runtime-inventory .callable-review-table{min-width:700px}#runtime-inventory .callable-review-table .col-file-area{width:7.5rem;max-width:7.5rem}#runtime-inventory .callable-review-table .col-callable{width:10rem;max-width:10rem}#runtime-inventory .callable-review-table .col-details{width:6rem;min-width:6rem}}"
