...
<details class="overview-help"><summary>Public function table signals</summary>Rows show <span class="badge warn">Large width/depth</span> when Width &gt; 10 or Depth &gt; 5, and <span class="badge danger">Architecture violation</span> when one or more Type 1 to Type 6 architecture violation edges appears in the public function flow.</details>
