...
<section id="architectureWorkflow" class="workflow-panel active"><section class="architecture-summary-cards"><article class="architecture-summary-card info"><small>Main review</small><span>Public functions</span><strong id="card-public">0</strong></article><article class="architecture-summary-card risk"><small>Main review</small><span>With architecture violation</span><strong id="card-warnings">0</strong></article><article class="architecture-summary-card review"><small>Main review</small><span>With large width/depth</span><strong id="card-large">0</strong></article><article class="architecture-summary-card good"><small>Supported by</small><span>Shared helper functions</span><strong id="card-shared-helpers">0</strong></article><article class="architecture-summary-card info"><small>Supported by</small><span>Nested private functions</span><strong id="card-private-functions">0</strong></article></section>
