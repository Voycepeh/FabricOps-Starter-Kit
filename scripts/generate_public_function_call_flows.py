...
<section class="table-wrap"><table id="publicFlowTable"><thead><tr><th class="function-col"><button class="sort-button" data-sort="function_name" type="button">Function</button></th><th class="file-col"><button class="sort-button" data-sort="source_path" type="button">File</button></th><th class="metric-col"><button class="sort-button" data-sort="direct_call_count" type="button">Direct calls</button></th><th class="metric-col"><button class="sort-button" data-sort="transitive_function_count" type="button">Transitive functions</button></th><th class="metric-col"><button class="sort-button" data-sort="max_depth" type="button">Max depth</button></th><th class="metric-col"><button class="sort-button" data-sort="files_touched" type="button">Files touched</button></th><th class="signals-col">Signals</th><th class="action-col"><button class="sort-button" data-sort="suggested_refactor_action" type="button">Suggested action</button></th></tr></thead><tbody id="public-table"></tbody></table></section>
<section id="selected-public-function-panel" class="flow-details"><h2>Selected public function</h2><div id="selectedSummary">Select a public function row.</div><h2>Selected call tree</h2><div id="selected-call-tree" class="flow-tree"></div><h2>Selected callable inventory</h2><section class="filter-panel" aria-label="Selected callable inventory filters"><label class="filter-field">Search selected inventory <input id="inventorySearch" type="search" placeholder="Function, type, file, parent"></label><label class="filter-field">Function type <select id="inventoryTypeFilter"><option value="">All types</option></select></label><button id="clearInventoryFilters" type="button">Clear filters</button></section><div class="table-actions"><button id="selectVisibleInventory" type="button">Select all visible selected-inventory rows</button><button id="clearInventory" type="button">Clear selected inventory rows</button><strong id="inventorySelectedCount">0 selected</strong><small id="inventoryRowCount">0 rows</small></div><div class="table-wrap"><table id="selectedCallableInventoryTable"><thead><tr><th class="select-col">Select checkbox</th><th class="function-col"><button class="sort-button" data-inventory-sort="function_name" type="button">Function</button></th><th class="type-col"><button class="sort-button" data-inventory-sort="function_type" type="button">Type</button></th><th class="file-col"><button class="sort-button" data-inventory-sort="source_path" type="button">File</button></th><th class="metric-col"><button class="sort-button" data-inventory-sort="depth" type="button">Depth</button></th><th class="parent-col"><button class="sort-button" data-inventory-sort="parent_qualified_name" type="button">Parent</button></th></tr></thead><tbody id="inventoryBody"></tbody></table></div></section>
