...
<style>
body{font-family:system-ui,-apple-system,Segoe UI,sans-serif;margin:0;color:#172033;background:#f8fafc}header,main{max-width:1180px;margin:auto;padding:1rem}h1{margin-bottom:.25rem}.overview-help{color:#475569}.workflow-tabs{display:flex;flex-wrap:wrap;gap:.5rem;margin:1rem 0}.workflow-tab{border:1px solid #cbd5e1;background:#fff;color:#334155;border-radius:999px;padding:.55rem .85rem}.workflow-tab.active{background:#1d4ed8;border-color:#1d4ed8;color:#fff}.workflow-panel{display:none}.workflow-panel.active{display:block}.architecture-summary-cards{display:grid;grid-template-columns:repeat(auto-fit,minmax(9.5rem,1fr));gap:.5rem;margin:.75rem 0}.architecture-summary-card{padding:.65rem;border:1px solid #dbe3ef;border-radius:.75rem;background:#fff}.architecture-summary-card strong{display:block;font-size:1.55rem}.risk{border-color:#fecaca!important;background:#fef2f2!important}.review{border-color:#fde68a!important;background:#fffbeb!important}.info{border-color:#bfdbfe!important;background:#eff6ff!important}.good{border-color:#bbf7d0!important;background:#f0fdf4!important}.filter-panel,.export-toolbar,.flow-details{margin:.75rem 0;padding:.75rem;border:1px solid #dbe3ef;border-radius:.75rem;background:#fff}.filter-panel{display:grid;grid-template-columns:minmax(16rem,1fr) repeat(2,minmax(11rem,15rem)) auto;gap:.55rem;align-items:end}.filter-field{display:flex;flex-direction:column;font-size:.82rem;font-weight:800;gap:.2rem}input,select,button{padding:.43rem .52rem;border:1px solid #cbd5e1;border-radius:.45rem;background:#fff}button{cursor:pointer;font-weight:800;color:#1d4ed8}.primary-action{background:#1d4ed8;color:#fff;border-color:#1d4ed8}.table-actions,.toolbar-row{display:flex;flex-wrap:wrap;gap:.5rem;align-items:center;margin:.55rem 0}.table-wrap{overflow-x:auto;overflow-y:hidden;background:#fff;border:1px solid #dbe3ef;border-radius:.75rem;-webkit-overflow-scrolling:touch}table{width:100%;border-collapse:collapse;table-layout:auto}#publicFlowTable{min-width:1180px}#selectedCallableInventoryTable{min-width:1060px}#definedButNotUsedTable{min-width:960px}th,td{padding:.55rem .65rem;border-bottom:1px solid #e2e8f0;text-align:left;vertical-align:top;font-size:.84rem;white-space:normal;overflow-wrap:break-word;word-break:normal}th{background:#eef2f7;color:#334155;font-size:.75rem;line-height:1.25;white-space:normal;overflow-wrap:normal;word-break:keep-all}td code{white-space:normal;overflow-wrap:break-word;word-break:break-word}.col-function{min-width:18rem}.col-file{min-width:22rem}.col-select{min-width:7.5rem}.col-type{min-width:7rem}.col-small{min-width:6.5rem;width:6.5rem}.col-signals{min-width:12rem}.col-action{min-width:13rem}.col-parent{min-width:16rem}.col-reason{min-width:14rem}col.col-function{width:18rem}col.col-file{width:22rem}col.col-select{width:7.5rem}col.col-type{width:7rem}col.col-small{width:6.5rem}col.col-signals{width:12rem}col.col-action{width:13rem}col.col-parent{width:16rem}col.col-reason{width:14rem}.sort-button{border:0;background:transparent;padding:0;color:#1d4ed8;text-align:left;line-height:1.25;white-space:normal;overflow-wrap:normal;word-break:keep-all}.sort-button:after{content:' ↕';color:#64748b;white-space:nowrap}tr[data-public-flow-row]{cursor:pointer}tr[data-public-flow-row]:focus{outline:3px solid #2563eb;outline-offset:-3px}tr.active{outline:2px solid #1d4ed8;outline-offset:-2px;background:#eff6ff;box-shadow:inset .25rem 0 #1d4ed8}.source-link{color:#1d4ed8;text-decoration:underline;overflow-wrap:break-word;word-break:break-word}.badge{display:inline-flex;margin:.06rem;padding:.12rem .38rem;border-radius:999px;font-size:.7rem;font-weight:800;background:#e0e7ff;color:#3730a3}.warn{background:#fef3c7;color:#92400e}.muted{background:#f1f5f9;color:#475569}.flow-summary-card{padding:.75rem;border:1px solid #bfdbfe;border-radius:.75rem;background:#eff6ff}.flow-meta{display:grid;grid-template-columns:repeat(auto-fit,minmax(135px,1fr));gap:.5rem}.flow-meta div{padding:.45rem;border:1px solid #e2e8f0;border-radius:.5rem;background:#fff}.flow-tree{overflow-x:hidden;border:1px solid #dbe3ef;border-radius:.75rem;padding:.7rem;background:linear-gradient(180deg,#fff,#f8fafc)}.tree-node{position:relative;margin:.32rem 0;padding:.55rem .65rem .55rem .9rem;border:1px solid #dbe3ef;border-radius:.7rem;background:#fff;box-shadow:0 1px 2px rgba(15,23,42,.04);white-space:normal;overflow-wrap:anywhere;word-break:normal}.tree-node:before{content:'';position:absolute;left:-.45rem;top:-.42rem;bottom:-.42rem;border-left:2px solid #dbe3ef}.tree-node:after{content:'';position:absolute;left:-.45rem;top:1.05rem;width:.45rem;border-top:2px solid #dbe3ef}.tree-row-main{display:flex;flex-wrap:wrap;align-items:center;gap:.3rem}.tree-caret{color:#64748b;font-size:.78rem}.tree-function{font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-weight:900;color:#1d4ed8;text-decoration:none;overflow-wrap:anywhere}.tree-file{display:inline-flex;margin:.06rem;padding:.12rem .38rem;border-radius:.38rem;font-size:.7rem;font-weight:800;background:#f1f5f9;color:#475569}.tree-status-violation{background:#fee2e2;color:#991b1b}.tree-status-warning{background:#fef3c7;color:#92400e}.tree-status-review{background:#e0f2fe;color:#075985}.tree-type-public-function{background:#dbeafe;color:#1e40af}.tree-type-public-dependency{background:#ede9fe;color:#5b21b6}.tree-type-shared-function{background:#dcfce7;color:#166534}.tree-type-private-function{background:#f1f5f9;color:#475569}.export-toolbar{background:#f8fafc}.toolbar-card-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(min(100%,18rem),1fr));gap:.5rem}.toolbar-card{padding:.6rem;border:1px solid #e2e8f0;border-radius:.65rem;background:#fff}.row-selected{background:#eff6ff}@media(max-width:760px){header,main{padding:.75rem}.filter-panel{grid-template-columns:1fr;padding:.65rem}.table-wrap{margin-left:-.25rem;margin-right:-.25rem;border-radius:.55rem}th,td{font-size:.78rem;padding:.48rem .55rem}.col-function{min-width:16rem}.col-file{min-width:20rem}.tree-node{margin-left:min(var(--tree-indent,0rem),3.5rem)!important;padding-left:.75rem!important}.tree-node:before{left:-.35rem}.tree-node:after{left:-.35rem;width:.35rem}}
</style></head><body><header><h1>Public Function Call Flows V2</h1><p class="overview-help">Review public-function architecture separately from defined-but-not-used cleanup, then export one focused AI refactor packet.</p><p class="overview-help"><strong id="generatedTimestamp">Generated: loading…</strong> · Source JSON: <a id="sourceJsonLink" href="https://github.com/Voycepeh/FabricOps-Starter-Kit/raw/main/docs/reference/_data/public-function-call-flows.json" target="_blank" rel="noopener">Download from GitHub</a></p></header><main>
<nav class="workflow-tabs" aria-label="Dashboard workflows"><button id="architectureTab" class="workflow-tab active" type="button" data-workflow-tab="architecture">Public function architecture</button><button id="orphanTab" class="workflow-tab" type="button" data-workflow-tab="orphan">Orphan function cleanup</button></nav>
<section id="architectureWorkflow" class="workflow-panel active">
...
function typeLabel(type){return ({public_function:'Public function',public_dependency:'Public dependency',shared_function:'Shared helper',private_function:'Private helper'})[type]||type||'Helper'}
function treeStatus(signals){const values=signals||[];if(values.some(x=>x==='public_calls_public'||x==='cross_file_private_dependency'))return {label:'Violation',cls:'tree-status-violation'};if(values.some(x=>x==='large_depth'||x==='large_width'))return {label:'Warning',cls:'tree-status-warning'};return {label:'Review',cls:'tree-status-review'}}
function nodeSignals(root,node){return node.depth===0?(root.signals||[]):[]}
function treeNode(root,node){const status=treeStatus(nodeSignals(root,node));const typeClass=`tree-type-${String(node.function_type||'helper').replaceAll('_','-')}`;return `<div class="tree-node" style="--tree-indent:${Math.min((node.depth||0)*.85,4.25)}rem;margin-left:var(--tree-indent)"><div class="tree-row-main"><span class="tree-caret">▸</span><a class="tree-function" href="../../../${esc(node.source_path)}#L${esc(node.source_start_line||1)}" target="_blank" rel="noopener">${esc(node.function_name)}(...)</a><span class="badge ${esc(typeClass)}">${esc(typeLabel(node.function_type))}</span><span class="tree-file">${esc(basename(node.source_path))}</span><span class="badge ${status.cls}">${esc(status.label)}</span></div></div>`}
...
function renderCards(){const s=DATA.summary||{}; const defined=s.defined_function_count??DATA.defined_functions.length, unused=s.defined_but_not_used_count??DATA.defined_but_not_used.length; $('card-public').textContent=s.public_function_count??DATA.public_functions.length; $('card-warnings').textContent=DATA.public_functions.filter(f=>(f.refactor_signals||[]).length).length; $('card-large').textContent=DATA.public_functions.filter(f=>(f.signals||[]).some(x=>x==='large_depth'||x==='large_width')).length; $('card-used').textContent=s.used_function_count??DATA.used_functions.length; $('card-defined').textContent=defined; $('card-orphan-defined').textContent=defined; $('card-orphan-unused').textContent=unused; $('card-unused-percent').textContent=`${unusedPercentage(s).toFixed(1)}%`}
...
function renderUnused(){cleanupRows=filteredCleanupRows();$('cleanupRowCount').textContent=`${cleanupRows.length} of ${(DATA.defined_but_not_used||[]).length} rows`;$('unused-table').innerHTML=cleanupRows.map(n=>`<tr class="${selectedCleanup.has(n.qualified_name)?'row-selected':''}"><td><input class="cleanup-check" type="checkbox" data-qn="${esc(n.qualified_name)}" ${selectedCleanup.has(n.qualified_name)?'checked':''}></td><td><code>${esc(n.function_name)}</code></td><td>${sourceLink(n)}</td><td>${esc(n.reason)}</td><td>${esc(n.suggested_action)}</td></tr>`).join('')}
...
function packet(){const f=selectedPublic; const inv=uniqInventory(f.flow); const selectedInv=selectedInventory.size?inv.filter(n=>selectedInventory.has(n.qualified_name)):inv; return {schema:'fabricops_public_function_call_flow_refactor_packet_v2',generated_at_utc:new Date().toISOString(),selected_public_function:{function_name:f.function_name,qualified_name:f.qualified_name,source_path:f.source_path,source_start_line:f.source_start_line,source_end_line:f.source_end_line},selected_flow_summary:{direct_call_count:f.direct_call_count,transitive_function_count:f.transitive_function_count,max_depth:f.max_depth,files_touched:f.files_touched||[],signals:f.signals||[],refactor_summary:f.refactor_summary,suggested_refactor_action:f.suggested_refactor_action},selected_flow_functions:f.flow||[],selected_inventory_assets:selectedInv,refactor_signals:f.refactor_signals||[],instructions_for_ai:['Create a focused cleanup PR from this selected public function flow.','Use the selected public function flow as the source of truth.','Default to breaking cleanup: remove obsolete helpers instead of preserving compatibility wrappers.','Do not refactor unrelated files.','Do not regenerate unrelated generated docs or old dashboard artifacts.']}}
function orphanPacket(){const s=DATA.summary||{};const selected=selectedCleanup.size?cleanupRows.filter(n=>selectedCleanup.has(n.qualified_name)):cleanupRows;return {schema:'fabricops_orphan_function_cleanup_packet_v1',generated_at_utc:new Date().toISOString(),generated_at_sgt:(DATA.metadata||{}).generated_at_sgt||null,source_json_url:(DATA.metadata||{}).source_json_url||null,summary:{defined_function_count:s.defined_function_count??(DATA.defined_functions||[]).length,defined_but_not_used_count:s.defined_but_not_used_count??(DATA.defined_but_not_used||[]).length,unused_percentage:Number(unusedPercentage(s).toFixed(1))},selected_orphan_functions:selected,instructions_for_ai:['Review whether each orphan function is truly unused.','Prefer deletion for obsolete helpers.','If a function is still needed, connect it to the correct public callable flow.','Keep the PR focused and small.','Do not preserve backwards compatibility.','Do not refactor unrelated files.','Do not regenerate unrelated generated artifacts.']}}
