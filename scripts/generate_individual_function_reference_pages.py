...
METADATA_RELATED_FUNCTIONS = {
    ...
    "METADATA_SOURCE_PARTITION_CHECKPOINT": ["read_pipeline_prep", "write_pipeline_prep"],
    "METADATA_SOURCE_WATERMARK_CHECKPOINT": ["read_pipeline_prep", "write_pipeline_prep"],
    "METADATA_GUARDRAIL": [
