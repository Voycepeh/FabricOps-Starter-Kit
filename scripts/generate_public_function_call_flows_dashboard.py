  ...
  function expand(rootQn){
    ...
    function visit(qn,depth,parent,stack,relationship){
      ...
      rows.push({...fn,
        ...
        architecture_signals:relationship?.architecture_signals||[],
        architecture_signal_types:relationship?.architecture_signal_types||[],
        architecture_signal_details:relationship?.architecture_signal_details||[],
