...
export const OpeningPlatform = () => {
  ...
  const exit = interpolate(frame, [215, 270], [0, 1], {extrapolateLeft: 'clamp', extrapolateRight: 'clamp', easing: Easing.inOut(Easing.cubic)});
  return <div style={{position: 'absolute', inset: 0}}>
    ...
    <div style={{position: 'absolute', left: 600, top: 285, width: 720, height: 510, borderRadius: 70, display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', gap: 26, background: '#0d1b30', border: '3px solid #8eb9e488', boxShadow: '0 35px 110px #000c, inset 0 1px #fff1', opacity: 1 - exit, transform: `scale(${0.88 + platform * 0.12 - exit * 0.06})`}}>
      <FABRIC_ICON width={250} height={250} aria-hidden="true" />
      <div style={{fontSize: 58, fontWeight: 800}}>Microsoft Fabric</div>
    </div>
  </div>;
};
