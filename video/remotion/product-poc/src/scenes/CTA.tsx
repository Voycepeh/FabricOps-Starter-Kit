...
const Action = ({label, focus}: {label: string; focus: number}) => <div style={{padding: '20px 34px', borderRadius: 999, border: `2px solid ${focus > 0.4 ? theme.production : '#71839d'}`, background: focus > 0.4 ? `${theme.production}1f` : '#101c2d', color: focus > 0.4 ? '#fff' : '#c3cfdd', fontSize: VIDEO_CONFIG.text.cta, fontWeight: 700, boxShadow: focus > 0.4 ? `0 0 42px ${theme.production}44` : 'none', transform: `scale(${1 + focus * 0.06})`}}>{label}&nbsp; →</div>;
