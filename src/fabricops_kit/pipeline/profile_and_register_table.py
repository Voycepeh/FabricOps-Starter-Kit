...
def _profile_and_register_table_core(
    df,
    *,
    profile_role,
    table=None,
...
PROFILE_AND_REGISTER_TABLE_CORE = partial(_profile_and_register_table_core)
...
def profile_and_register_table(
    ...
    * ``METADATA_DATA_CATALOGUE``: updated or newly added table and column
    ...
    """
    return PROFILE_AND_REGISTER_TABLE_CORE(
        df,
        ...
        schema=schema,
        load_strategy=load_strategy,
        load_strategy_parameters=load_strategy_parameters,
