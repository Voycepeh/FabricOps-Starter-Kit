...
TEMPLATE_FLOW_DOCS: list[TemplateFlowDocMetadata] = [{'notebook_key': '00_env_config',
 ...
 {'notebook_key': '01_data_agreement',
  ...
  'segments': [{'title': 'Segment 1: Render the agreement-intake app',
                'text': 'Use `render_agreement_intake_app(...)` for the default form notebook. Advanced users may call `create_agreement_form(...)`, `read_agreement_form(...)`, `collect_agreement_metadata(...)`, and `commit_agreement_metadata(...)` directly only when customizing the workflow.',
...
PUBLIC_SYMBOL_DOCS: list[PublicSymbolDocMetadata] = [{'symbol_name': 'load_config',
 ...
 {'symbol_name': 'create_agreement_form',
  ...
  'kind': 'function',
  'template_notebook': '`01_da_<agreement>`',
  'template_segment': 'Advanced customization: create agreement metadata widgets',
  'role': 'essential',
  'summary_override': None},
 {'symbol_name': 'collect_agreement_metadata',
  ...
  'kind': 'function',
  'template_notebook': '`01_da_<agreement>`',
  'template_segment': 'Advanced customization: collect and preview agreement metadata',
  'role': 'essential',
  'summary_override': None},
 {'symbol_name': 'commit_agreement_metadata',
  ...
  'kind': 'function',
  'template_notebook': '`01_da_<agreement>`',
  'template_segment': 'Advanced customization: commit metadata records',
  'role': 'essential',
  'summary_override': None},
 {'symbol_name': 'agreement_dropdown_options',
  'module': 'data_agreement',
  'kind': 'function',
  'template_notebook': '—',
  'template_segment': '—',
  'role': 'essential',
  'summary_override': None},
 {'symbol_name': 'latest_agreement_versions',
  'module': 'data_agreement',
  'kind': 'function',
  'template_notebook': '—',
  'template_segment': '—',
  'role': 'essential',
  'summary_override': None},
 {'symbol_name': 'load_active_data_steward_profiles',
  'module': 'data_agreement',
  'kind': 'function',
  'template_notebook': '`01_da_<agreement>`',
  'template_segment': 'Advanced customization: create agreement metadata widgets',
