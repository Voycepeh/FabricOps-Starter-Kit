...
TEMPLATE_FLOW_DOCS: list[TemplateFlowDocMetadata] = [{'notebook_key': '00_env_config',
 ...
 {'notebook_key': '01_data_agreement',
  ...
  'segment_intro': 'Form notebook that renders the agreement-intake app through one framework helper. The helper commits immutable `METADATA_DATA_AGREEMENT` versions and reads manually maintained `METADATA_DATA_STEWARD` profiles for intake dropdowns.',
