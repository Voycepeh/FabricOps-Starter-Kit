...
MODULE_DOCS_METADATA: list[ModuleDocMetadata] = [
    ...
    {"module_name": "technical_columns", "visibility": "public", "module_summary": "Owns lightweight runtime audit columns for pipeline outputs.", "sidebar_group": "3. Data engineer", "sidebar_include": True},
...
TEMPLATE_FLOW_DOCS: list[TemplateFlowDocMetadata] = [{'notebook_key': '00_env_config',
 ...
 {'notebook_key': '03_pc',
  ...
  'segment_intro': 'Core production pipeline flow for clean evidence creation, runtime audit columns, large-table write tuning, and controlled publishing. Audit columns are always useful; hashes, datetime features, and bucket columns are specialized patterns outside the default path.',
  'segments': [{'title': 'Segment 1: Runtime setup, parameters, agreement selection, and registration',
               ...
               {'title': 'Segment 4: Transform, add runtime audit columns, and publish outputs',
                'symbols': ['add_runtime_audit_columns', 'write_lakehouse_table', 'write_warehouse_table']},
...
PUBLIC_SYMBOL_DOCS: list[PublicSymbolDocMetadata] = [{'symbol_name': 'setup_notebook',
 ...
 {'symbol_name': 'build_runtime_audit_fields',
  ...
  'template_segment': '—',
  'role': 'essential',
  'summary_override': 'Build shared underscore-prefixed runtime audit fields for metadata-table rows.'},
 ...
 {'symbol_name': 'add_runtime_audit_columns',
  ...
  'template_segment': '—',
  'role': 'essential',
  'summary_override': 'Add lightweight runtime audit columns before writing pipeline output tables.'},
 {'symbol_name': 'standardize_columns',
  ...
  'template_segment': '—',
  'role': 'optional',
  'summary_override': 'Deprecated compatibility wrapper; use add_runtime_audit_columns for the standard runtime audit path.'},
