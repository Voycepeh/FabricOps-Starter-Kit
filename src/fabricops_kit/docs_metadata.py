...
TEMPLATE_FLOW_DOCS: list[TemplateFlowDocMetadata] = [{'notebook_key': '00_env_config',
 ...
 {'notebook_key': '01_data_agreement',
  ...
  'segment_intro': 'Form notebook that maintains real `METADATA_DATA_STEWARD` reference rows and commits immutable `METADATA_DATA_AGREEMENT` versions.',
  'segments': [{'title': 'Segment 1: Maintain steward reference rows',
                'text': 'Use `render_data_steward_maintenance_app(...)` to append real steward assignment rows before agreement intake. No fake steward identities are seeded.',
                'symbols': ['render_data_steward_maintenance_app']},
               {'title': 'Segment 2: Render the agreement-intake app',
                'text': 'Use `render_agreement_intake_app(...)` for the default agreement form. Advanced users may optionally call lower-level collection and commit helpers only when customizing the workflow.',
...
PUBLIC_SYMBOL_DOCS: list[PublicSymbolDocMetadata] = [{'symbol_name': 'setup_notebook',
 ...
 {'symbol_name': 'render_agreement_intake_app',
  ...
  'template_segment': 'Segment 2: Render the agreement-intake app',
  'role': 'essential',
 ...
 {'symbol_name': 'read_agreement_form',
  ...
  'role': 'optional',
  'summary_override': None},
 {'symbol_name': 'check_data_agreement_tables',
  'module': 'data_agreement',
  'kind': 'function',
  'template_notebook': '`01_da_<agreement>`',
  'template_segment': 'Validate agreement metadata prerequisites',
  'role': 'optional',
  'summary_override': 'Validate agreement metadata tables and report steward readiness without creating tables.'},
 {'symbol_name': 'render_data_steward_maintenance_app',
  'module': 'data_agreement',
  'kind': 'function',
  'template_notebook': '`01_da_<agreement>`',
  'template_segment': 'Maintain steward reference rows',
  'role': 'essential',
  'summary_override': 'Render and wire the steward reference maintenance form.'},
 {'symbol_name': 'create_data_steward_form',
  'module': 'data_agreement',
  'kind': 'function',
  'template_notebook': '`01_da_<agreement>`',
  'template_segment': 'Optional advanced customization: create steward maintenance widgets',
  'role': 'optional',
  'summary_override': None},
 {'symbol_name': 'read_data_steward_form',
  'module': 'data_agreement',
  'kind': 'function',
  'template_notebook': '`01_da_<agreement>`',
  'template_segment': 'Optional advanced customization: read steward maintenance widgets',
  'role': 'optional',
  'summary_override': None},
 {'symbol_name': 'collect_data_steward_metadata',
  'module': 'data_agreement',
  'kind': 'function',
  'template_notebook': '`01_da_<agreement>`',
  'template_segment': 'Optional advanced customization: validate steward reference rows',
  'role': 'optional',
  'summary_override': None},
 {'symbol_name': 'commit_data_steward_metadata',
  'module': 'data_agreement',
  'kind': 'function',
  'template_notebook': '`01_da_<agreement>`',
  'template_segment': 'Optional advanced customization: append steward reference rows',
  'role': 'optional',
  'summary_override': None},
