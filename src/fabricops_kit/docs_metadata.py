...
MODULE_DOCS_METADATA: list[ModuleDocMetadata] = [
    ...
    {"module_name": "data_agreement", "visibility": "public", "module_summary": "Owns agreement metadata capture, audited record building, metadata commit helpers, and agreement selection helpers used to anchor notebook workflows to approved business agreements.", "sidebar_group": "1. Governance steward", "sidebar_include": True},
...
TEMPLATE_FLOW_DOCS: list[TemplateFlowDocMetadata] = [{'notebook_key': '00_env_config',
 ...
 {'notebook_key': '01_data_agreement',
  ...
  'segment_intro': 'Form notebook that renders the agreement-intake app through one framework helper. The helper renders Data Steward maintenance followed by Data Agreement maintenance. Both tables are append-only, and agreement intake selects active steward rows.',
  'segments': [{'title': 'Segment 1: Render the agreement-intake app',
                'text': 'Use `render_agreement_intake_app(...)` for the default form notebook. Advanced users may optionally call `create_agreement_form(...)`, `read_agreement_form(...)`, `collect_agreement_metadata(...)`, and `commit_agreement_metadata(...)` directly only when customizing the workflow.',
...
PUBLIC_SYMBOL_DOCS: list[PublicSymbolDocMetadata] = [{'symbol_name': 'setup_notebook',
 ...
 {'symbol_name': 'load_agreements',
  ...
  'template_segment': '—',
  'role': 'essential',
  'summary_override': 'Load latest versioned agreement rows from the configured metadata lakehouse.'},
 ...
 {'symbol_name': 'render_agreement_intake_app',
  ...
  'template_segment': 'Segment 1: Render the agreement-intake app',
  'role': 'essential',
  'summary_override': 'Render and wire the default agreement-intake form application.'},
 {'symbol_name': 'create_agreement_form',
  'module': 'data_agreement',
  'kind': 'function',
  'template_notebook': '`01_da_<agreement>`',
  'template_segment': 'Optional advanced customization: create agreement metadata widgets',
  'role': 'optional',
  'summary_override': None},
 {'symbol_name': 'collect_agreement_metadata',
  'module': 'data_agreement',
  'kind': 'function',
  'template_notebook': '`01_da_<agreement>`',
  'template_segment': 'Optional advanced customization: collect and preview agreement metadata',
  'role': 'optional',
  'summary_override': None},
 {'symbol_name': 'commit_agreement_metadata',
  'module': 'data_agreement',
  'kind': 'function',
  'template_notebook': '`01_da_<agreement>`',
  'template_segment': 'Optional advanced customization: commit metadata records',
  'role': 'optional',
  'summary_override': None},
 {'symbol_name': 'read_agreement_form',
  'module': 'data_agreement',
  'kind': 'function',
  'template_notebook': '`01_da_<agreement>`',
  'template_segment': 'Optional advanced customization: collect and preview agreement metadata',
 ...
 {'symbol_name': 'collect_custom_fields',
  'module': 'data_agreement',
  'kind': 'function',
  'template_notebook': '`01_da_<agreement>`',
  'template_segment': 'Config-driven metadata intake',
  'role': 'optional',
  'summary_override': 'Collect and validate configured JSON-backed custom-field values.'},
 {'symbol_name': 'create_or_update_data_agreement',
  'module': 'data_agreement',
  'kind': 'function',
  'template_notebook': '`01_da_<agreement>`',
  'template_segment': 'Config-driven metadata intake',
  'role': 'optional',
  'summary_override': 'Append a created agreement or a new semantic version with runtime audit fields.'},
 {'symbol_name': 'create_or_update_data_steward',
  'module': 'data_agreement',
  'kind': 'function',
  'template_notebook': '`01_da_<agreement>`',
  'template_segment': 'Config-driven metadata intake',
  'role': 'optional',
  'summary_override': 'Append a created or updated steward assignment with runtime audit fields.'},
 {'symbol_name': 'deserialize_custom_fields',
  'module': 'data_agreement',
  'kind': 'function',
  'template_notebook': '`01_da_<agreement>`',
  'template_segment': 'Config-driven metadata intake',
  'role': 'optional',
  'summary_override': 'Deserialize stored custom-field JSON for widget display.'},
 {'symbol_name': 'ensure_metadata_tables',
  'module': 'data_agreement',
  'kind': 'function',
  'template_notebook': '`01_da_<agreement>`',
  'template_segment': 'Config-driven metadata intake',
  'role': 'optional',
  'summary_override': 'Idempotently create or validate the lightweight 01_da metadata tables.'},
 {'symbol_name': 'get_data_agreement_schema',
  'module': 'data_agreement',
  'kind': 'function',
  'template_notebook': '`01_da_<agreement>`',
  'template_segment': 'Config-driven metadata intake',
  'role': 'optional',
  'summary_override': 'Return the lightweight agreement metadata-table schema.'},
 {'symbol_name': 'get_data_steward_schema',
  'module': 'data_agreement',
  'kind': 'function',
  'template_notebook': '`01_da_<agreement>`',
  'template_segment': 'Config-driven metadata intake',
  'role': 'optional',
  'summary_override': 'Return the lightweight steward metadata-table schema.'},
 {'symbol_name': 'get_standard_runtime_audit_columns',
  'module': 'data_agreement',
  'kind': 'function',
  'template_notebook': '`01_da_<agreement>`',
  'template_segment': 'Config-driven metadata intake',
  'role': 'optional',
  'summary_override': 'Return backend-only runtime audit columns shared by intake tables.'},
 {'symbol_name': 'get_widget_visible_fields',
  'module': 'data_agreement',
  'kind': 'function',
  'template_notebook': '`01_da_<agreement>`',
  'template_segment': 'Config-driven metadata intake',
  'role': 'optional',
  'summary_override': 'Return configured editable widget fields without backend audit columns.'},
 {'symbol_name': 'list_data_agreements',
  'module': 'data_agreement',
  'kind': 'function',
  'template_notebook': '`01_da_<agreement>`',
  'template_segment': 'Config-driven metadata intake',
  'role': 'optional',
  'summary_override': 'List latest agreement versions from the configured metadata lakehouse.'},
 {'symbol_name': 'list_data_stewards',
  'module': 'data_agreement',
  'kind': 'function',
  'template_notebook': '`01_da_<agreement>`',
  'template_segment': 'Config-driven metadata intake',
  'role': 'optional',
  'summary_override': 'List latest steward assignments, optionally filtering to active rows.'},
 {'symbol_name': 'render_custom_fields',
  'module': 'data_agreement',
  'kind': 'function',
  'template_notebook': '`01_da_<agreement>`',
  'template_segment': 'Config-driven metadata intake',
  'role': 'optional',
  'summary_override': 'Render configured JSON-backed custom intake widgets.'},
 ...
 {'symbol_name': 'serialize_custom_fields',
  'module': 'data_agreement',
  'kind': 'function',
  'template_notebook': '`01_da_<agreement>`',
  'template_segment': 'Config-driven metadata intake',
  'role': 'optional',
  'summary_override': 'Serialize organization-specific intake values to deterministic JSON.'},
