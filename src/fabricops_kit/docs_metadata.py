...
TEMPLATE_FLOW_DOCS: list[TemplateFlowDocMetadata] = [{'notebook_key': '00_env_config',
 ...
 {'notebook_key': '01_data_agreement',
  ...
  'segment_intro': 'Captures human-approved data sharing agreement metadata as audited header, catalogue, and scope records that anchor downstream notebooks.',
  'segments': [{'title': 'Segment 1: Create agreement metadata widgets',
                'symbols': ['create_agreement_widgets',
                            'DEFAULT_SENSITIVITY_LABELS',
                            'DEFAULT_REFRESH_FREQUENCIES',
                            'YES_NO_OPTIONS']},
               {'title': 'Segment 2: Read widget values', 'symbols': ['read_agreement_widget_values']},
               {'title': 'Segment 3: Build audited records',
                'symbols': ['derive_agreement_status',
                            'build_agreement_header_record',
                            'build_agreement_catalogue_record',
                            'build_agreement_scope_record']},
               {'title': 'Segment 4: Commit metadata records', 'symbols': ['commit_agreement_metadata']}]},
 {'notebook_key': '02_ex',
...
PUBLIC_SYMBOL_DOCS: list[PublicSymbolDocMetadata] = [{'symbol_name': 'load_config',
 ...
 {'symbol_name': 'get_selected_agreement',
  ...
  'role': 'essential',
  'summary_override': None},
 {'symbol_name': 'DEFAULT_REFRESH_FREQUENCIES',
  'module': 'data_agreement',
  'kind': 'constant',
  'template_notebook': '`01_da_<agreement>`',
  'template_segment': 'Segment 1: Create agreement metadata widgets',
  'role': 'essential',
  'summary_override': 'Default dropdown options for agreement refresh frequency metadata.'},
 {'symbol_name': 'DEFAULT_SENSITIVITY_LABELS',
  'module': 'data_agreement',
  'kind': 'constant',
  'template_notebook': '`01_da_<agreement>`',
  'template_segment': 'Segment 1: Create agreement metadata widgets',
  'role': 'essential',
  'summary_override': 'Default sensitivity label options used by agreement metadata widgets.'},
 {'symbol_name': 'YES_NO_OPTIONS',
  'module': 'data_agreement',
  'kind': 'constant',
  'template_notebook': '`01_da_<agreement>`',
  'template_segment': 'Segment 1: Create agreement metadata widgets',
  'role': 'essential',
  'summary_override': 'Canonical Yes/No dropdown options for agreement metadata controls.'},
 {'symbol_name': 'create_agreement_widgets',
  'module': 'data_agreement',
  'kind': 'function',
  'template_notebook': '`01_da_<agreement>`',
  'template_segment': 'Segment 1: Create agreement metadata widgets',
  'role': 'essential',
  'summary_override': None},
 {'symbol_name': 'read_agreement_widget_values',
  'module': 'data_agreement',
  'kind': 'function',
  'template_notebook': '`01_da_<agreement>`',
  'template_segment': 'Segment 2: Read widget values',
  'role': 'essential',
  'summary_override': None},
 {'symbol_name': 'derive_agreement_status',
  'module': 'data_agreement',
  'kind': 'function',
  'template_notebook': '`01_da_<agreement>`',
  'template_segment': 'Segment 3: Build audited records',
  'role': 'essential',
  'summary_override': None},
 {'symbol_name': 'build_agreement_header_record',
  'module': 'data_agreement',
  'kind': 'function',
  'template_notebook': '`01_da_<agreement>`',
  'template_segment': 'Segment 3: Build audited records',
  'role': 'essential',
  'summary_override': None},
 {'symbol_name': 'build_agreement_catalogue_record',
  'module': 'data_agreement',
  'kind': 'function',
  'template_notebook': '`01_da_<agreement>`',
  'template_segment': 'Segment 3: Build audited records',
  'role': 'essential',
  'summary_override': None},
 {'symbol_name': 'build_agreement_scope_record',
  'module': 'data_agreement',
  'kind': 'function',
  'template_notebook': '`01_da_<agreement>`',
  'template_segment': 'Segment 3: Build audited records',
 ...
 {'symbol_name': 'commit_agreement_metadata',
  ...
  'kind': 'function',
  'template_notebook': '`01_da_<agreement>`',
  'template_segment': 'Segment 4: Commit metadata records',
  'role': 'essential',
  'summary_override': None},
