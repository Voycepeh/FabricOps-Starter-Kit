...
TEMPLATE_FLOW_DOCS: list[TemplateFlowDocMetadata] = [{'notebook_key': '00_env_config',
 ...
 {'notebook_key': '01_data_agreement',
  ...
  'segment_intro': 'Captures one immutable `METADATA_DATA_AGREEMENT` row per human-approved agreement version and uses manually maintained `METADATA_DATA_STEWARD` profiles for intake dropdowns.',
  'segments': [{'title': 'Segment 1: Create agreement metadata widgets', 'symbols': ['create_agreement_form']},
               {'title': 'Segment 2: Collect and preview agreement metadata', 'symbols': ['collect_agreement_metadata']},
               {'title': 'Segment 3: Commit metadata records', 'symbols': ['commit_agreement_metadata']}]},
 {'notebook_key': '02_ex',
...
PUBLIC_SYMBOL_DOCS: list[PublicSymbolDocMetadata] = [{'symbol_name': 'load_config',
 ...
 {'symbol_name': 'collect_agreement_metadata',
  ...
  'kind': 'function',
  'template_notebook': '`01_da_<agreement>`',
  'template_segment': 'Segment 2: Collect and preview agreement metadata',
  'role': 'essential',
  'summary_override': None},
 {'symbol_name': 'commit_agreement_metadata',
  ...
  'kind': 'function',
  'template_notebook': '`01_da_<agreement>`',
  'template_segment': 'Segment 3: Commit metadata records',
  'role': 'essential',
  'summary_override': None},
