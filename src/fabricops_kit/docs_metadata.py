...
TEMPLATE_FLOW_DOCS: list[TemplateFlowDocMetadata] = [{'notebook_key': '00_env_config',
 ...
 {'notebook_key': '03_pc',
  ...
  'segment_intro': 'Core production pipeline flow for clean evidence creation, pipeline-local schema checks, inline runtime audit columns, large-table write tuning, and controlled publishing. 03_pc uses check_schema for source and transformed-target shape checks, uses build_runtime_audit_fields for metadata runtime values, then adds dataframe audit columns inline. Audit columns are always useful; hashes, datetime features, and bucket columns are specialized patterns outside the default path.',
  'segments': [{'title': 'Segment 1: Runtime setup, parameters, agreement selection, and registration',
               ...
               {'title': 'Segment 2: Read source data',
                'symbols': ['read_lakehouse_table', 'read_warehouse_table', 'read_lakehouse_csv', 'read_lakehouse_parquet', 'check_schema']},
               ...
               {'title': 'Segment 4: Transform, add runtime audit columns, and publish outputs',
                'symbols': ['check_schema', 'build_runtime_audit_fields', 'write_lakehouse_table', 'write_warehouse_table']},
...
PUBLIC_SYMBOL_DOCS: list[PublicSymbolDocMetadata] = [{'symbol_name': 'setup_notebook',
 ...
 {'symbol_name': 'check_schema',
  ...
  'template_segment': 'Pipeline-local schema checks',
  'role': 'essential',
  'summary_override': 'Check a dataframe has the expected pipeline-local columns and datatypes before continuing.'},
 {'symbol_name': 'SchemaDriftError',
  'module': 'drift',
  'kind': 'class',
  'template_notebook': '03_pc_<agreement>_<pipeline>',
  'template_segment': 'Pipeline-local schema checks',
  'role': 'optional',
  'summary_override': 'Exception raised when check_schema is configured to fail on schema differences.'},
 ...
 {'symbol_name': 'check_profile_drift',
  ...
  'role': 'optional',
  'summary_override': None},
 {'symbol_name': 'default_profile_drift_policy',
  'module': 'drift',
  'kind': 'function',
  'template_notebook': '03_pc_<agreement>_<pipeline>',
  'template_segment': 'Profile-based data drift guardrails',
  'role': 'optional',
  'summary_override': 'Return lightweight default thresholds for profile-based data drift checks.'},
 {'symbol_name': 'extract_categorical_distribution_categories',
  'module': 'drift',
  'kind': 'function',
  'template_notebook': '03_pc_<agreement>_<pipeline>',
  'template_segment': 'Profile-based data drift guardrails',
  'role': 'optional',
  'summary_override': 'Extract baseline categorical vocabularies so current profiles can produce comparable categorical distributions.'},
 {'symbol_name': 'extract_numeric_distribution_bin_edges',
  'module': 'drift',
  'kind': 'function',
  'template_notebook': '03_pc_<agreement>_<pipeline>',
  'template_segment': 'Profile-based data drift guardrails',
  'role': 'optional',
  'summary_override': 'Extract baseline numeric bin edges so current profiles can produce comparable PSI distributions.'},
 {'symbol_name': 'load_latest_profile',
  'module': 'drift',
  'kind': 'function',
  'template_notebook': '03_pc_<agreement>_<pipeline>',
  'template_segment': 'Profile-based data drift guardrails',
  'role': 'optional',
  'summary_override': 'Load the latest previous successful or approved source/target profile baseline from existing profile metadata.'},
 {'symbol_name': 'assert_no_blocking_profile_drift',
  'module': 'drift',
  'kind': 'function',
  'template_notebook': '03_pc_<agreement>_<pipeline>',
  'template_segment': 'Profile-based data drift guardrails',
  'role': 'optional',
  'summary_override': 'Raise when profile drift check results should block notebook execution.'},
