...
TEMPLATE_FLOW_DOCS: list[TemplateFlowDocMetadata] = [{'notebook_key': '00_env_config',
 ...
 {'notebook_key': '02_ex',
  ...
  'segments': [{'title': 'Segment 1: Load shared config and runtime', 'symbols': ['setup_notebook', 'load_config']},
 ...
 {'notebook_key': '03_pc',
  ...
  'segments': [{'title': 'Segment 1: Load shared config and runtime context', 'symbols': ['setup_notebook', 'load_config']},
