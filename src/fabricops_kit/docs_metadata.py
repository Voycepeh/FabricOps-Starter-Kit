...
TEMPLATE_FLOW_DOCS: list[TemplateFlowDocMetadata] = [{'notebook_key': '00_env_config',
  ...
  'segments': [{'symbols': ['setup_notebook',
 ...
 {'notebook_key': '01_da_agreement_template',
  ...
  'segment_intro': 'Agreement, steward, and evidence intake.',
  'segments': [{'symbols': ['widget_render_agreement_intake_app'], 'title': 'Agreement intake'}],
...
PUBLIC_SYMBOL_DOCS: list[PublicSymbolDocMetadata] = [{'kind': 'function',
 ...
 {'kind': 'function',
  ...
  'role': 'essential',
  'summary_override': 'Create or validate data-agreement metadata tables during environment setup.',
 ...
 {'kind': 'function',
  'module': 'metadata',
  'role': 'essential',
  'summary_override': 'Create or validate notebook registry metadata during environment setup.',
 ...
 {'kind': 'function',
  ...
  'role': 'essential',
  'summary_override': 'Create or validate governance metadata tables during environment setup.',
  'symbol_name': 'setup_governance_metadata_tables',
  'template_notebook': '00_env_config',
  'template_segment': 'Environment bootstrap'},
 {'kind': 'function',
  'module': 'data_agreement',
  'role': 'essential',
  'summary_override': 'Render the combined steward, agreement, and evidence intake app.',
 ...
 {'kind': 'function',
  'module': 'drift',
  'role': 'essential',
  'summary_override': 'Stop a notebook when a schema or data-change guardrail result blocks continuation.',
 ...
 {'kind': 'function',
  'module': 'governance_review',
  'role': 'essential',
  'summary_override': 'Render non-persistent human review guidance for context, DQ rules, and classification.',
