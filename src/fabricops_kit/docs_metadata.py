...
TEMPLATE_FLOW_DOCS: list[TemplateFlowDocMetadata] = [{'notebook_key': '00_env_config',
 ...
 {'notebook_key': '03_pc',
  ...
  'segment_intro': 'Core production pipeline flow for clean evidence creation, schema guardrails, inline runtime audit columns, large-table write tuning, and controlled publishing. 03_pc applies source schema guardrails after read and target schema guardrails before audit columns/write.',
  'segments': [{'title': 'Segment 1: Runtime setup, parameters, agreement selection, and registration',
               ...
               {'title': 'Segment 3: Apply schema guardrails, profile, and write reusable catalogue evidence',
                'symbols': ['apply_schema_guardrail', 'profile_dataframe', 'write_lakehouse_table']},
               {'title': 'Segment 4: Transform, apply target guardrail, add runtime audit columns, and publish outputs',
...
PUBLIC_SYMBOL_DOCS: list[PublicSymbolDocMetadata] = [{'symbol_name': 'setup_notebook',
 ...
 {'symbol_name': 'select_agreement',
  ...
  'template_segment': '—',
  'role': 'essential',
  'summary_override': 'Render a searchable agreement selector and store selected agreement metadata row in module '
                      'state.'},
 ...
 {'symbol_name': 'build_runtime_audit_fields',
  ...
  'template_segment': '—',
  'role': 'essential',
  'summary_override': 'Build shared runtime audit values; 03_pc uses notebook and committed-by context while adding '
                      'dataframe audit columns inline.'},
 ...
 {'symbol_name': 'read_lakehouse_excel',
  ...
  'template_segment': '—',
  'role': 'optional',
  'summary_override': 'Read an Excel file from a Fabric lakehouse Files path and pass options such as skiprows, '
                      'header, usecols, dtype, and nrows through to pandas.read_excel.'},
 ...
 {'symbol_name': 'review_schema_contract',
  ...
  'kind': 'function',
  'template_notebook': '—',
  'template_segment': 'Schema contract governance workflow',
  'role': 'essential',
  'summary_override': 'Review, approve, version, and persist a dataset schema contract.'},
 {'symbol_name': 'apply_schema_guardrail',
  'module': 'schema_contracts',
  'kind': 'function',
  'template_notebook': '`03_pc_<agreement>_<source>_to_<target>`',
  'template_segment': 'Schema validation',
  'role': 'essential',
  'summary_override': 'Load the approved dataset contract, validate schema drift, enforce observe/warn/fail behavior, '
                      'and write evidence.'},
 {'symbol_name': 'validate_schema',
  'module': 'schema_contracts',
  'kind': 'function',
  'template_notebook': '—',
  'template_segment': 'Advanced schema validation',
  'role': 'optional',
  'summary_override': 'Validate a Spark DataFrame shape against approved dataset-level schema contract columns without '
                      'enforcement or metadata writes.'},
 ...
 {'symbol_name': 'print_runtime_banner',
  ...
  'template_segment': 'Segment 1: Explain the shared environment role',
  'role': 'essential',
  'summary_override': 'Print the installed package version and matching documentation links in a notebook-friendly '
                      'banner.'},
