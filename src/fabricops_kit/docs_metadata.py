...
TEMPLATE_FLOW_DOCS: list[TemplateFlowDocMetadata] = [{'notebook_key': '00_env_config',
 ...
 {'notebook_key': '01_data_agreement',
  ...
  'segments': [{'title': 'Segment 1: Render the agreement-intake app',
                'text': 'Use `render_agreement_intake_app(...)` for the default form notebook. It renders Data Steward maintenance first and Data Agreement maintenance second. Downstream notebooks use `select_agreement(...)` and `get_selected_agreement()` to bind work to a committed version.',
