...
DATA_AGREEMENT_VISIBLE_FIELDS = ["agreement_name", "domain", "provider_steward_id", "recipient_steward_id", "recipient", "start_date", "expiry_date", "business_purpose"]
...
WIDGET_CONFIG_DEFAULTS = {"data_steward_widget": {"visible_columns": DATA_STEWARD_VISIBLE_FIELDS, "custom_fields": []}, "data_agreement_widget": {"visible_columns": DATA_AGREEMENT_VISIBLE_FIELDS, "approved_usage_options": ["internal", "research", "external"], "custom_fields": []}}
