...
def metadata_table_schema_registry() -> dict[str, Any]:
    ...
    return {
        ...
        "METADATA_DATA_AGREEMENT": build_metadata_schema("METADATA_DATA_AGREEMENT", [("agreement_id", "string", False), ("agreement_version", "string", False), ("agreement_name", "string", False), ("domain", "string", False), ("provider_steward_id", "string", False), ("recipient_steward_id", "string", False), ("recipient", "string", False), ("start_date", "date", False), ("expiry_date", "date", False), ("business_purpose", "string", False), ("custom_fields_json", "string", True), *audit]),
        "METADATA_DATA_CONTRACT": build_metadata_schema("METADATA_DATA_CONTRACT", [("contract_id", "string", False), ("agreement_id", "string", False), ("metadata_table_key", "string", False), ("schema_fingerprint", "string", False), ("contract_version", "string"), ("contract_status", "string"), ("effective_from", "date"), ("effective_to", "date"), ("contract_payload_json", "string"), *audit]),
        ...
        "METADATA_DATA_PROFILED": build_metadata_schema("METADATA_DATA_PROFILED", [("metadata_table_key", "string", False), ("metadata_column_key", "string", False), ("schema_fingerprint", "string", False), ("column_name", "string", False), ("data_type", "string", False), ("row_count", "long", False), ("non_null_count", "long", False), ("null_count", "long", False), ("null_percent", "double", False), ("distinct_count", "long", False), ("distinct_percent", "double", False), ("mean_value", "double", True), ("stddev_value", "double", True), ("min_value", "string", True), ("percentile_25_value", "double", True), ("median_value", "double", True), ("percentile_75_value", "double", True), ("max_value", "string", True), ("is_sampled", "boolean", False), ("frequency_json", "string", True), ("profiled_at", "timestamp", False), *audit]),
