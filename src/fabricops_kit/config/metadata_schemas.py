...
def metadata_table_schema_registry() -> dict[str, Any]:
    ...
    return {
        ...
        "METADATA_DATA_LINEAGE_TABLE": build_metadata_schema("METADATA_DATA_LINEAGE_TABLE", [("lineage_id", "string"), ("dataset_name", "string"), ("run_id", "string"), ("source_table", "string"), ("target_table", "string"), ("source_table_key", "string"), ("target_table_key", "string"), ("transformation_steps_json", "string"), ("created_at", "timestamp"), *audit]),
        ...
        "METADATA_GUARDRAIL_RESULTS": build_metadata_schema("METADATA_GUARDRAIL_RESULTS", [("result_id", "string"), ("run_id", "string"), ("rule_key", "string"), ("environment_name", "string"), ("dataset_name", "string"), ("table_name", "string"), ("column_name", "string"), ("guardrail_type", "string"), ("rule_type", "string"), ("status", "string"), ("can_continue", "boolean"), ("severity", "string"), ("reason", "string"), ("expected_value_json", "string"), ("actual_value_json", "string"), ("result_payload_json", "string"), ("created_at", "timestamp"), *audit]),
