...
def metadata_table_schema_registry() -> dict[str, Any]:
    ...
    return {
        ...
        "METADATA_DATA_CONTRACT": build_metadata_schema("METADATA_DATA_CONTRACT", [("contract_snapshot_id", "string", False), ("agreement_id", "string", False), ("metadata_table_key", "string", False), ("schema_fingerprint", "string", False), ("snapshot_saved_at", "timestamp", False), *audit]),
