...
def metadata_table_schema_registry() -> dict[str, Any]:
    ...
    return {
        ...
        "METADATA_SOURCE_OBSERVATION": build_metadata_schema("METADATA_SOURCE_OBSERVATION", [("source_id", "string", False), ("observation_definition_id", "string", False), ("source_type", "string", False), ("source_target", "string", False), ("source_schema", "string", True), ("source_table", "string", False), ("partition_value", "string", False), ("is_present", "boolean", False), ("row_count", "long", False), ("observed_min", "string", True), ("observed_max", "string", True), ("fingerprint", "string", False), ("observed_at", "timestamp", False), *audit]),
    }
